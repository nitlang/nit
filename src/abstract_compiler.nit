...
redef class ToolContext
   ...
   do
      ...
      self.opt_no_check_covariance.value = true
      self.opt_no_check_initialization.value = true
      self.opt_no_check_assert.value = true
      self.opt_no_check_autocast.value = true
      self.opt_no_check_other.value = true
   end
end
