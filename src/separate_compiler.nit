...
redef class ToolContext
   ...
   do
      ...
      self.opt_inline_coloring_numbers.value = true
      self.opt_inline_some_methods.value = true
      self.opt_direct_call_monomorph.value = true
   end
end
...
class SeparateCompilerVisitor
   ...
   do
      ...
      if compiler.modelbuilder.toolcontext.opt_direct_call_monomorph.value then
         var tgs = callsite.mproperty.mpropdefs
