...
bench_nitg-s_options "slower" --hardening --no-inline-intern --generic-resolution-tree --no-union-attribute
...
bench_nitg-e_options "slower" --hardening --no-inline-intern --no-union-attribute
