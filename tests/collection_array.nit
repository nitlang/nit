...
print "--Tests on Sequence[Int]"
test_setindex(test)
test_retindex(test)
test_append(test)
test_append_all(test)
test_prepend(test)
test_prepend_all(test)
test_first(test)
test_last(test)
test_index_of(test)
test_last_index_of(test)
test_pick_first(test)
test_pick_last(test)
test_remove_at(test)
test_insert_at(test)
test_iterator_from(test)
test_iterator_within(test)
...
print "--Tests on SequenceIterator[Int]"
test_clear(test)
test_add(test)
test_sequence_iterator(test)
test_iterator_insert_before(test)
test_iterator_delete_before(test)
test_iterator_insert_after(test)
test_iterator_delete_after(test)
test_iterator_index(test)

print "--Tests on ArrayIterator[Int]"
