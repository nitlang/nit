...
13:MAttributeDef
=properties=JsonObject(5):
{"location":"%SOURCE_DIRECTORY%\/org\/example\/foo\/C.java:25,1---1,1","visibility":"public","name":"THE_ANSWER","mdoc":["âAnswer to the Ultimate Question of Life, the Universe, and Everything.","â"],"is_intro":true}
----
=to=Entity#0:
=labels=Array(4):
3:foo
