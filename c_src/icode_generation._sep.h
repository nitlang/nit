/* This C header file is generated by NIT to compile modules and programs that requires icode_generation. */
#ifndef icode_generation_sep
#define icode_generation_sep
...
extern const char *LOCATE_icode_generation;
extern const int SFT_icode_generation[];
#define ID_A2IContext (SFT_icode_generation[0])
#define COLOR_A2IContext (SFT_icode_generation[1])
#define ATTR_icode_generation___A2IContext____variables(recv) ATTR(recv, (SFT_icode_generation[2] + 0))
#define ATTR_icode_generation___A2IContext____closurevariables(recv) ATTR(recv, (SFT_icode_generation[2] + 1))
#define ATTR_icode_generation___A2IContext____visitor(recv) ATTR(recv, (SFT_icode_generation[2] + 2))
#define ATTR_icode_generation___A2IContext____return_seq(recv) ATTR(recv, (SFT_icode_generation[2] + 3))
#define ATTR_icode_generation___A2IContext____return_value(recv) ATTR(recv, (SFT_icode_generation[2] + 4))
#define ATTR_icode_generation___A2IContext____method(recv) ATTR(recv, (SFT_icode_generation[2] + 5))
#define ATTR_icode_generation___A2IContext____current_node(recv) ATTR(recv, (SFT_icode_generation[2] + 6))
#define INIT_TABLE_POS_A2IContext (SFT_icode_generation[3] + 0)
#define CALL_SUPER_icode_generation___A2IContext___stmt(recv) ((icode_generation___A2IContext___stmt_t)CALL((recv), (SFT_icode_generation[3] + 1)))
#define CALL_icode_generation___A2IContext___add_new_array(recv) ((icode_generation___A2IContext___add_new_array_t)CALL((recv), (SFT_icode_generation[3] + 2)))
#define CALL_icode_generation___A2IContext___add_call_array_add(recv) ((icode_generation___A2IContext___add_call_array_add_t)CALL((recv), (SFT_icode_generation[3] + 3)))
#define CALL_icode_generation___A2IContext___variable(recv) ((icode_generation___A2IContext___variable_t)CALL((recv), (SFT_icode_generation[3] + 4)))
#define CALL_icode_generation___A2IContext___closurevariables(recv) ((icode_generation___A2IContext___closurevariables_t)CALL((recv), (SFT_icode_generation[3] + 5)))
#define CALL_icode_generation___A2IContext___visitor(recv) ((icode_generation___A2IContext___visitor_t)CALL((recv), (SFT_icode_generation[3] + 6)))
#define CALL_icode_generation___A2IContext___return_seq(recv) ((icode_generation___A2IContext___return_seq_t)CALL((recv), (SFT_icode_generation[3] + 7)))
#define CALL_icode_generation___A2IContext___return_seq__eq(recv) ((icode_generation___A2IContext___return_seq__eq_t)CALL((recv), (SFT_icode_generation[3] + 8)))
#define CALL_icode_generation___A2IContext___return_value(recv) ((icode_generation___A2IContext___return_value_t)CALL((recv), (SFT_icode_generation[3] + 9)))
#define CALL_icode_generation___A2IContext___return_value__eq(recv) ((icode_generation___A2IContext___return_value__eq_t)CALL((recv), (SFT_icode_generation[3] + 10)))
#define CALL_icode_generation___A2IContext___method(recv) ((icode_generation___A2IContext___method_t)CALL((recv), (SFT_icode_generation[3] + 11)))
#define CALL_icode_generation___A2IContext___init(recv) ((icode_generation___A2IContext___init_t)CALL((recv), (SFT_icode_generation[3] + 12)))
#define CALL_icode_generation___A2IContext___invoke_super_init_calls_after(recv) ((icode_generation___A2IContext___invoke_super_init_calls_after_t)CALL((recv), (SFT_icode_generation[3] + 13)))
#define CALL_icode_generation___A2IContext___generate_stmt(recv) ((icode_generation___A2IContext___generate_stmt_t)CALL((recv), (SFT_icode_generation[3] + 14)))
#define CALL_icode_generation___A2IContext___generate_expr(recv) ((icode_generation___A2IContext___generate_expr_t)CALL((recv), (SFT_icode_generation[3] + 15)))
#define ATTR_icode_generation___EscapableBlock____break_seq(recv) ATTR(recv, (SFT_icode_generation[4] + 0))
#define ATTR_icode_generation___EscapableBlock____continue_seq(recv) ATTR(recv, (SFT_icode_generation[4] + 1))
#define ATTR_icode_generation___EscapableBlock____break_value(recv) ATTR(recv, (SFT_icode_generation[4] + 2))
#define ATTR_icode_generation___EscapableBlock____continue_value(recv) ATTR(recv, (SFT_icode_generation[4] + 3))
#define CALL_icode_generation___EscapableBlock___break_seq(recv) ((icode_generation___EscapableBlock___break_seq_t)CALL((recv), (SFT_icode_generation[5] + 0)))
#define CALL_icode_generation___EscapableBlock___break_seq__eq(recv) ((icode_generation___EscapableBlock___break_seq__eq_t)CALL((recv), (SFT_icode_generation[5] + 1)))
#define CALL_icode_generation___EscapableBlock___continue_seq(recv) ((icode_generation___EscapableBlock___continue_seq_t)CALL((recv), (SFT_icode_generation[5] + 2)))
#define CALL_icode_generation___EscapableBlock___continue_seq__eq(recv) ((icode_generation___EscapableBlock___continue_seq__eq_t)CALL((recv), (SFT_icode_generation[5] + 3)))
#define CALL_icode_generation___EscapableBlock___break_value(recv) ((icode_generation___EscapableBlock___break_value_t)CALL((recv), (SFT_icode_generation[5] + 4)))
#define CALL_icode_generation___EscapableBlock___break_value__eq(recv) ((icode_generation___EscapableBlock___break_value__eq_t)CALL((recv), (SFT_icode_generation[5] + 5)))
#define CALL_icode_generation___EscapableBlock___continue_value(recv) ((icode_generation___EscapableBlock___continue_value_t)CALL((recv), (SFT_icode_generation[5] + 6)))
#define CALL_icode_generation___EscapableBlock___continue_value__eq(recv) ((icode_generation___EscapableBlock___continue_value__eq_t)CALL((recv), (SFT_icode_generation[5] + 7)))
#define CALL_icode_generation___MMSrcModule___generate_icode(recv) ((icode_generation___MMSrcModule___generate_icode_t)CALL((recv), (SFT_icode_generation[6] + 0)))
#define ATTR_icode_generation___MMSrcAttribute____iroutine(recv) ATTR(recv, (SFT_icode_generation[7] + 0))
#define CALL_icode_generation___MMSrcAttribute___iroutine__eq(recv) ((icode_generation___MMSrcAttribute___iroutine__eq_t)CALL((recv), (SFT_icode_generation[8] + 0)))
#define CALL_icode_generation___MMSrcAttribute___generate_iroutine(recv) ((icode_generation___MMSrcAttribute___generate_iroutine_t)CALL((recv), (SFT_icode_generation[8] + 1)))
#define ATTR_icode_generation___MMSrcMethod____iroutine(recv) ATTR(recv, (SFT_icode_generation[9] + 0))
#define CALL_icode_generation___MMSrcMethod___iroutine__eq(recv) ((icode_generation___MMSrcMethod___iroutine__eq_t)CALL((recv), (SFT_icode_generation[10] + 0)))
#define CALL_icode_generation___MMSrcMethod___generate_iroutine(recv) ((icode_generation___MMSrcMethod___generate_iroutine_t)CALL((recv), (SFT_icode_generation[10] + 1)))
#define CALL_icode_generation___MMSrcMethod___inner_generate_iroutine(recv) ((icode_generation___MMSrcMethod___inner_generate_iroutine_t)CALL((recv), (SFT_icode_generation[10] + 2)))
#define ID_A2IVisitor (SFT_icode_generation[11])
#define COLOR_A2IVisitor (SFT_icode_generation[12])
#define ATTR_icode_generation___A2IVisitor____icode_ctx(recv) ATTR(recv, (SFT_icode_generation[13] + 0))
#define INIT_TABLE_POS_A2IVisitor (SFT_icode_generation[14] + 0)
#define CALL_icode_generation___A2IVisitor___icode_ctx__eq(recv) ((icode_generation___A2IVisitor___icode_ctx__eq_t)CALL((recv), (SFT_icode_generation[14] + 1)))
#define CALL_icode_generation___A2IVisitor___icode_ctx(recv) ((icode_generation___A2IVisitor___icode_ctx_t)CALL((recv), (SFT_icode_generation[14] + 2)))
#define CALL_icode_generation___A2IVisitor___init(recv) ((icode_generation___A2IVisitor___init_t)CALL((recv), (SFT_icode_generation[14] + 3)))
#define CALL_icode_generation___ANode___accept_icode_generation(recv) ((icode_generation___ANode___accept_icode_generation_t)CALL((recv), (SFT_icode_generation[15] + 0)))
#define CALL_SUPER_icode_generation___AAttrPropdef___accept_icode_generation(recv) ((icode_generation___AAttrPropdef___accept_icode_generation_t)CALL((recv), (SFT_icode_generation[16] + 0)))
#define CALL_SUPER_icode_generation___AMethPropdef___accept_icode_generation(recv) ((icode_generation___AMethPropdef___accept_icode_generation_t)CALL((recv), (SFT_icode_generation[17] + 0)))
#define CALL_icode_generation___AMethPropdef___fill_iroutine(recv) ((icode_generation___AMethPropdef___fill_iroutine_t)CALL((recv), (SFT_icode_generation[17] + 1)))
#define CALL_icode_generation___ASignature___fill_iroutine_parameters(recv) ((icode_generation___ASignature___fill_iroutine_parameters_t)CALL((recv), (SFT_icode_generation[18] + 0)))
#define CALL_icode_generation___AExpr___generate_icode(recv) ((icode_generation___AExpr___generate_icode_t)CALL((recv), (SFT_icode_generation[19] + 0)))
#define ATTR_icode_generation___AStringFormExpr____cstring(recv) ATTR(recv, (SFT_icode_generation[20] + 0))
#define ATTR_icode_generation___AStringFormExpr____cstring_length(recv) ATTR(recv, (SFT_icode_generation[20] + 1))
#define CALL_icode_generation___AStringFormExpr___string_text(recv) ((icode_generation___AStringFormExpr___string_text_t)CALL((recv), (SFT_icode_generation[21] + 0)))
#define CALL_icode_generation___AStringFormExpr___compute_string_infos(recv) ((icode_generation___AStringFormExpr___compute_string_infos_t)CALL((recv), (SFT_icode_generation[21] + 1)))
