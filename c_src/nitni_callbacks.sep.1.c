...
var8 = ((val* (*)(val*))(var_npropdef->class->vft[COLOR_modelize_property__APropdef__mpropdef]))(var_npropdef) /* mpropdef on <var_npropdef:AExternPropdef>*/;
var9 = 1;
if (var8 == NULL) {
fprintf(stderr, "Runtime error: %s", "Receiver is null");
...
((void (*)(val*, short int))(var8->class->vft[COLOR_modelize_property__MPropDef__has_supercall_61d]))(var8, var9) /* has_supercall= on <var8:nullable MPropDef(nullable MMethodDef)>*/;
}
RET_LABEL:;
}
