...
#define ATTR_syntax___syntax_base___MMMethSrcMethod____is_abstract(recv) ATTR(recv, (SFT_syntax___syntax_base[29] + 2))
#define ATTR_syntax___syntax_base___MMMethSrcMethod____extern_name(recv) ATTR(recv, (SFT_syntax___syntax_base[29] + 3))
