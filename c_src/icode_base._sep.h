/* This C header file is generated by NIT to compile modules and programs that requires icode_base. */
#ifndef icode_base_sep
#define icode_base_sep
...
extern const char *LOCATE_icode_base;
extern const int SFT_icode_base[];
#define ID_IRegister (SFT_icode_base[0])
#define COLOR_IRegister (SFT_icode_base[1])
#define ATTR_icode_base___IRegister____stype(recv) ATTR(recv, (SFT_icode_base[2] + 0))
#define INIT_TABLE_POS_IRegister (SFT_icode_base[3] + 0)
#define CALL_icode_base___IRegister___stype(recv) ((icode_base___IRegister___stype_t)CALL((recv), (SFT_icode_base[3] + 1)))
#define CALL_icode_base___IRegister___init(recv) ((icode_base___IRegister___init_t)CALL((recv), (SFT_icode_base[3] + 2)))
#define ID_IEscapeMark (SFT_icode_base[4])
#define COLOR_IEscapeMark (SFT_icode_base[5])
#define INIT_TABLE_POS_IEscapeMark (SFT_icode_base[6] + 0)
#define CALL_icode_base___IEscapeMark___init(recv) ((icode_base___IEscapeMark___init_t)CALL((recv), (SFT_icode_base[6] + 1)))
#define ID_IClosureDecl (SFT_icode_base[7])
#define COLOR_IClosureDecl (SFT_icode_base[8])
#define ATTR_icode_base___IClosureDecl____closure(recv) ATTR(recv, (SFT_icode_base[9] + 0))
#define ATTR_icode_base___IClosureDecl____default(recv) ATTR(recv, (SFT_icode_base[9] + 1))
#define INIT_TABLE_POS_IClosureDecl (SFT_icode_base[10] + 0)
#define CALL_icode_base___IClosureDecl___closure(recv) ((icode_base___IClosureDecl___closure_t)CALL((recv), (SFT_icode_base[10] + 1)))
#define CALL_icode_base___IClosureDecl___default(recv) ((icode_base___IClosureDecl___default_t)CALL((recv), (SFT_icode_base[10] + 2)))
#define CALL_icode_base___IClosureDecl___default__eq(recv) ((icode_base___IClosureDecl___default__eq_t)CALL((recv), (SFT_icode_base[10] + 3)))
#define CALL_icode_base___IClosureDecl___init(recv) ((icode_base___IClosureDecl___init_t)CALL((recv), (SFT_icode_base[10] + 4)))
#define ID_IRoutine (SFT_icode_base[11])
#define COLOR_IRoutine (SFT_icode_base[12])
#define ATTR_icode_base___IRoutine____params(recv) ATTR(recv, (SFT_icode_base[13] + 0))
#define ATTR_icode_base___IRoutine____closure_decls(recv) ATTR(recv, (SFT_icode_base[13] + 1))
#define ATTR_icode_base___IRoutine____registers(recv) ATTR(recv, (SFT_icode_base[13] + 2))
#define ATTR_icode_base___IRoutine____result(recv) ATTR(recv, (SFT_icode_base[13] + 3))
#define ATTR_icode_base___IRoutine____escape_marks(recv) ATTR(recv, (SFT_icode_base[13] + 4))
#define ATTR_icode_base___IRoutine____body(recv) ATTR(recv, (SFT_icode_base[13] + 5))
#define ATTR_icode_base___IRoutine____location(recv) ATTR(recv, (SFT_icode_base[13] + 6))
#define INIT_TABLE_POS_IRoutine (SFT_icode_base[14] + 0)
#define CALL_icode_base___IRoutine___params(recv) ((icode_base___IRoutine___params_t)CALL((recv), (SFT_icode_base[14] + 1)))
#define CALL_icode_base___IRoutine___closure_decls(recv) ((icode_base___IRoutine___closure_decls_t)CALL((recv), (SFT_icode_base[14] + 2)))
#define CALL_icode_base___IRoutine___closure_decls__eq(recv) ((icode_base___IRoutine___closure_decls__eq_t)CALL((recv), (SFT_icode_base[14] + 3)))
#define CALL_icode_base___IRoutine___registers(recv) ((icode_base___IRoutine___registers_t)CALL((recv), (SFT_icode_base[14] + 4)))
#define CALL_icode_base___IRoutine___result(recv) ((icode_base___IRoutine___result_t)CALL((recv), (SFT_icode_base[14] + 5)))
#define CALL_icode_base___IRoutine___escape_marks(recv) ((icode_base___IRoutine___escape_marks_t)CALL((recv), (SFT_icode_base[14] + 6)))
#define CALL_icode_base___IRoutine___body(recv) ((icode_base___IRoutine___body_t)CALL((recv), (SFT_icode_base[14] + 7)))
#define CALL_icode_base___IRoutine___location(recv) ((icode_base___IRoutine___location_t)CALL((recv), (SFT_icode_base[14] + 8)))
#define CALL_icode_base___IRoutine___location__eq(recv) ((icode_base___IRoutine___location__eq_t)CALL((recv), (SFT_icode_base[14] + 9)))
#define CALL_icode_base___IRoutine___init(recv) ((icode_base___IRoutine___init_t)CALL((recv), (SFT_icode_base[14] + 10)))
#define ID_IClosureDef (SFT_icode_base[15])
#define COLOR_IClosureDef (SFT_icode_base[16])
#define INIT_TABLE_POS_IClosureDef (SFT_icode_base[17] + 0)
#define CALL_icode_base___IClosureDef___init(recv) ((icode_base___IClosureDef___init_t)CALL((recv), (SFT_icode_base[17] + 1)))
#define ID_ICode (SFT_icode_base[18])
#define COLOR_ICode (SFT_icode_base[19])
#define ATTR_icode_base___ICode____result(recv) ATTR(recv, (SFT_icode_base[20] + 0))
#define ATTR_icode_base___ICode____location(recv) ATTR(recv, (SFT_icode_base[20] + 1))
#define INIT_TABLE_POS_ICode (SFT_icode_base[21] + 0)
#define CALL_icode_base___ICode___arity(recv) ((icode_base___ICode___arity_t)CALL((recv), (SFT_icode_base[21] + 1)))
#define CALL_icode_base___ICode___result(recv) ((icode_base___ICode___result_t)CALL((recv), (SFT_icode_base[21] + 2)))
#define CALL_icode_base___ICode___result__eq(recv) ((icode_base___ICode___result__eq_t)CALL((recv), (SFT_icode_base[21] + 3)))
#define CALL_icode_base___ICode___location(recv) ((icode_base___ICode___location_t)CALL((recv), (SFT_icode_base[21] + 4)))
#define CALL_icode_base___ICode___location__eq(recv) ((icode_base___ICode___location__eq_t)CALL((recv), (SFT_icode_base[21] + 5)))
#define CALL_icode_base___ICode___is_pure(recv) ((icode_base___ICode___is_pure_t)CALL((recv), (SFT_icode_base[21] + 6)))
#define CALL_icode_base___ICode___init(recv) ((icode_base___ICode___init_t)CALL((recv), (SFT_icode_base[21] + 7)))
#define ID_ICode0 (SFT_icode_base[22])
#define COLOR_ICode0 (SFT_icode_base[23])
#define INIT_TABLE_POS_ICode0 (SFT_icode_base[24] + 0)
#define ID_ICode1 (SFT_icode_base[25])
#define COLOR_ICode1 (SFT_icode_base[26])
#define ATTR_icode_base___ICode1____expr(recv) ATTR(recv, (SFT_icode_base[27] + 0))
#define INIT_TABLE_POS_ICode1 (SFT_icode_base[28] + 0)
#define CALL_icode_base___ICode1___expr(recv) ((icode_base___ICode1___expr_t)CALL((recv), (SFT_icode_base[28] + 1)))
#define CALL_icode_base___ICode1___init(recv) ((icode_base___ICode1___init_t)CALL((recv), (SFT_icode_base[28] + 2)))
#define ID_ICode2 (SFT_icode_base[29])
#define COLOR_ICode2 (SFT_icode_base[30])
#define ATTR_icode_base___ICode2____expr1(recv) ATTR(recv, (SFT_icode_base[31] + 0))
#define ATTR_icode_base___ICode2____expr2(recv) ATTR(recv, (SFT_icode_base[31] + 1))
#define INIT_TABLE_POS_ICode2 (SFT_icode_base[32] + 0)
#define CALL_icode_base___ICode2___expr1(recv) ((icode_base___ICode2___expr1_t)CALL((recv), (SFT_icode_base[32] + 1)))
#define CALL_icode_base___ICode2___expr2(recv) ((icode_base___ICode2___expr2_t)CALL((recv), (SFT_icode_base[32] + 2)))
#define CALL_icode_base___ICode2___init(recv) ((icode_base___ICode2___init_t)CALL((recv), (SFT_icode_base[32] + 3)))
#define ID_ICodeN (SFT_icode_base[33])
#define COLOR_ICodeN (SFT_icode_base[34])
#define ATTR_icode_base___ICodeN____exprs(recv) ATTR(recv, (SFT_icode_base[35] + 0))
#define ATTR_icode_base___ICodeN____closure_defs(recv) ATTR(recv, (SFT_icode_base[35] + 1))
#define INIT_TABLE_POS_ICodeN (SFT_icode_base[36] + 0)
#define CALL_icode_base___ICodeN___exprs(recv) ((icode_base___ICodeN___exprs_t)CALL((recv), (SFT_icode_base[36] + 1)))
#define CALL_icode_base___ICodeN___closure_defs(recv) ((icode_base___ICodeN___closure_defs_t)CALL((recv), (SFT_icode_base[36] + 2)))
#define CALL_icode_base___ICodeN___closure_defs__eq(recv) ((icode_base___ICodeN___closure_defs__eq_t)CALL((recv), (SFT_icode_base[36] + 3)))
#define CALL_icode_base___ICodeN___init(recv) ((icode_base___ICodeN___init_t)CALL((recv), (SFT_icode_base[36] + 4)))
#define ID_ISeq (SFT_icode_base[37])
#define COLOR_ISeq (SFT_icode_base[38])
#define ATTR_icode_base___ISeq____icodes(recv) ATTR(recv, (SFT_icode_base[39] + 0))
#define ATTR_icode_base___ISeq____iescape_mark(recv) ATTR(recv, (SFT_icode_base[39] + 1))
#define INIT_TABLE_POS_ISeq (SFT_icode_base[40] + 0)
#define CALL_icode_base___ISeq___icodes(recv) ((icode_base___ISeq___icodes_t)CALL((recv), (SFT_icode_base[40] + 1)))
#define CALL_icode_base___ISeq___iescape_mark(recv) ((icode_base___ISeq___iescape_mark_t)CALL((recv), (SFT_icode_base[40] + 2)))
#define CALL_icode_base___ISeq___iescape_mark__eq(recv) ((icode_base___ISeq___iescape_mark__eq_t)CALL((recv), (SFT_icode_base[40] + 3)))
#define CALL_icode_base___ISeq___init(recv) ((icode_base___ISeq___init_t)CALL((recv), (SFT_icode_base[40] + 4)))
#define ID_ILoop (SFT_icode_base[41])
#define COLOR_ILoop (SFT_icode_base[42])
#define INIT_TABLE_POS_ILoop (SFT_icode_base[43] + 0)
#define CALL_icode_base___ILoop___init(recv) ((icode_base___ILoop___init_t)CALL((recv), (SFT_icode_base[43] + 1)))
#define ID_IIf (SFT_icode_base[44])
#define COLOR_IIf (SFT_icode_base[45])
#define ATTR_icode_base___IIf____then_seq(recv) ATTR(recv, (SFT_icode_base[46] + 0))
#define ATTR_icode_base___IIf____else_seq(recv) ATTR(recv, (SFT_icode_base[46] + 1))
#define INIT_TABLE_POS_IIf (SFT_icode_base[47] + 0)
#define CALL_icode_base___IIf___then_seq(recv) ((icode_base___IIf___then_seq_t)CALL((recv), (SFT_icode_base[47] + 1)))
#define CALL_icode_base___IIf___else_seq(recv) ((icode_base___IIf___else_seq_t)CALL((recv), (SFT_icode_base[47] + 2)))
#define CALL_icode_base___IIf___init(recv) ((icode_base___IIf___init_t)CALL((recv), (SFT_icode_base[47] + 3)))
#define ID_IEscape (SFT_icode_base[48])
#define COLOR_IEscape (SFT_icode_base[49])
#define ATTR_icode_base___IEscape____iescape_mark(recv) ATTR(recv, (SFT_icode_base[50] + 0))
#define INIT_TABLE_POS_IEscape (SFT_icode_base[51] + 0)
#define CALL_icode_base___IEscape___iescape_mark(recv) ((icode_base___IEscape___iescape_mark_t)CALL((recv), (SFT_icode_base[51] + 1)))
#define CALL_icode_base___IEscape___init(recv) ((icode_base___IEscape___init_t)CALL((recv), (SFT_icode_base[51] + 2)))
#define ID_IAbort (SFT_icode_base[52])
#define COLOR_IAbort (SFT_icode_base[53])
#define ATTR_icode_base___IAbort____texts(recv) ATTR(recv, (SFT_icode_base[54] + 0))
#define ATTR_icode_base___IAbort____module_location(recv) ATTR(recv, (SFT_icode_base[54] + 1))
#define INIT_TABLE_POS_IAbort (SFT_icode_base[55] + 0)
#define CALL_icode_base___IAbort___texts(recv) ((icode_base___IAbort___texts_t)CALL((recv), (SFT_icode_base[55] + 1)))
#define CALL_icode_base___IAbort___module_location(recv) ((icode_base___IAbort___module_location_t)CALL((recv), (SFT_icode_base[55] + 2)))
#define CALL_icode_base___IAbort___init(recv) ((icode_base___IAbort___init_t)CALL((recv), (SFT_icode_base[55] + 3)))
#define ID_IAbsCall (SFT_icode_base[56])
#define COLOR_IAbsCall (SFT_icode_base[57])
#define ATTR_icode_base___IAbsCall____property(recv) ATTR(recv, (SFT_icode_base[58] + 0))
#define INIT_TABLE_POS_IAbsCall (SFT_icode_base[59] + 0)
#define CALL_icode_base___IAbsCall___property(recv) ((icode_base___IAbsCall___property_t)CALL((recv), (SFT_icode_base[59] + 1)))
#define CALL_icode_base___IAbsCall___init(recv) ((icode_base___IAbsCall___init_t)CALL((recv), (SFT_icode_base[59] + 2)))
#define ID_ICall (SFT_icode_base[60])
#define COLOR_ICall (SFT_icode_base[61])
#define INIT_TABLE_POS_ICall (SFT_icode_base[62] + 0)
#define CALL_icode_base___ICall___init(recv) ((icode_base___ICall___init_t)CALL((recv), (SFT_icode_base[62] + 1)))
#define ID_ISuper (SFT_icode_base[63])
#define COLOR_ISuper (SFT_icode_base[64])
#define INIT_TABLE_POS_ISuper (SFT_icode_base[65] + 0)
#define CALL_icode_base___ISuper___init(recv) ((icode_base___ISuper___init_t)CALL((recv), (SFT_icode_base[65] + 1)))
#define ID_INew (SFT_icode_base[66])
#define COLOR_INew (SFT_icode_base[67])
#define ATTR_icode_base___INew____stype(recv) ATTR(recv, (SFT_icode_base[68] + 0))
#define INIT_TABLE_POS_INew (SFT_icode_base[69] + 0)
#define CALL_icode_base___INew___stype(recv) ((icode_base___INew___stype_t)CALL((recv), (SFT_icode_base[69] + 1)))
#define CALL_icode_base___INew___init(recv) ((icode_base___INew___init_t)CALL((recv), (SFT_icode_base[69] + 2)))
#define ID_IAllocateInstance (SFT_icode_base[70])
#define COLOR_IAllocateInstance (SFT_icode_base[71])
#define ATTR_icode_base___IAllocateInstance____stype(recv) ATTR(recv, (SFT_icode_base[72] + 0))
#define INIT_TABLE_POS_IAllocateInstance (SFT_icode_base[73] + 0)
#define CALL_icode_base___IAllocateInstance___stype(recv) ((icode_base___IAllocateInstance___stype_t)CALL((recv), (SFT_icode_base[73] + 1)))
#define CALL_icode_base___IAllocateInstance___init(recv) ((icode_base___IAllocateInstance___init_t)CALL((recv), (SFT_icode_base[73] + 2)))
#define ID_IStaticCall (SFT_icode_base[74])
#define COLOR_IStaticCall (SFT_icode_base[75])
#define INIT_TABLE_POS_IStaticCall (SFT_icode_base[76] + 0)
#define CALL_icode_base___IStaticCall___init(recv) ((icode_base___IStaticCall___init_t)CALL((recv), (SFT_icode_base[76] + 1)))
#define ID_ICheckInstance (SFT_icode_base[77])
#define COLOR_ICheckInstance (SFT_icode_base[78])
#define ATTR_icode_base___ICheckInstance____stype(recv) ATTR(recv, (SFT_icode_base[79] + 0))
#define INIT_TABLE_POS_ICheckInstance (SFT_icode_base[80] + 0)
#define CALL_icode_base___ICheckInstance___stype(recv) ((icode_base___ICheckInstance___stype_t)CALL((recv), (SFT_icode_base[80] + 1)))
#define CALL_icode_base___ICheckInstance___init(recv) ((icode_base___ICheckInstance___init_t)CALL((recv), (SFT_icode_base[80] + 2)))
#define ID_IInitAttributes (SFT_icode_base[81])
#define COLOR_IInitAttributes (SFT_icode_base[82])
#define ATTR_icode_base___IInitAttributes____stype(recv) ATTR(recv, (SFT_icode_base[83] + 0))
#define INIT_TABLE_POS_IInitAttributes (SFT_icode_base[84] + 0)
#define CALL_icode_base___IInitAttributes___stype(recv) ((icode_base___IInitAttributes___stype_t)CALL((recv), (SFT_icode_base[84] + 1)))
#define CALL_icode_base___IInitAttributes___init(recv) ((icode_base___IInitAttributes___init_t)CALL((recv), (SFT_icode_base[84] + 2)))
#define ID_IClosCall (SFT_icode_base[85])
#define COLOR_IClosCall (SFT_icode_base[86])
#define ATTR_icode_base___IClosCall____closure_decl(recv) ATTR(recv, (SFT_icode_base[87] + 0))
#define ATTR_icode_base___IClosCall____break_seq(recv) ATTR(recv, (SFT_icode_base[87] + 1))
#define INIT_TABLE_POS_IClosCall (SFT_icode_base[88] + 0)
#define CALL_icode_base___IClosCall___closure_decl(recv) ((icode_base___IClosCall___closure_decl_t)CALL((recv), (SFT_icode_base[88] + 1)))
#define CALL_icode_base___IClosCall___break_seq(recv) ((icode_base___IClosCall___break_seq_t)CALL((recv), (SFT_icode_base[88] + 2)))
#define CALL_icode_base___IClosCall___break_seq__eq(recv) ((icode_base___IClosCall___break_seq__eq_t)CALL((recv), (SFT_icode_base[88] + 3)))
