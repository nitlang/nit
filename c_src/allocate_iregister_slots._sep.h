/* This C header file is generated by NIT to compile modules and programs that requires allocate_iregister_slots. */
#ifndef allocate_iregister_slots_sep
#define allocate_iregister_slots_sep
...
extern const char *LOCATE_allocate_iregister_slots;
extern const int SFT_allocate_iregister_slots[];
...
#define CALL_SUPER_allocate_iregister_slots___IRegisterSlotAllocationVisitor___visit_icode(recv) ((allocate_iregister_slots___IRegisterSlotAllocationVisitor___visit_icode_t)CALL((recv), (SFT_allocate_iregister_slots[3] + 3)))
#define CALL_SUPER_allocate_iregister_slots___IRegisterSlotAllocationVisitor___visit_closure_defs(recv) ((allocate_iregister_slots___IRegisterSlotAllocationVisitor___visit_closure_defs_t)CALL((recv), (SFT_allocate_iregister_slots[3] + 4)))
#define CALL_SUPER_allocate_iregister_slots___IRegisterSlotAllocationVisitor___visit_iroutine(recv) ((allocate_iregister_slots___IRegisterSlotAllocationVisitor___visit_iroutine_t)CALL((recv), (SFT_allocate_iregister_slots[3] + 5)))
#define CALL_allocate_iregister_slots___IRegisterSlotAllocationVisitor___register(recv) ((allocate_iregister_slots___IRegisterSlotAllocationVisitor___register_t)CALL((recv), (SFT_allocate_iregister_slots[3] + 6)))
#define CALL_allocate_iregister_slots___IRegisterSlotAllocationVisitor___free(recv) ((allocate_iregister_slots___IRegisterSlotAllocationVisitor___free_t)CALL((recv), (SFT_allocate_iregister_slots[3] + 7)))
#define CALL_allocate_iregister_slots___IRegisterSlotAllocationVisitor___iroutine_slot_allocation(recv) ((allocate_iregister_slots___IRegisterSlotAllocationVisitor___iroutine_slot_allocation_t)CALL((recv), (SFT_allocate_iregister_slots[3] + 8)))
#define CALL_allocate_iregister_slots___IRegisterSlotAllocationVisitor___init(recv) ((allocate_iregister_slots___IRegisterSlotAllocationVisitor___init_t)CALL((recv), (SFT_allocate_iregister_slots[3] + 9)))
#define ID_SlotGroup (SFT_allocate_iregister_slots[4])
#define COLOR_SlotGroup (SFT_allocate_iregister_slots[5])
#define ATTR_allocate_iregister_slots___SlotGroup____free(recv) ATTR(recv, (SFT_allocate_iregister_slots[6] + 0))
#define ATTR_allocate_iregister_slots___SlotGroup____next_index(recv) ATTR(recv, (SFT_allocate_iregister_slots[6] + 1))
#define INIT_TABLE_POS_SlotGroup (SFT_allocate_iregister_slots[7] + 0)
#define CALL_allocate_iregister_slots___SlotGroup___register(recv) ((allocate_iregister_slots___SlotGroup___register_t)CALL((recv), (SFT_allocate_iregister_slots[7] + 1)))
#define CALL_allocate_iregister_slots___SlotGroup___free(recv) ((allocate_iregister_slots___SlotGroup___free_t)CALL((recv), (SFT_allocate_iregister_slots[7] + 2)))
#define CALL_allocate_iregister_slots___SlotGroup___init(recv) ((allocate_iregister_slots___SlotGroup___init_t)CALL((recv), (SFT_allocate_iregister_slots[7] + 3)))
#define ATTR_allocate_iregister_slots___IRoutine____std_slots_nb(recv) ATTR(recv, (SFT_allocate_iregister_slots[8] + 0))
#define ATTR_allocate_iregister_slots___IRoutine____tag_slots_nb(recv) ATTR(recv, (SFT_allocate_iregister_slots[8] + 1))
#define CALL_allocate_iregister_slots___IRoutine___std_slots_nb(recv) ((allocate_iregister_slots___IRoutine___std_slots_nb_t)CALL((recv), (SFT_allocate_iregister_slots[9] + 0)))
#define CALL_allocate_iregister_slots___IRoutine___tag_slots_nb(recv) ((allocate_iregister_slots___IRoutine___tag_slots_nb_t)CALL((recv), (SFT_allocate_iregister_slots[9] + 1)))
#define CALL_allocate_iregister_slots___IRoutine___allocate_iregister_slots(recv) ((allocate_iregister_slots___IRoutine___allocate_iregister_slots_t)CALL((recv), (SFT_allocate_iregister_slots[9] + 2)))
#define ATTR_allocate_iregister_slots___IRegister____slot_index(recv) ATTR(recv, (SFT_allocate_iregister_slots[10] + 0))
...
#define CALL_allocate_iregister_slots___IRegister___is_local__eq(recv) ((allocate_iregister_slots___IRegister___is_local__eq_t)CALL((recv), (SFT_allocate_iregister_slots[11] + 3)))
#define CALL_allocate_iregister_slots___IRegister___local_iroutine(recv) ((allocate_iregister_slots___IRegister___local_iroutine_t)CALL((recv), (SFT_allocate_iregister_slots[11] + 4)))
