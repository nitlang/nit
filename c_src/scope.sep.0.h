...
extern const struct type type_scope__ClosureVariable;
void CHECK_NEW_scope__ClosureVariable(val*);
extern const int COLOR_scope__AClosureDecl__variable_61d;
...
extern const struct type type_parser_nodes__AClosureCallExpr;
extern const int COLOR_parser_nodes__ACallFormExpr__n_args;
extern const int COLOR_parser_nodes__ASendExpr__n_closure_defs;
extern const int COLOR_parser_prod__AClosureCallExpr__init_aclosurecallexpr;
void CHECK_NEW_parser_nodes__AClosureCallExpr(val*);
extern const int COLOR_scope__AClosureCallExpr__variable_61d;
...
extern const int COLOR_scope__ASendExpr__escapemark_61d;
extern const int COLOR_scope__ASendExpr__accept_scope_visitor;
...
extern const int COLOR_scope__AClosureDef__variables_61d;
extern const int COLOR_parser_nodes__AClosureDef__n_ids;
extern const int COLOR_parser_nodes__ANode__parent;
extern const struct type type_parser_nodes__ASendExpr;
extern const int COLOR_scope__ASendExpr__escapemark;
extern const int COLOR_scope__AClosureDef__escapemark_61d;
extern const int COLOR_parser_nodes__AClosureDef__n_expr;
extern const int COLOR_scope__AClosureDef__escapemark;
