...
static const char * const LOCATE_genericity___MMLocalClass___get_formal = "genericity::MMLocalClass::get_formal";
val_t genericity___MMLocalClass___get_formal(val_t p0, val_t p1);
typedef val_t (*genericity___MMLocalClass___get_formal_t)(val_t p0, val_t p1);
static const char * const LOCATE_genericity___MMLocalClass___register_formal = "genericity::MMLocalClass::register_formal";
void genericity___MMLocalClass___register_formal(val_t p0, val_t p1);
typedef void (*genericity___MMLocalClass___register_formal_t)(val_t p0, val_t p1);
static const char * const LOCATE_genericity___MMLocalClass___get_instantiate_type = "genericity::MMLocalClass::get_instantiate_type";
val_t genericity___MMLocalClass___get_instantiate_type(val_t p0, val_t p1);
typedef val_t (*genericity___MMLocalClass___get_instantiate_type_t)(val_t p0, val_t p1);
static const char * const LOCATE_genericity___MMLocalClass___formals_types = "genericity::MMLocalClass::formals_types";
val_t genericity___MMLocalClass___formals_types(val_t p0);
typedef val_t (*genericity___MMLocalClass___formals_types_t)(val_t p0);
static const char * const LOCATE_genericity___MMLocalClass___get_type = "genericity::MMLocalClass::(static_type::MMLocalClass::get_type)";
val_t genericity___MMLocalClass___get_type(val_t p0);
typedef val_t (*genericity___MMLocalClass___get_type_t)(val_t p0);
static const char * const LOCATE_genericity___MMLocalClass___is_generic = "genericity::MMLocalClass::is_generic";
val_t genericity___MMLocalClass___is_generic(val_t p0);
typedef val_t (*genericity___MMLocalClass___is_generic_t)(val_t p0);
val_t NEW_MMLocalClass_abstractmetamodel___MMLocalClass___init(val_t p0, val_t p1, val_t p2);
static const char * const LOCATE_genericity___MMType___is_generic = "genericity::MMType::is_generic";
val_t genericity___MMType___is_generic(val_t p0);
typedef val_t (*genericity___MMType___is_generic_t)(val_t p0);
val_t NEW_MMType_static_type___MMType___init();
static const char * const LOCATE_genericity___MMTypeFormal___is_generic = "genericity::MMTypeFormal::(genericity::MMType::is_generic)";
val_t genericity___MMTypeFormal___is_generic(val_t p0);
typedef val_t (*genericity___MMTypeFormal___is_generic_t)(val_t p0);
val_t NEW_MMTypeFormal_type_formal___MMTypeFormal___init(val_t p0, val_t p1);
static const char * const LOCATE_genericity___MMTypeSimpleClass___is_generic = "genericity::MMTypeSimpleClass::(genericity::MMType::is_generic)";
val_t genericity___MMTypeSimpleClass___is_generic(val_t p0);
typedef val_t (*genericity___MMTypeSimpleClass___is_generic_t)(val_t p0);
...
static const char * const LOCATE_genericity___MMTypeFormalParameter___def_class = "genericity::MMTypeFormalParameter::def_class";
val_t genericity___MMTypeFormalParameter___def_class(val_t p0);
typedef val_t (*genericity___MMTypeFormalParameter___def_class_t)(val_t p0);
static const char * const LOCATE_genericity___MMTypeFormalParameter___position = "genericity::MMTypeFormalParameter::position";
val_t genericity___MMTypeFormalParameter___position(val_t p0);
typedef val_t (*genericity___MMTypeFormalParameter___position_t)(val_t p0);
static const char * const LOCATE_genericity___MMTypeFormalParameter___mmmodule = "genericity::MMTypeFormalParameter::(static_type::MMType::mmmodule)";
val_t genericity___MMTypeFormalParameter___mmmodule(val_t p0);
typedef val_t (*genericity___MMTypeFormalParameter___mmmodule_t)(val_t p0);
static const char * const LOCATE_genericity___MMTypeFormalParameter___for_module = "genericity::MMTypeFormalParameter::(static_type::MMType::for_module)";
val_t genericity___MMTypeFormalParameter___for_module(val_t p0, val_t p1);
typedef val_t (*genericity___MMTypeFormalParameter___for_module_t)(val_t p0, val_t p1);
static const char * const LOCATE_genericity___MMTypeFormalParameter___upcast_for = "genericity::MMTypeFormalParameter::(static_type::MMType::upcast_for)";
val_t genericity___MMTypeFormalParameter___upcast_for(val_t p0, val_t p1);
typedef val_t (*genericity___MMTypeFormalParameter___upcast_for_t)(val_t p0, val_t p1);
static const char * const LOCATE_genericity___MMTypeFormalParameter___bound__eq = "genericity::MMTypeFormalParameter::bound=";
void genericity___MMTypeFormalParameter___bound__eq(val_t p0, val_t p1);
typedef void (*genericity___MMTypeFormalParameter___bound__eq_t)(val_t p0, val_t p1);
static const char * const LOCATE_genericity___MMTypeFormalParameter___adapt_to = "genericity::MMTypeFormalParameter::(static_type::MMType::adapt_to)";
val_t genericity___MMTypeFormalParameter___adapt_to(val_t p0, val_t p1);
typedef val_t (*genericity___MMTypeFormalParameter___adapt_to_t)(val_t p0, val_t p1);
static const char * const LOCATE_genericity___MMTypeFormalParameter___with_bound = "genericity::MMTypeFormalParameter::with_bound";
void genericity___MMTypeFormalParameter___with_bound(val_t p0, val_t p1, val_t p2, val_t p3, val_t p4, int* init_table);
typedef void (*genericity___MMTypeFormalParameter___with_bound_t)(val_t p0, val_t p1, val_t p2, val_t p3, val_t p4, int* init_table);
val_t NEW_MMTypeFormalParameter_genericity___MMTypeFormalParameter___with_bound(val_t p0, val_t p1, val_t p2, val_t p3);
static const char * const LOCATE_genericity___MMTypeFormalParameter___init = "genericity::MMTypeFormalParameter::init";
void genericity___MMTypeFormalParameter___init(val_t p0, val_t p1, val_t p2, val_t p3, int* init_table);
typedef void (*genericity___MMTypeFormalParameter___init_t)(val_t p0, val_t p1, val_t p2, val_t p3, int* init_table);
val_t NEW_MMTypeFormalParameter_genericity___MMTypeFormalParameter___init(val_t p0, val_t p1, val_t p2);
static const char * const LOCATE_genericity___MMTypeNone___is_generic = "genericity::MMTypeNone::(genericity::MMType::is_generic)";
val_t genericity___MMTypeNone___is_generic(val_t p0);
typedef val_t (*genericity___MMTypeNone___is_generic_t)(val_t p0);
static const char * const LOCATE_genericity___MMTypeNone___for_module = "genericity::MMTypeNone::(static_type::MMType::for_module)";
val_t genericity___MMTypeNone___for_module(val_t p0, val_t p1);
typedef val_t (*genericity___MMTypeNone___for_module_t)(val_t p0, val_t p1);
static const char * const LOCATE_genericity___MMTypeNone___adapt_to = "genericity::MMTypeNone::(static_type::MMType::adapt_to)";
val_t genericity___MMTypeNone___adapt_to(val_t p0, val_t p1);
typedef val_t (*genericity___MMTypeNone___adapt_to_t)(val_t p0, val_t p1);
