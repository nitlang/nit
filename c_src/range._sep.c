...
val_t range___Range___first(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_first", LOCATE_range, 22);
  }
...
val_t range___Range___last(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_last", LOCATE_range, 24);
  }
...
val_t range___Range___after(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_after", LOCATE_range, 27);
  }
...
val_t range___Range___has(val_t p0, val_t p1){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_first", LOCATE_range, 30);
  }
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    if (UNTAG_Bool(REGB0)) {
      ...
      nit_abort("Uninitialized attribute %s", "_last", LOCATE_range, 30);
    }
    fra.me.REG[0] = ATTR_range___Range____last(fra.me.REG[0]);
...
val_t range___Range___has_only(val_t p0, val_t p1){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_first", LOCATE_range, 32);
  }
  fra.me.REG[2] = ATTR_range___Range____first(fra.me.REG[0]);
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    if (UNTAG_Bool(REGB0)) {
      ...
      nit_abort("Uninitialized attribute %s", "_last", LOCATE_range, 32);
    }
    fra.me.REG[0] = ATTR_range___Range____last(fra.me.REG[0]);
...
void range___Range___iterate(val_t p0, struct stack_frame_t *closctx_param, fun_t clos_fun0){
  ...
  fra.me.file = LOCATE_range;
  fra.me.line = 45;
  fra.me.meth = LOCATE_range___Range___iterate;
  fra.me.has_broke = 0;
  fra.me.REG_size = 3;
  fra.me.REG[0] = NIT_NULL;
  fra.me.REG[1] = NIT_NULL;
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_first", LOCATE_range, 48);
  }
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_last", LOCATE_range, 49);
  }
  fra.me.REG[0] = ATTR_range___Range____last(fra.me.REG[0]);
  ...
  while(1) {
    ...
    if (UNTAG_Bool(REGB0)) {
      ...
      fra.me.REG[2] = CALL_kernel___Discrete___succ(fra.me.REG[1])(fra.me.REG[1]);
...
val_t range___Range___length(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_first", LOCATE_range, 58);
  }
  fra.me.REG[1] = ATTR_range___Range____first(fra.me.REG[0]);
  REGB0 = TAG_Bool(ATTR_range___Range____after(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
    nit_abort("Uninitialized attribute %s", "_after", LOCATE_range, 58);
  }
  fra.me.REG[0] = ATTR_range___Range____after(fra.me.REG[0]);
...
val_t range___Range___is_empty(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_first", LOCATE_range, 66);
  }
  fra.me.REG[1] = ATTR_range___Range____first(fra.me.REG[0]);
  REGB0 = TAG_Bool(ATTR_range___Range____after(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
    nit_abort("Uninitialized attribute %s", "_after", LOCATE_range, 66);
  }
  fra.me.REG[0] = ATTR_range___Range____after(fra.me.REG[0]);
...
val_t range___IteratorRange___item(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_item", LOCATE_range, 91);
  }
...
val_t range___IteratorRange___is_ok(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_item", LOCATE_range, 93);
  }
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_range", LOCATE_range, 93);
  }
...
void range___IteratorRange___next(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_item", LOCATE_range, 95);
  }
  fra.me.REG[1] = ATTR_range___IteratorRange____item(fra.me.REG[0]);
