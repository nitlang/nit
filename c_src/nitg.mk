...
nitg.classes.11.o: nitg.classes.11.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o nitg.classes.11.o nitg.classes.11.c

nitg.classes.12.o: nitg.classes.12.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o nitg.classes.12.o nitg.classes.12.c
...
parser.sep.16.o: parser.sep.16.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o parser.sep.16.o parser.sep.16.c
...
common_ffi.sep.1.o: common_ffi.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o common_ffi.sep.1.o common_ffi.sep.1.c

nitni_base.sep.1.o: nitni_base.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o nitni_base.sep.1.o nitni_base.sep.1.c

nitni_callbacks.sep.1.o: nitni_callbacks.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o nitni_callbacks.sep.1.o nitni_callbacks.sep.1.c

nitni_utilities.sep.1.o: nitni_utilities.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o nitni_utilities.sep.1.o nitni_utilities.sep.1.c

ffi_base.sep.1.o: ffi_base.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o ffi_base.sep.1.o ffi_base.sep.1.c

c_tools.sep.1.o: c_tools.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o c_tools.sep.1.o c_tools.sep.1.c

compiling_writer.sep.1.o: compiling_writer.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o compiling_writer.sep.1.o compiling_writer.sep.1.c

extern_classes.sep.1.o: extern_classes.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o extern_classes.sep.1.o extern_classes.sep.1.c

header_dependency.sep.1.o: header_dependency.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o header_dependency.sep.1.o header_dependency.sep.1.c

c.sep.1.o: c.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o c.sep.1.o c.sep.1.c

pkgconfig.sep.1.o: pkgconfig.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o pkgconfig.sep.1.o pkgconfig.sep.1.c

c_compiler_options.sep.1.o: c_compiler_options.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o c_compiler_options.sep.1.o c_compiler_options.sep.1.c

cpp.sep.1.o: cpp.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o cpp.sep.1.o cpp.sep.1.c

compiler_ffi.sep.1.o: compiler_ffi.sep.1.c
	$(CC) $(CFLAGS) $(CINCL) -D NONITCNI -c -o compiler_ffi.sep.1.o compiler_ffi.sep.1.c
...
string._ffi.extern.o: ../.nit_compile/string._ffi.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o string._ffi.extern.o ../.nit_compile/string._ffi.c

string._nitni.extern.o: ../.nit_compile/string._nitni.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o string._nitni.extern.o ../.nit_compile/string._nitni.c

file._ffi.extern.o: ../.nit_compile/file._ffi.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o file._ffi.extern.o ../.nit_compile/file._ffi.c

file._nitni.extern.o: ../.nit_compile/file._nitni.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o file._nitni.extern.o ../.nit_compile/file._nitni.c

stream._ffi.extern.o: ../.nit_compile/stream._ffi.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o stream._ffi.extern.o ../.nit_compile/stream._ffi.c

stream._nitni.extern.o: ../.nit_compile/stream._nitni.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o stream._nitni.extern.o ../.nit_compile/stream._nitni.c

time._ffi.extern.o: ../.nit_compile/time._ffi.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o time._ffi.extern.o ../.nit_compile/time._ffi.c

time._nitni.extern.o: ../.nit_compile/time._nitni.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o time._nitni.extern.o ../.nit_compile/time._nitni.c

environ._ffi.extern.o: ../.nit_compile/environ._ffi.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o environ._ffi.extern.o ../.nit_compile/environ._ffi.c

environ._nitni.extern.o: ../.nit_compile/environ._nitni.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o environ._nitni.extern.o ../.nit_compile/environ._nitni.c

exec._ffi.extern.o: ../.nit_compile/exec._ffi.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o exec._ffi.extern.o ../.nit_compile/exec._ffi.c

exec._nitni.extern.o: ../.nit_compile/exec._nitni.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o exec._nitni.extern.o ../.nit_compile/exec._nitni.c

math._ffi.extern.o: ../.nit_compile/math._ffi.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o math._ffi.extern.o ../.nit_compile/math._ffi.c

math._nitni.extern.o: ../.nit_compile/math._nitni.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o math._nitni.extern.o ../.nit_compile/math._nitni.c

tables._ffi.extern.o: ../.nit_compile/tables._ffi.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o tables._ffi.extern.o ../.nit_compile/tables._ffi.c

tables._nitni.extern.o: ../.nit_compile/tables._nitni.c
	$(CC) $(CFLAGS) -D NONITCNI  -c -o tables._nitni.extern.o ../.nit_compile/tables._nitni.c

gc_chooser.extern.o: ../clib/gc_chooser.c
	$(CC) $(CFLAGS) -D NONITCNI -DWITH_LIBGC -c -o gc_chooser.extern.o ../clib/gc_chooser.c

../c_src2/nitg: nitg.classes.1.o nitg.classes.2.o nitg.classes.3.o nitg.classes.4.o nitg.classes.5.o nitg.classes.6.o nitg.classes.7.o nitg.classes.8.o nitg.classes.9.o nitg.classes.10.o nitg.classes.11.o nitg.classes.12.o nitg.main.1.o nitg.sep.1.o modelbuilder.sep.1.o parser.sep.1.o parser.sep.2.o parser.sep.3.o parser.sep.4.o parser.sep.5.o parser.sep.6.o parser.sep.7.o parser.sep.8.o parser.sep.9.o parser.sep.10.o parser.sep.11.o parser.sep.12.o parser.sep.13.o parser.sep.14.o parser.sep.15.o parser.sep.16.o parser_prod.sep.1.o parser_prod.sep.2.o parser_prod.sep.3.o parser_prod.sep.4.o parser_prod.sep.5.o lexer.sep.1.o parser_nodes.sep.1.o parser_nodes.sep.2.o location.sep.1.o posix.sep.1.o string.sep.1.o collection.sep.1.o abstract_collection.sep.1.o kernel.sep.1.o range.sep.1.o list.sep.1.o array.sep.1.o sorter.sep.1.o hash_collection.sep.1.o ropes.sep.1.o file.sep.1.o stream.sep.1.o string_search.sep.1.o time.sep.1.o environ.sep.1.o exec.sep.1.o math.sep.1.o gc.sep.1.o tables.sep.1.o model.sep.1.o poset.sep.1.o model_base.sep.1.o more_collections.sep.1.o opts.sep.1.o toolcontext.sep.1.o phase.sep.1.o frontend.sep.1.o simple_misc_analysis.sep.1.o literal.sep.1.o scope.sep.1.o flow.sep.1.o local_var_init.sep.1.o typing.sep.1.o typing.sep.2.o modelize_property.sep.1.o modelize_class.sep.1.o auto_super_init.sep.1.o div_by_zero.sep.1.o cached.sep.1.o parser_util.sep.1.o transform.sep.1.o astbuilder.sep.1.o astvalidation.sep.1.o rapid_type_analysis.sep.1.o global_compiler.sep.1.o global_compiler.sep.2.o abstract_compiler.sep.1.o abstract_compiler.sep.2.o abstract_compiler.sep.3.o common_ffi.sep.1.o nitni_base.sep.1.o nitni_callbacks.sep.1.o nitni_utilities.sep.1.o ffi_base.sep.1.o c_tools.sep.1.o compiling_writer.sep.1.o extern_classes.sep.1.o header_dependency.sep.1.o c.sep.1.o pkgconfig.sep.1.o c_compiler_options.sep.1.o cpp.sep.1.o compiler_ffi.sep.1.o separate_erasure_compiler.sep.1.o separate_compiler.sep.1.o separate_compiler.sep.2.o separate_compiler.sep.3.o layout_builders.sep.1.o nitg.types.1.o nitg.types.2.o nitg.types.3.o nitg.types.4.o nitg.types.5.o nitg.types.6.o nitg.types.7.o string_nit.extern.o file_nit.extern.o stream_nit.extern.o time_nit.extern.o exec_nit.extern.o tables_nit.extern.o string._ffi.extern.o string._nitni.extern.o file._ffi.extern.o file._nitni.extern.o stream._ffi.extern.o stream._nitni.extern.o time._ffi.extern.o time._nitni.extern.o environ._ffi.extern.o environ._nitni.extern.o exec._ffi.extern.o exec._nitni.extern.o math._ffi.extern.o math._nitni.extern.o tables._ffi.extern.o tables._nitni.extern.o gc_chooser.extern.o
	$(CC) $(LDFLAGS) -o ../c_src2/nitg nitg.classes.1.o nitg.classes.2.o nitg.classes.3.o nitg.classes.4.o nitg.classes.5.o nitg.classes.6.o nitg.classes.7.o nitg.classes.8.o nitg.classes.9.o nitg.classes.10.o nitg.classes.11.o nitg.classes.12.o nitg.main.1.o nitg.sep.1.o modelbuilder.sep.1.o parser.sep.1.o parser.sep.2.o parser.sep.3.o parser.sep.4.o parser.sep.5.o parser.sep.6.o parser.sep.7.o parser.sep.8.o parser.sep.9.o parser.sep.10.o parser.sep.11.o parser.sep.12.o parser.sep.13.o parser.sep.14.o parser.sep.15.o parser.sep.16.o parser_prod.sep.1.o parser_prod.sep.2.o parser_prod.sep.3.o parser_prod.sep.4.o parser_prod.sep.5.o lexer.sep.1.o parser_nodes.sep.1.o parser_nodes.sep.2.o location.sep.1.o posix.sep.1.o string.sep.1.o collection.sep.1.o abstract_collection.sep.1.o kernel.sep.1.o range.sep.1.o list.sep.1.o array.sep.1.o sorter.sep.1.o hash_collection.sep.1.o ropes.sep.1.o file.sep.1.o stream.sep.1.o string_search.sep.1.o time.sep.1.o environ.sep.1.o exec.sep.1.o math.sep.1.o gc.sep.1.o tables.sep.1.o model.sep.1.o poset.sep.1.o model_base.sep.1.o more_collections.sep.1.o opts.sep.1.o toolcontext.sep.1.o phase.sep.1.o frontend.sep.1.o simple_misc_analysis.sep.1.o literal.sep.1.o scope.sep.1.o flow.sep.1.o local_var_init.sep.1.o typing.sep.1.o typing.sep.2.o modelize_property.sep.1.o modelize_class.sep.1.o auto_super_init.sep.1.o div_by_zero.sep.1.o cached.sep.1.o parser_util.sep.1.o transform.sep.1.o astbuilder.sep.1.o astvalidation.sep.1.o rapid_type_analysis.sep.1.o global_compiler.sep.1.o global_compiler.sep.2.o abstract_compiler.sep.1.o abstract_compiler.sep.2.o abstract_compiler.sep.3.o common_ffi.sep.1.o nitni_base.sep.1.o nitni_callbacks.sep.1.o nitni_utilities.sep.1.o ffi_base.sep.1.o c_tools.sep.1.o compiling_writer.sep.1.o extern_classes.sep.1.o header_dependency.sep.1.o c.sep.1.o pkgconfig.sep.1.o c_compiler_options.sep.1.o cpp.sep.1.o compiler_ffi.sep.1.o separate_erasure_compiler.sep.1.o separate_compiler.sep.1.o separate_compiler.sep.2.o separate_compiler.sep.3.o layout_builders.sep.1.o nitg.types.1.o nitg.types.2.o nitg.types.3.o nitg.types.4.o nitg.types.5.o nitg.types.6.o nitg.types.7.o string_nit.extern.o file_nit.extern.o stream_nit.extern.o time_nit.extern.o exec_nit.extern.o tables_nit.extern.o string._ffi.extern.o string._nitni.extern.o file._ffi.extern.o file._nitni.extern.o stream._ffi.extern.o stream._nitni.extern.o time._ffi.extern.o time._nitni.extern.o environ._ffi.extern.o environ._nitni.extern.o exec._ffi.extern.o exec._nitni.extern.o math._ffi.extern.o math._nitni.extern.o tables._ffi.extern.o tables._nitni.extern.o gc_chooser.extern.o $(LDLIBS)

clean:
	rm nitg.classes.1.o nitg.classes.2.o nitg.classes.3.o nitg.classes.4.o nitg.classes.5.o nitg.classes.6.o nitg.classes.7.o nitg.classes.8.o nitg.classes.9.o nitg.classes.10.o nitg.classes.11.o nitg.classes.12.o nitg.main.1.o nitg.sep.1.o modelbuilder.sep.1.o parser.sep.1.o parser.sep.2.o parser.sep.3.o parser.sep.4.o parser.sep.5.o parser.sep.6.o parser.sep.7.o parser.sep.8.o parser.sep.9.o parser.sep.10.o parser.sep.11.o parser.sep.12.o parser.sep.13.o parser.sep.14.o parser.sep.15.o parser.sep.16.o parser_prod.sep.1.o parser_prod.sep.2.o parser_prod.sep.3.o parser_prod.sep.4.o parser_prod.sep.5.o lexer.sep.1.o parser_nodes.sep.1.o parser_nodes.sep.2.o location.sep.1.o posix.sep.1.o string.sep.1.o collection.sep.1.o abstract_collection.sep.1.o kernel.sep.1.o range.sep.1.o list.sep.1.o array.sep.1.o sorter.sep.1.o hash_collection.sep.1.o ropes.sep.1.o file.sep.1.o stream.sep.1.o string_search.sep.1.o time.sep.1.o environ.sep.1.o exec.sep.1.o math.sep.1.o gc.sep.1.o tables.sep.1.o model.sep.1.o poset.sep.1.o model_base.sep.1.o more_collections.sep.1.o opts.sep.1.o toolcontext.sep.1.o phase.sep.1.o frontend.sep.1.o simple_misc_analysis.sep.1.o literal.sep.1.o scope.sep.1.o flow.sep.1.o local_var_init.sep.1.o typing.sep.1.o typing.sep.2.o modelize_property.sep.1.o modelize_class.sep.1.o auto_super_init.sep.1.o div_by_zero.sep.1.o cached.sep.1.o parser_util.sep.1.o transform.sep.1.o astbuilder.sep.1.o astvalidation.sep.1.o rapid_type_analysis.sep.1.o global_compiler.sep.1.o global_compiler.sep.2.o abstract_compiler.sep.1.o abstract_compiler.sep.2.o abstract_compiler.sep.3.o common_ffi.sep.1.o nitni_base.sep.1.o nitni_callbacks.sep.1.o nitni_utilities.sep.1.o ffi_base.sep.1.o c_tools.sep.1.o compiling_writer.sep.1.o extern_classes.sep.1.o header_dependency.sep.1.o c.sep.1.o pkgconfig.sep.1.o c_compiler_options.sep.1.o cpp.sep.1.o compiler_ffi.sep.1.o separate_erasure_compiler.sep.1.o separate_compiler.sep.1.o separate_compiler.sep.2.o separate_compiler.sep.3.o layout_builders.sep.1.o nitg.types.1.o nitg.types.2.o nitg.types.3.o nitg.types.4.o nitg.types.5.o nitg.types.6.o nitg.types.7.o string_nit.extern.o file_nit.extern.o stream_nit.extern.o time_nit.extern.o exec_nit.extern.o tables_nit.extern.o string._ffi.extern.o string._nitni.extern.o file._ffi.extern.o file._nitni.extern.o stream._ffi.extern.o stream._nitni.extern.o time._ffi.extern.o time._nitni.extern.o environ._ffi.extern.o environ._nitni.extern.o exec._ffi.extern.o exec._nitni.extern.o math._ffi.extern.o math._nitni.extern.o tables._ffi.extern.o tables._nitni.extern.o gc_chooser.extern.o 2>/dev/null
