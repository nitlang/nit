...
extern const struct types resolution_table_kernel__Object;
extern const struct types resolution_table_nullable_kernel__Object;
...
extern const struct types resolution_table_nitni_callbacks__VerifyNitniCallbacksPhase;
extern const struct types resolution_table_transform__TransformPhase;
extern const struct types resolution_table_ffi_base__FFILanguageAssignationPhase;
...
extern const struct types resolution_table_c__CLanguage;
extern const struct types resolution_table_cpp__CPPLanguage;
extern const struct types resolution_table_extern_classes__ExternClassesTypingPhaseAst;
extern const struct types resolution_table_extern_classes__ExternClassesTypingPhaseModel;
extern const struct types resolution_table_header_dependency__HeaderDependancyPhase;
extern const struct types resolution_table_pkgconfig__PkgconfigPhase;
extern const struct types resolution_table_c_compiler_options__CCompilerOptionsPhase;
...
extern const struct types resolution_table_tables__TablesCapable;
...
extern const struct types resolution_table_c__ExternCFile;
...
extern const struct types resolution_table_c__ForeignCType;
extern const struct types resolution_table_ffi_base__ForeignType;
extern const struct types resolution_table_cpp__ForeignCppType;
...
extern const struct types resolution_table_nitni_callbacks__ForeignCallbackSet;
...
extern const struct types resolution_table_exec__IProcess;
...
extern const struct types resolution_table_c_compiler_options__DirectCCompilerOption;
extern const struct types resolution_table_c_compiler_options__ExecCCompilerOption;
...
extern const struct types resolution_table_nitni_callbacks__MExplicitSuper;
extern const struct types resolution_table_nitni_callbacks__MExplicitCall;
...
extern const struct types resolution_table_stream__FDIStream;
extern const struct types resolution_table_stream__FDStream;
...
extern const struct types resolution_table_c_tools__CCompilationUnit;
extern const struct types resolution_table_compiling_writer__Writer;
extern const struct types resolution_table_compiling_writer__WriterStrings;
...
extern const struct types resolution_table_nitni_callbacks__MExplicitCast;
extern const struct types resolution_table_exec__NativeProcess;
extern const struct types resolution_table_nitni_utilities__SignatureLength;
extern const struct types resolution_table_nitni_utilities__CallContext;
...
extern const struct types resolution_table_cpp__CPPCompilationUnit;
extern const struct types resolution_table_c_tools__CFunction;
extern const struct types resolution_table_cpp__ExternCppFile;
extern const struct types resolution_table_c__ExternCFunction;
extern const struct types resolution_table_c__FromCCallContext;
extern const struct types resolution_table_c__ToCCallContext;
extern const struct types resolution_table_cpp__FromCppCallContext;
extern const struct types resolution_table_cpp__CppCallContext;
extern const struct types resolution_table_cpp__ToCppCallContext;
extern const struct types resolution_table_compiling_writer__WriterCoreNode;
...
extern const struct types resolution_table_nullable_hash_collection__HashSetNodenitni_callbacks__NitniCallback;
...
extern const struct types resolution_table_nullable_hash_collection__HashMapNodeffi_base__FFILanguageabstract_collection__Setnitni_callbacks__NitniCallback;
...
extern const struct types resolution_table_nullable_hash_collection__HashSetNodeffi_base__FFILanguage;
...
extern const struct types resolution_table_nullable_hash_collection__HashSetNodenitni_callbacks__MExplicitCall;
...
extern const struct types resolution_table_nullable_hash_collection__HashSetNodenitni_callbacks__MExplicitSuper;
...
extern const struct types resolution_table_nullable_hash_collection__HashSetNodenitni_callbacks__MExplicitCast;
