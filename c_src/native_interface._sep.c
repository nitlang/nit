...
void native_interface___MMSrcModule___compile_separate_module(val_t p0, val_t p1){
  ...
  REGB0 = CALL_abstractmetamodel___MMModule___is_extern_hybrid(fra.me.REG[2])(fra.me.REG[2]);
  if (UNTAG_Bool(REGB0)) {
    /* ./native_interface//native_interface.nit:27 */
    fra.me.REG[4] = NEW_FrontierVisitor_frontier___FrontierVisitor___init(fra.me.REG[2]);
    /* ./native_interface//native_interface.nit:28 */
    CALL_frontier___MMSrcModule___compile_frontier(fra.me.REG[2])(fra.me.REG[2], fra.me.REG[4]);
    /* ./native_interface//native_interface.nit:30 */
    CALL_frontier___FrontierVisitor___compile_cached(fra.me.REG[4])(fra.me.REG[4]);
    ...
    fra.me.REG[3] = CALL_compiling_base___CProgram___compdir(fra.me.REG[3])(fra.me.REG[3]);
    ...
    CALL_frontier___FrontierVisitor___write_to_files(fra.me.REG[4])(fra.me.REG[4], fra.me.REG[5]);
  }
