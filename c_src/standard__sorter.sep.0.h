...
#define COLOR_standard__Array__standard__sorter__Comparator__COMPARED 4
...
#define COLOR_standard__sorter__Comparator__compare 32
...
#define COLOR_standard__kernel__Comparable___60d_61d_62d 36
