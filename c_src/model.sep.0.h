...
void CHECK_NEW_model__MClassDefSorter(val*);
...
void CHECK_NEW_model__MPropDefSorter(val*);
...
void CHECK_NEW_model__MParameterType(val*);
...
void CHECK_NEW_model__MGenericType(val*);
...
void CHECK_NEW_model__MClassType(val*);
...
void CHECK_NEW_model__MNullableType(val*);
...
void CHECK_NEW_model__MClassKind(val*);
