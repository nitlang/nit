...
#define ATTR_syntax___typing___AClosureDecl____escapable(recv) ATTR(recv, (SFT_syntax___typing[12] + 0))
#define CALL_syntax___typing___AClosureDecl___escapable(recv) ((syntax___typing___AClosureDecl___escapable_t)CALL((recv), (SFT_syntax___typing[13] + 0)))
#define CALL_SUPER_syntax___typing___AClosureDecl___accept_typing(recv) ((syntax___typing___AClosureDecl___accept_typing_t)CALL((recv), (SFT_syntax___typing[13] + 1)))
#define ATTR_syntax___typing___AType____stype(recv) ATTR(recv, (SFT_syntax___typing[14] + 0))
#define ATTR_syntax___typing___AExpr____is_typed(recv) ATTR(recv, (SFT_syntax___typing[15] + 0))
#define ATTR_syntax___typing___AExpr____stype(recv) ATTR(recv, (SFT_syntax___typing[15] + 1))
#define ATTR_syntax___typing___AExpr____if_true_flow_ctx(recv) ATTR(recv, (SFT_syntax___typing[15] + 2))
#define ATTR_syntax___typing___AExpr____if_false_flow_ctx(recv) ATTR(recv, (SFT_syntax___typing[15] + 3))
#define CALL_syntax___typing___AExpr___is_implicit_self(recv) ((syntax___typing___AExpr___is_implicit_self_t)CALL((recv), (SFT_syntax___typing[16] + 0)))
#define CALL_syntax___typing___AExpr___is_self(recv) ((syntax___typing___AExpr___is_self_t)CALL((recv), (SFT_syntax___typing[16] + 1)))
#define CALL_syntax___typing___AExpr___its_variable(recv) ((syntax___typing___AExpr___its_variable_t)CALL((recv), (SFT_syntax___typing[16] + 2)))
#define CALL_syntax___typing___AExpr___if_true_flow_ctx(recv) ((syntax___typing___AExpr___if_true_flow_ctx_t)CALL((recv), (SFT_syntax___typing[16] + 3)))
#define CALL_syntax___typing___AExpr___if_false_flow_ctx(recv) ((syntax___typing___AExpr___if_false_flow_ctx_t)CALL((recv), (SFT_syntax___typing[16] + 4)))
#define ATTR_syntax___typing___AVardeclExpr____variable(recv) ATTR(recv, (SFT_syntax___typing[17] + 0))
#define ID_syntax___typing___AAbsControl (SFT_syntax___typing[18])
#define COLOR_syntax___typing___AAbsControl (SFT_syntax___typing[19])
#define ATTR_syntax___typing___AAbsControl____escapable(recv) ATTR(recv, (SFT_syntax___typing[20] + 0))
#define INIT_TABLE_POS_syntax___typing___AAbsControl (SFT_syntax___typing[21] + 0)
#define CALL_syntax___typing___AAbsControl___escapable(recv) ((syntax___typing___AAbsControl___escapable_t)CALL((recv), (SFT_syntax___typing[21] + 1)))
#define CALL_syntax___typing___AAbsControl___process_control(recv) ((syntax___typing___AAbsControl___process_control_t)CALL((recv), (SFT_syntax___typing[21] + 2)))
#define CALL_syntax___typing___AAbsControl___process_control_inside(recv) ((syntax___typing___AAbsControl___process_control_inside_t)CALL((recv), (SFT_syntax___typing[21] + 3)))
#define ATTR_syntax___typing___AForExpr____variables(recv) ATTR(recv, (SFT_syntax___typing[22] + 0))
#define CALL_syntax___typing___AForExpr___do_typing(recv) ((syntax___typing___AForExpr___do_typing_t)CALL((recv), (SFT_syntax___typing[23] + 0)))
#define ATTR_syntax___typing___AVarFormExpr____variable(recv) ATTR(recv, (SFT_syntax___typing[24] + 0))
#define ATTR_syntax___typing___AReassignFormExpr____assign_method(recv) ATTR(recv, (SFT_syntax___typing[25] + 0))
#define CALL_syntax___typing___AReassignFormExpr___do_rvalue_typing(recv) ((syntax___typing___AReassignFormExpr___do_rvalue_typing_t)CALL((recv), (SFT_syntax___typing[26] + 0)))
#define CALL_syntax___typing___AAssignOp___method_name(recv) ((syntax___typing___AAssignOp___method_name_t)CALL((recv), (SFT_syntax___typing[27] + 0)))
#define ATTR_syntax___typing___ASelfExpr____variable(recv) ATTR(recv, (SFT_syntax___typing[28] + 0))
#define ATTR_syntax___typing___ASuperstringExpr____atype(recv) ATTR(recv, (SFT_syntax___typing[29] + 0))
#define CALL_syntax___typing___AArrayExpr___do_typing(recv) ((syntax___typing___AArrayExpr___do_typing_t)CALL((recv), (SFT_syntax___typing[30] + 0)))
#define ATTR_syntax___typing___ASuperExpr____init_in_superclass(recv) ATTR(recv, (SFT_syntax___typing[31] + 0))
#define ATTR_syntax___typing___AAttrFormExpr____prop(recv) ATTR(recv, (SFT_syntax___typing[32] + 0))
#define ATTR_syntax___typing___AAttrFormExpr____attr_type(recv) ATTR(recv, (SFT_syntax___typing[32] + 1))
#define CALL_syntax___typing___AAttrFormExpr___do_typing(recv) ((syntax___typing___AAttrFormExpr___do_typing_t)CALL((recv), (SFT_syntax___typing[33] + 0)))
#define ATTR_syntax___typing___AAbsAbsSendExpr____prop_signature(recv) ATTR(recv, (SFT_syntax___typing[34] + 0))
#define ATTR_syntax___typing___AAbsAbsSendExpr____raw_arguments_cache(recv) ATTR(recv, (SFT_syntax___typing[34] + 1))
#define CALL_syntax___typing___AAbsAbsSendExpr___compute_raw_arguments(recv) ((syntax___typing___AAbsAbsSendExpr___compute_raw_arguments_t)CALL((recv), (SFT_syntax___typing[35] + 0)))
#define CALL_syntax___typing___AAbsAbsSendExpr___process_signature(recv) ((syntax___typing___AAbsAbsSendExpr___process_signature_t)CALL((recv), (SFT_syntax___typing[35] + 1)))
#define CALL_syntax___typing___AAbsAbsSendExpr___process_closures(recv) ((syntax___typing___AAbsAbsSendExpr___process_closures_t)CALL((recv), (SFT_syntax___typing[35] + 2)))
#define ATTR_syntax___typing___AAbsSendExpr____prop(recv) ATTR(recv, (SFT_syntax___typing[36] + 0))
#define ATTR_syntax___typing___AAbsSendExpr____return_type(recv) ATTR(recv, (SFT_syntax___typing[36] + 1))
#define CALL_syntax___typing___AAbsSendExpr___do_typing(recv) ((syntax___typing___AAbsSendExpr___do_typing_t)CALL((recv), (SFT_syntax___typing[37] + 0)))
#define CALL_syntax___typing___AAbsSendExpr___get_property(recv) ((syntax___typing___AAbsSendExpr___get_property_t)CALL((recv), (SFT_syntax___typing[37] + 1)))
#define CALL_syntax___typing___AAbsSendExpr___get_signature(recv) ((syntax___typing___AAbsSendExpr___get_signature_t)CALL((recv), (SFT_syntax___typing[37] + 2)))
#define CALL_syntax___typing___ASuperInitCall___register_super_init_call(recv) ((syntax___typing___ASuperInitCall___register_super_init_call_t)CALL((recv), (SFT_syntax___typing[38] + 0)))
#define CALL_syntax___typing___ASendExpr___name(recv) ((syntax___typing___ASendExpr___name_t)CALL((recv), (SFT_syntax___typing[39] + 0)))
#define CALL_syntax___typing___ASendExpr___do_all_typing(recv) ((syntax___typing___ASendExpr___do_all_typing_t)CALL((recv), (SFT_syntax___typing[39] + 1)))
#define ATTR_syntax___typing___ASendReassignExpr____read_prop(recv) ATTR(recv, (SFT_syntax___typing[40] + 0))
#define CALL_SUPER_syntax___typing___AEqExpr___after_typing(recv) ((syntax___typing___AEqExpr___after_typing_t)CALL((recv), (SFT_syntax___typing[41] + 0)))
#define CALL_syntax___typing___AEqExpr___try_to_isa(recv) ((syntax___typing___AEqExpr___try_to_isa_t)CALL((recv), (SFT_syntax___typing[41] + 1)))
#define CALL_SUPER_syntax___typing___ANeExpr___after_typing(recv) ((syntax___typing___ANeExpr___after_typing_t)CALL((recv), (SFT_syntax___typing[42] + 0)))
#define CALL_syntax___typing___ANeExpr___try_to_isa(recv) ((syntax___typing___ANeExpr___try_to_isa_t)CALL((recv), (SFT_syntax___typing[42] + 1)))
#define CALL_SUPER_syntax___typing___ACallFormExpr___after_typing(recv) ((syntax___typing___ACallFormExpr___after_typing_t)CALL((recv), (SFT_syntax___typing[43] + 0)))
#define CALL_syntax___typing___ACallFormExpr___variable_create(recv) ((syntax___typing___ACallFormExpr___variable_create_t)CALL((recv), (SFT_syntax___typing[43] + 1)))
#define ATTR_syntax___typing___AClosureCallExpr____variable(recv) ATTR(recv, (SFT_syntax___typing[44] + 0))
#define CALL_syntax___typing___AClosureId___to_symbol(recv) ((syntax___typing___AClosureId___to_symbol_t)CALL((recv), (SFT_syntax___typing[45] + 0)))
#define ATTR_syntax___typing___AClosureDef____closure(recv) ATTR(recv, (SFT_syntax___typing[46] + 0))
#define ATTR_syntax___typing___AClosureDef____escapable(recv) ATTR(recv, (SFT_syntax___typing[46] + 1))
#define ATTR_syntax___typing___AClosureDef____accept_typing2(recv) ATTR(recv, (SFT_syntax___typing[46] + 2))
#define CALL_syntax___typing___AClosureDef___escapable(recv) ((syntax___typing___AClosureDef___escapable_t)CALL((recv), (SFT_syntax___typing[47] + 0)))
#define CALL_SUPER_syntax___typing___AClosureDef___accept_typing(recv) ((syntax___typing___AClosureDef___accept_typing_t)CALL((recv), (SFT_syntax___typing[47] + 1)))
#define CALL_syntax___typing___AClosureDef___accept_typing2(recv) ((syntax___typing___AClosureDef___accept_typing2_t)CALL((recv), (SFT_syntax___typing[47] + 2)))
#define ID_syntax___typing___ATypeCheckExpr (SFT_syntax___typing[48])
#define COLOR_syntax___typing___ATypeCheckExpr (SFT_syntax___typing[49])
#define INIT_TABLE_POS_syntax___typing___ATypeCheckExpr (SFT_syntax___typing[50] + 0)
#define CALL_syntax___typing___ATypeCheckExpr___check_expr_cast(recv) ((syntax___typing___ATypeCheckExpr___check_expr_cast_t)CALL((recv), (SFT_syntax___typing[50] + 1)))
#define CALL_SUPER_syntax___typing___AOnceExpr___accept_typing(recv) ((syntax___typing___AOnceExpr___accept_typing_t)CALL((recv), (SFT_syntax___typing[51] + 0)))
