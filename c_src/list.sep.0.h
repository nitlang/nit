...
#define COLOR_list__ListNodelist__List_FT0 0
...
#define COLOR_list__ListIteratorlist__List_FT0 10
void list__ListIterator__init(val* self, val* p0);
val* list__List__iterator(val* self);
#define COLOR_list__List_FT0 11
#define COLOR_nullable_list__ListNodelist__List_FT0 12
