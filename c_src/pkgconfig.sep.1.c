...
fprintf(stderr, " (%s:%d)\n", "src/common_ffi/pkgconfig.nit", 5);
exit(1);
}
var = var1;
RET_LABEL:;
...
fprintf(stderr, " (%s:%d)\n", "src/common_ffi/pkgconfig.nit", 49);
exit(1);
}
var_nmodule = var55;
...
CHECK_NEW_exec__IProcess(var59);
...
CHECK_NEW_exec__IProcess(var131);
var_proc = var131;
...
CHECK_NEW_exec__IProcess(var167);
var_proc = var167;
