...
extern const classtable_elt_t VFT_AExternClasskind[];
...
#define ID_AExternClasskind (SFT_parser_nodes[354])
#define COLOR_AExternClasskind (SFT_parser_nodes[355])
#define ATTR_parser_nodes___AExternClasskind____n_kwextern(recv) ATTR(recv, (SFT_parser_nodes[356] + 0))
#define INIT_TABLE_POS_AExternClasskind (SFT_parser_nodes[357] + 0)
#define CALL_parser_nodes___AExternClasskind___n_kwextern(recv) ((parser_nodes___AExternClasskind___n_kwextern_t)CALL((recv), (SFT_parser_nodes[357] + 1)))
#define ID_AFormaldef (SFT_parser_nodes[358])
#define COLOR_AFormaldef (SFT_parser_nodes[359])
#define ATTR_parser_nodes___AFormaldef____n_id(recv) ATTR(recv, (SFT_parser_nodes[360] + 0))
#define ATTR_parser_nodes___AFormaldef____n_type(recv) ATTR(recv, (SFT_parser_nodes[360] + 1))
#define INIT_TABLE_POS_AFormaldef (SFT_parser_nodes[361] + 0)
#define CALL_parser_nodes___AFormaldef___n_id(recv) ((parser_nodes___AFormaldef___n_id_t)CALL((recv), (SFT_parser_nodes[361] + 1)))
#define CALL_parser_nodes___AFormaldef___n_type(recv) ((parser_nodes___AFormaldef___n_type_t)CALL((recv), (SFT_parser_nodes[361] + 2)))
#define ID_ASuperclass (SFT_parser_nodes[362])
#define COLOR_ASuperclass (SFT_parser_nodes[363])
#define ATTR_parser_nodes___ASuperclass____n_kwspecial(recv) ATTR(recv, (SFT_parser_nodes[364] + 0))
#define ATTR_parser_nodes___ASuperclass____n_kwsuper(recv) ATTR(recv, (SFT_parser_nodes[364] + 1))
#define ATTR_parser_nodes___ASuperclass____n_type(recv) ATTR(recv, (SFT_parser_nodes[364] + 2))
#define INIT_TABLE_POS_ASuperclass (SFT_parser_nodes[365] + 0)
#define CALL_parser_nodes___ASuperclass___n_kwspecial(recv) ((parser_nodes___ASuperclass___n_kwspecial_t)CALL((recv), (SFT_parser_nodes[365] + 1)))
#define CALL_parser_nodes___ASuperclass___n_kwsuper(recv) ((parser_nodes___ASuperclass___n_kwsuper_t)CALL((recv), (SFT_parser_nodes[365] + 2)))
#define CALL_parser_nodes___ASuperclass___n_type(recv) ((parser_nodes___ASuperclass___n_type_t)CALL((recv), (SFT_parser_nodes[365] + 3)))
#define ID_APropdef (SFT_parser_nodes[366])
#define COLOR_APropdef (SFT_parser_nodes[367])
#define ATTR_parser_nodes___APropdef____n_doc(recv) ATTR(recv, (SFT_parser_nodes[368] + 0))
#define INIT_TABLE_POS_APropdef (SFT_parser_nodes[369] + 0)
#define CALL_parser_nodes___APropdef___n_doc(recv) ((parser_nodes___APropdef___n_doc_t)CALL((recv), (SFT_parser_nodes[369] + 1)))
#define ID_AAttrPropdef (SFT_parser_nodes[370])
#define COLOR_AAttrPropdef (SFT_parser_nodes[371])
#define ATTR_parser_nodes___AAttrPropdef____n_kwredef(recv) ATTR(recv, (SFT_parser_nodes[372] + 0))
#define ATTR_parser_nodes___AAttrPropdef____n_visibility(recv) ATTR(recv, (SFT_parser_nodes[372] + 1))
#define ATTR_parser_nodes___AAttrPropdef____n_kwvar(recv) ATTR(recv, (SFT_parser_nodes[372] + 2))
#define ATTR_parser_nodes___AAttrPropdef____n_id(recv) ATTR(recv, (SFT_parser_nodes[372] + 3))
#define ATTR_parser_nodes___AAttrPropdef____n_id2(recv) ATTR(recv, (SFT_parser_nodes[372] + 4))
#define ATTR_parser_nodes___AAttrPropdef____n_type(recv) ATTR(recv, (SFT_parser_nodes[372] + 5))
#define ATTR_parser_nodes___AAttrPropdef____n_readable(recv) ATTR(recv, (SFT_parser_nodes[372] + 6))
#define ATTR_parser_nodes___AAttrPropdef____n_writable(recv) ATTR(recv, (SFT_parser_nodes[372] + 7))
#define ATTR_parser_nodes___AAttrPropdef____n_expr(recv) ATTR(recv, (SFT_parser_nodes[372] + 8))
#define INIT_TABLE_POS_AAttrPropdef (SFT_parser_nodes[373] + 0)
#define CALL_parser_nodes___AAttrPropdef___n_kwredef(recv) ((parser_nodes___AAttrPropdef___n_kwredef_t)CALL((recv), (SFT_parser_nodes[373] + 1)))
#define CALL_parser_nodes___AAttrPropdef___n_visibility(recv) ((parser_nodes___AAttrPropdef___n_visibility_t)CALL((recv), (SFT_parser_nodes[373] + 2)))
#define CALL_parser_nodes___AAttrPropdef___n_kwvar(recv) ((parser_nodes___AAttrPropdef___n_kwvar_t)CALL((recv), (SFT_parser_nodes[373] + 3)))
#define CALL_parser_nodes___AAttrPropdef___n_id(recv) ((parser_nodes___AAttrPropdef___n_id_t)CALL((recv), (SFT_parser_nodes[373] + 4)))
#define CALL_parser_nodes___AAttrPropdef___n_id2(recv) ((parser_nodes___AAttrPropdef___n_id2_t)CALL((recv), (SFT_parser_nodes[373] + 5)))
#define CALL_parser_nodes___AAttrPropdef___n_type(recv) ((parser_nodes___AAttrPropdef___n_type_t)CALL((recv), (SFT_parser_nodes[373] + 6)))
#define CALL_parser_nodes___AAttrPropdef___n_readable(recv) ((parser_nodes___AAttrPropdef___n_readable_t)CALL((recv), (SFT_parser_nodes[373] + 7)))
#define CALL_parser_nodes___AAttrPropdef___n_writable(recv) ((parser_nodes___AAttrPropdef___n_writable_t)CALL((recv), (SFT_parser_nodes[373] + 8)))
#define CALL_parser_nodes___AAttrPropdef___n_expr(recv) ((parser_nodes___AAttrPropdef___n_expr_t)CALL((recv), (SFT_parser_nodes[373] + 9)))
#define ID_AMethPropdef (SFT_parser_nodes[374])
#define COLOR_AMethPropdef (SFT_parser_nodes[375])
#define ATTR_parser_nodes___AMethPropdef____n_kwredef(recv) ATTR(recv, (SFT_parser_nodes[376] + 0))
#define ATTR_parser_nodes___AMethPropdef____n_visibility(recv) ATTR(recv, (SFT_parser_nodes[376] + 1))
#define ATTR_parser_nodes___AMethPropdef____n_methid(recv) ATTR(recv, (SFT_parser_nodes[376] + 2))
#define ATTR_parser_nodes___AMethPropdef____n_signature(recv) ATTR(recv, (SFT_parser_nodes[376] + 3))
#define INIT_TABLE_POS_AMethPropdef (SFT_parser_nodes[377] + 0)
#define CALL_parser_nodes___AMethPropdef___n_kwredef(recv) ((parser_nodes___AMethPropdef___n_kwredef_t)CALL((recv), (SFT_parser_nodes[377] + 1)))
#define CALL_parser_nodes___AMethPropdef___n_visibility(recv) ((parser_nodes___AMethPropdef___n_visibility_t)CALL((recv), (SFT_parser_nodes[377] + 2)))
#define CALL_parser_nodes___AMethPropdef___n_methid(recv) ((parser_nodes___AMethPropdef___n_methid_t)CALL((recv), (SFT_parser_nodes[377] + 3)))
#define CALL_parser_nodes___AMethPropdef___n_signature(recv) ((parser_nodes___AMethPropdef___n_signature_t)CALL((recv), (SFT_parser_nodes[377] + 4)))
#define ID_ADeferredMethPropdef (SFT_parser_nodes[378])
#define COLOR_ADeferredMethPropdef (SFT_parser_nodes[379])
#define ATTR_parser_nodes___ADeferredMethPropdef____n_kwmeth(recv) ATTR(recv, (SFT_parser_nodes[380] + 0))
#define INIT_TABLE_POS_ADeferredMethPropdef (SFT_parser_nodes[381] + 0)
#define CALL_parser_nodes___ADeferredMethPropdef___n_kwmeth(recv) ((parser_nodes___ADeferredMethPropdef___n_kwmeth_t)CALL((recv), (SFT_parser_nodes[381] + 1)))
#define ID_AInternMethPropdef (SFT_parser_nodes[382])
#define COLOR_AInternMethPropdef (SFT_parser_nodes[383])
#define ATTR_parser_nodes___AInternMethPropdef____n_kwmeth(recv) ATTR(recv, (SFT_parser_nodes[384] + 0))
#define INIT_TABLE_POS_AInternMethPropdef (SFT_parser_nodes[385] + 0)
#define CALL_parser_nodes___AInternMethPropdef___n_kwmeth(recv) ((parser_nodes___AInternMethPropdef___n_kwmeth_t)CALL((recv), (SFT_parser_nodes[385] + 1)))
#define ID_AExternPropdef (SFT_parser_nodes[386])
#define COLOR_AExternPropdef (SFT_parser_nodes[387])
#define ATTR_parser_nodes___AExternPropdef____n_extern(recv) ATTR(recv, (SFT_parser_nodes[388] + 0))
#define ATTR_parser_nodes___AExternPropdef____n_extern_calls(recv) ATTR(recv, (SFT_parser_nodes[388] + 1))
#define INIT_TABLE_POS_AExternPropdef (SFT_parser_nodes[389] + 0)
#define CALL_parser_nodes___AExternPropdef___n_extern(recv) ((parser_nodes___AExternPropdef___n_extern_t)CALL((recv), (SFT_parser_nodes[389] + 1)))
#define CALL_parser_nodes___AExternPropdef___n_extern_calls(recv) ((parser_nodes___AExternPropdef___n_extern_calls_t)CALL((recv), (SFT_parser_nodes[389] + 2)))
#define ID_AExternMethPropdef (SFT_parser_nodes[390])
#define COLOR_AExternMethPropdef (SFT_parser_nodes[391])
#define ATTR_parser_nodes___AExternMethPropdef____n_kwmeth(recv) ATTR(recv, (SFT_parser_nodes[392] + 0))
#define INIT_TABLE_POS_AExternMethPropdef (SFT_parser_nodes[393] + 0)
#define CALL_parser_nodes___AExternMethPropdef___n_kwmeth(recv) ((parser_nodes___AExternMethPropdef___n_kwmeth_t)CALL((recv), (SFT_parser_nodes[393] + 1)))
#define ID_AConcreteMethPropdef (SFT_parser_nodes[394])
#define COLOR_AConcreteMethPropdef (SFT_parser_nodes[395])
#define ATTR_parser_nodes___AConcreteMethPropdef____n_kwmeth(recv) ATTR(recv, (SFT_parser_nodes[396] + 0))
#define ATTR_parser_nodes___AConcreteMethPropdef____n_block(recv) ATTR(recv, (SFT_parser_nodes[396] + 1))
...
static const char * const LOCATE_parser_nodes___AExternClasskind___n_kwextern = "parser_nodes::AExternClasskind::n_kwextern";
val_t parser_nodes___AExternClasskind___n_kwextern(val_t p0);
typedef val_t (*parser_nodes___AExternClasskind___n_kwextern_t)(val_t p0);
