/* This C header file is generated by NIT to compile modules and programs that requires compiling_icode. */
#ifndef compiling_icode_sep
#define compiling_icode_sep
#include "analysis._sep.h"
#include "compiling_base._sep.h"
#include <nit_common.h>

extern const classtable_elt_t VFT_I2CCompilerVisitor[];
extern const char *LOCATE_compiling_icode;
extern const int SFT_compiling_icode[];
#define ID_I2CCompilerVisitor (SFT_compiling_icode[0])
#define COLOR_I2CCompilerVisitor (SFT_compiling_icode[1])
#define ATTR_compiling_icode___I2CCompilerVisitor____ids(recv) ATTR(recv, (SFT_compiling_icode[2] + 0))
#define ATTR_compiling_icode___I2CCompilerVisitor____ids2(recv) ATTR(recv, (SFT_compiling_icode[2] + 1))
#define ATTR_compiling_icode___I2CCompilerVisitor____last_number(recv) ATTR(recv, (SFT_compiling_icode[2] + 2))
#define ATTR_compiling_icode___I2CCompilerVisitor____closures(recv) ATTR(recv, (SFT_compiling_icode[2] + 3))
#define ATTR_compiling_icode___I2CCompilerVisitor____clostypes(recv) ATTR(recv, (SFT_compiling_icode[2] + 4))
#define ATTR_compiling_icode___I2CCompilerVisitor____local_labels(recv) ATTR(recv, (SFT_compiling_icode[2] + 5))
#define ATTR_compiling_icode___I2CCompilerVisitor____escaped_labels(recv) ATTR(recv, (SFT_compiling_icode[2] + 6))
#define ATTR_compiling_icode___I2CCompilerVisitor____marks_to_seq(recv) ATTR(recv, (SFT_compiling_icode[2] + 7))
#define ATTR_compiling_icode___I2CCompilerVisitor____closure(recv) ATTR(recv, (SFT_compiling_icode[2] + 8))
#define ATTR_compiling_icode___I2CCompilerVisitor____visitor(recv) ATTR(recv, (SFT_compiling_icode[2] + 9))
#define ATTR_compiling_icode___I2CCompilerVisitor____iroutine(recv) ATTR(recv, (SFT_compiling_icode[2] + 10))
#define ATTR_compiling_icode___I2CCompilerVisitor____return_label(recv) ATTR(recv, (SFT_compiling_icode[2] + 11))
#define ATTR_compiling_icode___I2CCompilerVisitor____last_location(recv) ATTR(recv, (SFT_compiling_icode[2] + 12))
#define ATTR_compiling_icode___I2CCompilerVisitor____next_location(recv) ATTR(recv, (SFT_compiling_icode[2] + 13))
#define ATTR_compiling_icode___I2CCompilerVisitor____basecname(recv) ATTR(recv, (SFT_compiling_icode[2] + 14))
#define INIT_TABLE_POS_I2CCompilerVisitor (SFT_compiling_icode[3] + 0)
#define CALL_compiling_icode___I2CCompilerVisitor___register(recv) ((compiling_icode___I2CCompilerVisitor___register_t)CALL((recv), (SFT_compiling_icode[3] + 1)))
#define CALL_compiling_icode___I2CCompilerVisitor___registers(recv) ((compiling_icode___I2CCompilerVisitor___registers_t)CALL((recv), (SFT_compiling_icode[3] + 2)))
#define CALL_compiling_icode___I2CCompilerVisitor___new_number(recv) ((compiling_icode___I2CCompilerVisitor___new_number_t)CALL((recv), (SFT_compiling_icode[3] + 3)))
#define CALL_compiling_icode___I2CCompilerVisitor___lab(recv) ((compiling_icode___I2CCompilerVisitor___lab_t)CALL((recv), (SFT_compiling_icode[3] + 4)))
#define CALL_compiling_icode___I2CCompilerVisitor___closures(recv) ((compiling_icode___I2CCompilerVisitor___closures_t)CALL((recv), (SFT_compiling_icode[3] + 5)))
#define CALL_compiling_icode___I2CCompilerVisitor___clostypes(recv) ((compiling_icode___I2CCompilerVisitor___clostypes_t)CALL((recv), (SFT_compiling_icode[3] + 6)))
#define CALL_compiling_icode___I2CCompilerVisitor___local_labels(recv) ((compiling_icode___I2CCompilerVisitor___local_labels_t)CALL((recv), (SFT_compiling_icode[3] + 7)))
#define CALL_compiling_icode___I2CCompilerVisitor___local_labels__eq(recv) ((compiling_icode___I2CCompilerVisitor___local_labels__eq_t)CALL((recv), (SFT_compiling_icode[3] + 8)))
#define CALL_compiling_icode___I2CCompilerVisitor___escaped_labels(recv) ((compiling_icode___I2CCompilerVisitor___escaped_labels_t)CALL((recv), (SFT_compiling_icode[3] + 9)))
#define CALL_compiling_icode___I2CCompilerVisitor___escaped_labels__eq(recv) ((compiling_icode___I2CCompilerVisitor___escaped_labels__eq_t)CALL((recv), (SFT_compiling_icode[3] + 10)))
#define CALL_compiling_icode___I2CCompilerVisitor___register_escape_label(recv) ((compiling_icode___I2CCompilerVisitor___register_escape_label_t)CALL((recv), (SFT_compiling_icode[3] + 11)))
#define CALL_compiling_icode___I2CCompilerVisitor___add_label(recv) ((compiling_icode___I2CCompilerVisitor___add_label_t)CALL((recv), (SFT_compiling_icode[3] + 12)))
#define CALL_compiling_icode___I2CCompilerVisitor___add_goto(recv) ((compiling_icode___I2CCompilerVisitor___add_goto_t)CALL((recv), (SFT_compiling_icode[3] + 13)))
#define CALL_compiling_icode___I2CCompilerVisitor___marks_to_seq(recv) ((compiling_icode___I2CCompilerVisitor___marks_to_seq_t)CALL((recv), (SFT_compiling_icode[3] + 14)))
#define CALL_compiling_icode___I2CCompilerVisitor___closure(recv) ((compiling_icode___I2CCompilerVisitor___closure_t)CALL((recv), (SFT_compiling_icode[3] + 15)))
#define CALL_compiling_icode___I2CCompilerVisitor___closure__eq(recv) ((compiling_icode___I2CCompilerVisitor___closure__eq_t)CALL((recv), (SFT_compiling_icode[3] + 16)))
#define CALL_compiling_icode___I2CCompilerVisitor___visitor(recv) ((compiling_icode___I2CCompilerVisitor___visitor_t)CALL((recv), (SFT_compiling_icode[3] + 17)))
#define CALL_compiling_icode___I2CCompilerVisitor___iroutine(recv) ((compiling_icode___I2CCompilerVisitor___iroutine_t)CALL((recv), (SFT_compiling_icode[3] + 18)))
