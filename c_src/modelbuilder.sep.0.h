...
#define COLOR_modelbuilder__ToolContext__init 127
...
#define COLOR_modelbuilder__Phase__process_mainmodule 40
...
#define COLOR_abstract_collection__SequenceRead__last 40
