...
#define ID_parser___parser_nodes___AFormaldef (SFT_parser___parser_nodes[354])
#define COLOR_parser___parser_nodes___AFormaldef (SFT_parser___parser_nodes[355])
#define ATTR_parser___parser_nodes___AFormaldef____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[356] + 0))
#define ATTR_parser___parser_nodes___AFormaldef____n_type(recv) ATTR(recv, (SFT_parser___parser_nodes[356] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AFormaldef (SFT_parser___parser_nodes[357] + 0)
#define CALL_parser___parser_nodes___AFormaldef___n_id(recv) ((parser___parser_nodes___AFormaldef___n_id_t)CALL((recv), (SFT_parser___parser_nodes[357] + 1)))
#define CALL_parser___parser_nodes___AFormaldef___n_type(recv) ((parser___parser_nodes___AFormaldef___n_type_t)CALL((recv), (SFT_parser___parser_nodes[357] + 2)))
#define ID_parser___parser_nodes___ASuperclass (SFT_parser___parser_nodes[358])
#define COLOR_parser___parser_nodes___ASuperclass (SFT_parser___parser_nodes[359])
#define ATTR_parser___parser_nodes___ASuperclass____n_kwspecial(recv) ATTR(recv, (SFT_parser___parser_nodes[360] + 0))
#define ATTR_parser___parser_nodes___ASuperclass____n_kwsuper(recv) ATTR(recv, (SFT_parser___parser_nodes[360] + 1))
#define ATTR_parser___parser_nodes___ASuperclass____n_type(recv) ATTR(recv, (SFT_parser___parser_nodes[360] + 2))
#define INIT_TABLE_POS_parser___parser_nodes___ASuperclass (SFT_parser___parser_nodes[361] + 0)
#define CALL_parser___parser_nodes___ASuperclass___n_kwspecial(recv) ((parser___parser_nodes___ASuperclass___n_kwspecial_t)CALL((recv), (SFT_parser___parser_nodes[361] + 1)))
#define CALL_parser___parser_nodes___ASuperclass___n_kwsuper(recv) ((parser___parser_nodes___ASuperclass___n_kwsuper_t)CALL((recv), (SFT_parser___parser_nodes[361] + 2)))
#define CALL_parser___parser_nodes___ASuperclass___n_type(recv) ((parser___parser_nodes___ASuperclass___n_type_t)CALL((recv), (SFT_parser___parser_nodes[361] + 3)))
#define ID_parser___parser_nodes___APropdef (SFT_parser___parser_nodes[362])
#define COLOR_parser___parser_nodes___APropdef (SFT_parser___parser_nodes[363])
#define ATTR_parser___parser_nodes___APropdef____n_doc(recv) ATTR(recv, (SFT_parser___parser_nodes[364] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___APropdef (SFT_parser___parser_nodes[365] + 0)
#define CALL_parser___parser_nodes___APropdef___n_doc(recv) ((parser___parser_nodes___APropdef___n_doc_t)CALL((recv), (SFT_parser___parser_nodes[365] + 1)))
#define ID_parser___parser_nodes___AAttrPropdef (SFT_parser___parser_nodes[366])
#define COLOR_parser___parser_nodes___AAttrPropdef (SFT_parser___parser_nodes[367])
#define ATTR_parser___parser_nodes___AAttrPropdef____n_kwredef(recv) ATTR(recv, (SFT_parser___parser_nodes[368] + 0))
#define ATTR_parser___parser_nodes___AAttrPropdef____n_visibility(recv) ATTR(recv, (SFT_parser___parser_nodes[368] + 1))
#define ATTR_parser___parser_nodes___AAttrPropdef____n_kwvar(recv) ATTR(recv, (SFT_parser___parser_nodes[368] + 2))
#define ATTR_parser___parser_nodes___AAttrPropdef____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[368] + 3))
#define ATTR_parser___parser_nodes___AAttrPropdef____n_id2(recv) ATTR(recv, (SFT_parser___parser_nodes[368] + 4))
#define ATTR_parser___parser_nodes___AAttrPropdef____n_type(recv) ATTR(recv, (SFT_parser___parser_nodes[368] + 5))
#define ATTR_parser___parser_nodes___AAttrPropdef____n_readable(recv) ATTR(recv, (SFT_parser___parser_nodes[368] + 6))
#define ATTR_parser___parser_nodes___AAttrPropdef____n_writable(recv) ATTR(recv, (SFT_parser___parser_nodes[368] + 7))
#define ATTR_parser___parser_nodes___AAttrPropdef____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[368] + 8))
#define INIT_TABLE_POS_parser___parser_nodes___AAttrPropdef (SFT_parser___parser_nodes[369] + 0)
#define CALL_parser___parser_nodes___AAttrPropdef___n_kwredef(recv) ((parser___parser_nodes___AAttrPropdef___n_kwredef_t)CALL((recv), (SFT_parser___parser_nodes[369] + 1)))
#define CALL_parser___parser_nodes___AAttrPropdef___n_visibility(recv) ((parser___parser_nodes___AAttrPropdef___n_visibility_t)CALL((recv), (SFT_parser___parser_nodes[369] + 2)))
#define CALL_parser___parser_nodes___AAttrPropdef___n_kwvar(recv) ((parser___parser_nodes___AAttrPropdef___n_kwvar_t)CALL((recv), (SFT_parser___parser_nodes[369] + 3)))
#define CALL_parser___parser_nodes___AAttrPropdef___n_id(recv) ((parser___parser_nodes___AAttrPropdef___n_id_t)CALL((recv), (SFT_parser___parser_nodes[369] + 4)))
#define CALL_parser___parser_nodes___AAttrPropdef___n_id2(recv) ((parser___parser_nodes___AAttrPropdef___n_id2_t)CALL((recv), (SFT_parser___parser_nodes[369] + 5)))
#define CALL_parser___parser_nodes___AAttrPropdef___n_type(recv) ((parser___parser_nodes___AAttrPropdef___n_type_t)CALL((recv), (SFT_parser___parser_nodes[369] + 6)))
#define CALL_parser___parser_nodes___AAttrPropdef___n_readable(recv) ((parser___parser_nodes___AAttrPropdef___n_readable_t)CALL((recv), (SFT_parser___parser_nodes[369] + 7)))
#define CALL_parser___parser_nodes___AAttrPropdef___n_writable(recv) ((parser___parser_nodes___AAttrPropdef___n_writable_t)CALL((recv), (SFT_parser___parser_nodes[369] + 8)))
#define CALL_parser___parser_nodes___AAttrPropdef___n_expr(recv) ((parser___parser_nodes___AAttrPropdef___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[369] + 9)))
#define ID_parser___parser_nodes___AMethPropdef (SFT_parser___parser_nodes[370])
#define COLOR_parser___parser_nodes___AMethPropdef (SFT_parser___parser_nodes[371])
#define ATTR_parser___parser_nodes___AMethPropdef____n_kwredef(recv) ATTR(recv, (SFT_parser___parser_nodes[372] + 0))
#define ATTR_parser___parser_nodes___AMethPropdef____n_visibility(recv) ATTR(recv, (SFT_parser___parser_nodes[372] + 1))
#define ATTR_parser___parser_nodes___AMethPropdef____n_methid(recv) ATTR(recv, (SFT_parser___parser_nodes[372] + 2))
#define ATTR_parser___parser_nodes___AMethPropdef____n_signature(recv) ATTR(recv, (SFT_parser___parser_nodes[372] + 3))
#define INIT_TABLE_POS_parser___parser_nodes___AMethPropdef (SFT_parser___parser_nodes[373] + 0)
#define CALL_parser___parser_nodes___AMethPropdef___n_kwredef(recv) ((parser___parser_nodes___AMethPropdef___n_kwredef_t)CALL((recv), (SFT_parser___parser_nodes[373] + 1)))
#define CALL_parser___parser_nodes___AMethPropdef___n_visibility(recv) ((parser___parser_nodes___AMethPropdef___n_visibility_t)CALL((recv), (SFT_parser___parser_nodes[373] + 2)))
#define CALL_parser___parser_nodes___AMethPropdef___n_methid(recv) ((parser___parser_nodes___AMethPropdef___n_methid_t)CALL((recv), (SFT_parser___parser_nodes[373] + 3)))
#define CALL_parser___parser_nodes___AMethPropdef___n_signature(recv) ((parser___parser_nodes___AMethPropdef___n_signature_t)CALL((recv), (SFT_parser___parser_nodes[373] + 4)))
#define ID_parser___parser_nodes___ADeferredMethPropdef (SFT_parser___parser_nodes[374])
#define COLOR_parser___parser_nodes___ADeferredMethPropdef (SFT_parser___parser_nodes[375])
#define ATTR_parser___parser_nodes___ADeferredMethPropdef____n_kwmeth(recv) ATTR(recv, (SFT_parser___parser_nodes[376] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ADeferredMethPropdef (SFT_parser___parser_nodes[377] + 0)
#define CALL_parser___parser_nodes___ADeferredMethPropdef___n_kwmeth(recv) ((parser___parser_nodes___ADeferredMethPropdef___n_kwmeth_t)CALL((recv), (SFT_parser___parser_nodes[377] + 1)))
#define ID_parser___parser_nodes___AInternMethPropdef (SFT_parser___parser_nodes[378])
#define COLOR_parser___parser_nodes___AInternMethPropdef (SFT_parser___parser_nodes[379])
#define ATTR_parser___parser_nodes___AInternMethPropdef____n_kwmeth(recv) ATTR(recv, (SFT_parser___parser_nodes[380] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AInternMethPropdef (SFT_parser___parser_nodes[381] + 0)
#define CALL_parser___parser_nodes___AInternMethPropdef___n_kwmeth(recv) ((parser___parser_nodes___AInternMethPropdef___n_kwmeth_t)CALL((recv), (SFT_parser___parser_nodes[381] + 1)))
#define ID_parser___parser_nodes___AExternMethPropdef (SFT_parser___parser_nodes[382])
#define COLOR_parser___parser_nodes___AExternMethPropdef (SFT_parser___parser_nodes[383])
#define ATTR_parser___parser_nodes___AExternMethPropdef____n_kwmeth(recv) ATTR(recv, (SFT_parser___parser_nodes[384] + 0))
#define ATTR_parser___parser_nodes___AExternMethPropdef____n_extern(recv) ATTR(recv, (SFT_parser___parser_nodes[384] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AExternMethPropdef (SFT_parser___parser_nodes[385] + 0)
#define CALL_parser___parser_nodes___AExternMethPropdef___n_kwmeth(recv) ((parser___parser_nodes___AExternMethPropdef___n_kwmeth_t)CALL((recv), (SFT_parser___parser_nodes[385] + 1)))
#define CALL_parser___parser_nodes___AExternMethPropdef___n_extern(recv) ((parser___parser_nodes___AExternMethPropdef___n_extern_t)CALL((recv), (SFT_parser___parser_nodes[385] + 2)))
#define ID_parser___parser_nodes___AConcreteMethPropdef (SFT_parser___parser_nodes[386])
#define COLOR_parser___parser_nodes___AConcreteMethPropdef (SFT_parser___parser_nodes[387])
#define ATTR_parser___parser_nodes___AConcreteMethPropdef____n_kwmeth(recv) ATTR(recv, (SFT_parser___parser_nodes[388] + 0))
#define ATTR_parser___parser_nodes___AConcreteMethPropdef____n_block(recv) ATTR(recv, (SFT_parser___parser_nodes[388] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AConcreteMethPropdef (SFT_parser___parser_nodes[389] + 0)
#define CALL_parser___parser_nodes___AConcreteMethPropdef___n_kwmeth(recv) ((parser___parser_nodes___AConcreteMethPropdef___n_kwmeth_t)CALL((recv), (SFT_parser___parser_nodes[389] + 1)))
#define CALL_parser___parser_nodes___AConcreteMethPropdef___n_block(recv) ((parser___parser_nodes___AConcreteMethPropdef___n_block_t)CALL((recv), (SFT_parser___parser_nodes[389] + 2)))
#define ID_parser___parser_nodes___AConcreteInitPropdef (SFT_parser___parser_nodes[390])
#define COLOR_parser___parser_nodes___AConcreteInitPropdef (SFT_parser___parser_nodes[391])
#define ATTR_parser___parser_nodes___AConcreteInitPropdef____n_kwinit(recv) ATTR(recv, (SFT_parser___parser_nodes[392] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AConcreteInitPropdef (SFT_parser___parser_nodes[393] + 0)
#define CALL_parser___parser_nodes___AConcreteInitPropdef___n_kwinit(recv) ((parser___parser_nodes___AConcreteInitPropdef___n_kwinit_t)CALL((recv), (SFT_parser___parser_nodes[393] + 1)))
#define ID_parser___parser_nodes___AMainMethPropdef (SFT_parser___parser_nodes[394])
#define COLOR_parser___parser_nodes___AMainMethPropdef (SFT_parser___parser_nodes[395])
#define INIT_TABLE_POS_parser___parser_nodes___AMainMethPropdef (SFT_parser___parser_nodes[396] + 0)
#define ID_parser___parser_nodes___ATypePropdef (SFT_parser___parser_nodes[397])
#define COLOR_parser___parser_nodes___ATypePropdef (SFT_parser___parser_nodes[398])
#define ATTR_parser___parser_nodes___ATypePropdef____n_kwredef(recv) ATTR(recv, (SFT_parser___parser_nodes[399] + 0))
#define ATTR_parser___parser_nodes___ATypePropdef____n_visibility(recv) ATTR(recv, (SFT_parser___parser_nodes[399] + 1))
#define ATTR_parser___parser_nodes___ATypePropdef____n_kwtype(recv) ATTR(recv, (SFT_parser___parser_nodes[399] + 2))
#define ATTR_parser___parser_nodes___ATypePropdef____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[399] + 3))
#define ATTR_parser___parser_nodes___ATypePropdef____n_type(recv) ATTR(recv, (SFT_parser___parser_nodes[399] + 4))
#define INIT_TABLE_POS_parser___parser_nodes___ATypePropdef (SFT_parser___parser_nodes[400] + 0)
#define CALL_parser___parser_nodes___ATypePropdef___n_kwredef(recv) ((parser___parser_nodes___ATypePropdef___n_kwredef_t)CALL((recv), (SFT_parser___parser_nodes[400] + 1)))
#define CALL_parser___parser_nodes___ATypePropdef___n_visibility(recv) ((parser___parser_nodes___ATypePropdef___n_visibility_t)CALL((recv), (SFT_parser___parser_nodes[400] + 2)))
#define CALL_parser___parser_nodes___ATypePropdef___n_kwtype(recv) ((parser___parser_nodes___ATypePropdef___n_kwtype_t)CALL((recv), (SFT_parser___parser_nodes[400] + 3)))
#define CALL_parser___parser_nodes___ATypePropdef___n_id(recv) ((parser___parser_nodes___ATypePropdef___n_id_t)CALL((recv), (SFT_parser___parser_nodes[400] + 4)))
#define CALL_parser___parser_nodes___ATypePropdef___n_type(recv) ((parser___parser_nodes___ATypePropdef___n_type_t)CALL((recv), (SFT_parser___parser_nodes[400] + 5)))
#define ID_parser___parser_nodes___AAble (SFT_parser___parser_nodes[401])
#define COLOR_parser___parser_nodes___AAble (SFT_parser___parser_nodes[402])
#define ATTR_parser___parser_nodes___AAble____n_visibility(recv) ATTR(recv, (SFT_parser___parser_nodes[403] + 0))
#define ATTR_parser___parser_nodes___AAble____n_kwredef(recv) ATTR(recv, (SFT_parser___parser_nodes[403] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AAble (SFT_parser___parser_nodes[404] + 0)
#define CALL_parser___parser_nodes___AAble___n_visibility(recv) ((parser___parser_nodes___AAble___n_visibility_t)CALL((recv), (SFT_parser___parser_nodes[404] + 1)))
#define CALL_parser___parser_nodes___AAble___n_kwredef(recv) ((parser___parser_nodes___AAble___n_kwredef_t)CALL((recv), (SFT_parser___parser_nodes[404] + 2)))
#define ID_parser___parser_nodes___AReadAble (SFT_parser___parser_nodes[405])
#define COLOR_parser___parser_nodes___AReadAble (SFT_parser___parser_nodes[406])
#define ATTR_parser___parser_nodes___AReadAble____n_kwreadable(recv) ATTR(recv, (SFT_parser___parser_nodes[407] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AReadAble (SFT_parser___parser_nodes[408] + 0)
#define CALL_parser___parser_nodes___AReadAble___n_kwreadable(recv) ((parser___parser_nodes___AReadAble___n_kwreadable_t)CALL((recv), (SFT_parser___parser_nodes[408] + 1)))
#define ID_parser___parser_nodes___AWriteAble (SFT_parser___parser_nodes[409])
#define COLOR_parser___parser_nodes___AWriteAble (SFT_parser___parser_nodes[410])
#define ATTR_parser___parser_nodes___AWriteAble____n_kwwritable(recv) ATTR(recv, (SFT_parser___parser_nodes[411] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AWriteAble (SFT_parser___parser_nodes[412] + 0)
#define CALL_parser___parser_nodes___AWriteAble___n_kwwritable(recv) ((parser___parser_nodes___AWriteAble___n_kwwritable_t)CALL((recv), (SFT_parser___parser_nodes[412] + 1)))
#define ID_parser___parser_nodes___AMethid (SFT_parser___parser_nodes[413])
#define COLOR_parser___parser_nodes___AMethid (SFT_parser___parser_nodes[414])
#define INIT_TABLE_POS_parser___parser_nodes___AMethid (SFT_parser___parser_nodes[415] + 0)
#define ID_parser___parser_nodes___AIdMethid (SFT_parser___parser_nodes[416])
#define COLOR_parser___parser_nodes___AIdMethid (SFT_parser___parser_nodes[417])
#define ATTR_parser___parser_nodes___AIdMethid____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[418] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AIdMethid (SFT_parser___parser_nodes[419] + 0)
#define CALL_parser___parser_nodes___AIdMethid___n_id(recv) ((parser___parser_nodes___AIdMethid___n_id_t)CALL((recv), (SFT_parser___parser_nodes[419] + 1)))
#define ID_parser___parser_nodes___APlusMethid (SFT_parser___parser_nodes[420])
#define COLOR_parser___parser_nodes___APlusMethid (SFT_parser___parser_nodes[421])
#define ATTR_parser___parser_nodes___APlusMethid____n_plus(recv) ATTR(recv, (SFT_parser___parser_nodes[422] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___APlusMethid (SFT_parser___parser_nodes[423] + 0)
#define CALL_parser___parser_nodes___APlusMethid___n_plus(recv) ((parser___parser_nodes___APlusMethid___n_plus_t)CALL((recv), (SFT_parser___parser_nodes[423] + 1)))
#define ID_parser___parser_nodes___AMinusMethid (SFT_parser___parser_nodes[424])
#define COLOR_parser___parser_nodes___AMinusMethid (SFT_parser___parser_nodes[425])
#define ATTR_parser___parser_nodes___AMinusMethid____n_minus(recv) ATTR(recv, (SFT_parser___parser_nodes[426] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AMinusMethid (SFT_parser___parser_nodes[427] + 0)
#define CALL_parser___parser_nodes___AMinusMethid___n_minus(recv) ((parser___parser_nodes___AMinusMethid___n_minus_t)CALL((recv), (SFT_parser___parser_nodes[427] + 1)))
#define ID_parser___parser_nodes___AStarMethid (SFT_parser___parser_nodes[428])
#define COLOR_parser___parser_nodes___AStarMethid (SFT_parser___parser_nodes[429])
#define ATTR_parser___parser_nodes___AStarMethid____n_star(recv) ATTR(recv, (SFT_parser___parser_nodes[430] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AStarMethid (SFT_parser___parser_nodes[431] + 0)
#define CALL_parser___parser_nodes___AStarMethid___n_star(recv) ((parser___parser_nodes___AStarMethid___n_star_t)CALL((recv), (SFT_parser___parser_nodes[431] + 1)))
#define ID_parser___parser_nodes___ASlashMethid (SFT_parser___parser_nodes[432])
#define COLOR_parser___parser_nodes___ASlashMethid (SFT_parser___parser_nodes[433])
#define ATTR_parser___parser_nodes___ASlashMethid____n_slash(recv) ATTR(recv, (SFT_parser___parser_nodes[434] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ASlashMethid (SFT_parser___parser_nodes[435] + 0)
#define CALL_parser___parser_nodes___ASlashMethid___n_slash(recv) ((parser___parser_nodes___ASlashMethid___n_slash_t)CALL((recv), (SFT_parser___parser_nodes[435] + 1)))
#define ID_parser___parser_nodes___APercentMethid (SFT_parser___parser_nodes[436])
#define COLOR_parser___parser_nodes___APercentMethid (SFT_parser___parser_nodes[437])
#define ATTR_parser___parser_nodes___APercentMethid____n_percent(recv) ATTR(recv, (SFT_parser___parser_nodes[438] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___APercentMethid (SFT_parser___parser_nodes[439] + 0)
#define CALL_parser___parser_nodes___APercentMethid___n_percent(recv) ((parser___parser_nodes___APercentMethid___n_percent_t)CALL((recv), (SFT_parser___parser_nodes[439] + 1)))
#define ID_parser___parser_nodes___AEqMethid (SFT_parser___parser_nodes[440])
#define COLOR_parser___parser_nodes___AEqMethid (SFT_parser___parser_nodes[441])
#define ATTR_parser___parser_nodes___AEqMethid____n_eq(recv) ATTR(recv, (SFT_parser___parser_nodes[442] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AEqMethid (SFT_parser___parser_nodes[443] + 0)
#define CALL_parser___parser_nodes___AEqMethid___n_eq(recv) ((parser___parser_nodes___AEqMethid___n_eq_t)CALL((recv), (SFT_parser___parser_nodes[443] + 1)))
#define ID_parser___parser_nodes___ANeMethid (SFT_parser___parser_nodes[444])
#define COLOR_parser___parser_nodes___ANeMethid (SFT_parser___parser_nodes[445])
#define ATTR_parser___parser_nodes___ANeMethid____n_ne(recv) ATTR(recv, (SFT_parser___parser_nodes[446] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ANeMethid (SFT_parser___parser_nodes[447] + 0)
#define CALL_parser___parser_nodes___ANeMethid___n_ne(recv) ((parser___parser_nodes___ANeMethid___n_ne_t)CALL((recv), (SFT_parser___parser_nodes[447] + 1)))
#define ID_parser___parser_nodes___ALeMethid (SFT_parser___parser_nodes[448])
#define COLOR_parser___parser_nodes___ALeMethid (SFT_parser___parser_nodes[449])
#define ATTR_parser___parser_nodes___ALeMethid____n_le(recv) ATTR(recv, (SFT_parser___parser_nodes[450] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ALeMethid (SFT_parser___parser_nodes[451] + 0)
#define CALL_parser___parser_nodes___ALeMethid___n_le(recv) ((parser___parser_nodes___ALeMethid___n_le_t)CALL((recv), (SFT_parser___parser_nodes[451] + 1)))
#define ID_parser___parser_nodes___AGeMethid (SFT_parser___parser_nodes[452])
#define COLOR_parser___parser_nodes___AGeMethid (SFT_parser___parser_nodes[453])
#define ATTR_parser___parser_nodes___AGeMethid____n_ge(recv) ATTR(recv, (SFT_parser___parser_nodes[454] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AGeMethid (SFT_parser___parser_nodes[455] + 0)
#define CALL_parser___parser_nodes___AGeMethid___n_ge(recv) ((parser___parser_nodes___AGeMethid___n_ge_t)CALL((recv), (SFT_parser___parser_nodes[455] + 1)))
#define ID_parser___parser_nodes___ALtMethid (SFT_parser___parser_nodes[456])
#define COLOR_parser___parser_nodes___ALtMethid (SFT_parser___parser_nodes[457])
#define ATTR_parser___parser_nodes___ALtMethid____n_lt(recv) ATTR(recv, (SFT_parser___parser_nodes[458] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ALtMethid (SFT_parser___parser_nodes[459] + 0)
#define CALL_parser___parser_nodes___ALtMethid___n_lt(recv) ((parser___parser_nodes___ALtMethid___n_lt_t)CALL((recv), (SFT_parser___parser_nodes[459] + 1)))
#define ID_parser___parser_nodes___AGtMethid (SFT_parser___parser_nodes[460])
#define COLOR_parser___parser_nodes___AGtMethid (SFT_parser___parser_nodes[461])
#define ATTR_parser___parser_nodes___AGtMethid____n_gt(recv) ATTR(recv, (SFT_parser___parser_nodes[462] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AGtMethid (SFT_parser___parser_nodes[463] + 0)
#define CALL_parser___parser_nodes___AGtMethid___n_gt(recv) ((parser___parser_nodes___AGtMethid___n_gt_t)CALL((recv), (SFT_parser___parser_nodes[463] + 1)))
#define ID_parser___parser_nodes___ALlMethid (SFT_parser___parser_nodes[464])
#define COLOR_parser___parser_nodes___ALlMethid (SFT_parser___parser_nodes[465])
#define ATTR_parser___parser_nodes___ALlMethid____n_ll(recv) ATTR(recv, (SFT_parser___parser_nodes[466] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ALlMethid (SFT_parser___parser_nodes[467] + 0)
#define CALL_parser___parser_nodes___ALlMethid___n_ll(recv) ((parser___parser_nodes___ALlMethid___n_ll_t)CALL((recv), (SFT_parser___parser_nodes[467] + 1)))
#define CALL_parser___parser_nodes___ALlMethid___n_ll__eq(recv) ((parser___parser_nodes___ALlMethid___n_ll__eq_t)CALL((recv), (SFT_parser___parser_nodes[467] + 2)))
#define ID_parser___parser_nodes___AGgMethid (SFT_parser___parser_nodes[468])
#define COLOR_parser___parser_nodes___AGgMethid (SFT_parser___parser_nodes[469])
#define ATTR_parser___parser_nodes___AGgMethid____n_gg(recv) ATTR(recv, (SFT_parser___parser_nodes[470] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AGgMethid (SFT_parser___parser_nodes[471] + 0)
#define CALL_parser___parser_nodes___AGgMethid___n_gg(recv) ((parser___parser_nodes___AGgMethid___n_gg_t)CALL((recv), (SFT_parser___parser_nodes[471] + 1)))
#define CALL_parser___parser_nodes___AGgMethid___n_gg__eq(recv) ((parser___parser_nodes___AGgMethid___n_gg__eq_t)CALL((recv), (SFT_parser___parser_nodes[471] + 2)))
#define ID_parser___parser_nodes___ABraMethid (SFT_parser___parser_nodes[472])
#define COLOR_parser___parser_nodes___ABraMethid (SFT_parser___parser_nodes[473])
#define ATTR_parser___parser_nodes___ABraMethid____n_obra(recv) ATTR(recv, (SFT_parser___parser_nodes[474] + 0))
#define ATTR_parser___parser_nodes___ABraMethid____n_cbra(recv) ATTR(recv, (SFT_parser___parser_nodes[474] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___ABraMethid (SFT_parser___parser_nodes[475] + 0)
#define CALL_parser___parser_nodes___ABraMethid___n_obra(recv) ((parser___parser_nodes___ABraMethid___n_obra_t)CALL((recv), (SFT_parser___parser_nodes[475] + 1)))
#define CALL_parser___parser_nodes___ABraMethid___n_cbra(recv) ((parser___parser_nodes___ABraMethid___n_cbra_t)CALL((recv), (SFT_parser___parser_nodes[475] + 2)))
#define ID_parser___parser_nodes___AStarshipMethid (SFT_parser___parser_nodes[476])
#define COLOR_parser___parser_nodes___AStarshipMethid (SFT_parser___parser_nodes[477])
#define ATTR_parser___parser_nodes___AStarshipMethid____n_starship(recv) ATTR(recv, (SFT_parser___parser_nodes[478] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AStarshipMethid (SFT_parser___parser_nodes[479] + 0)
#define CALL_parser___parser_nodes___AStarshipMethid___n_starship(recv) ((parser___parser_nodes___AStarshipMethid___n_starship_t)CALL((recv), (SFT_parser___parser_nodes[479] + 1)))
#define ID_parser___parser_nodes___AAssignMethid (SFT_parser___parser_nodes[480])
#define COLOR_parser___parser_nodes___AAssignMethid (SFT_parser___parser_nodes[481])
#define ATTR_parser___parser_nodes___AAssignMethid____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[482] + 0))
#define ATTR_parser___parser_nodes___AAssignMethid____n_assign(recv) ATTR(recv, (SFT_parser___parser_nodes[482] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AAssignMethid (SFT_parser___parser_nodes[483] + 0)
#define CALL_parser___parser_nodes___AAssignMethid___n_id(recv) ((parser___parser_nodes___AAssignMethid___n_id_t)CALL((recv), (SFT_parser___parser_nodes[483] + 1)))
#define CALL_parser___parser_nodes___AAssignMethid___n_assign(recv) ((parser___parser_nodes___AAssignMethid___n_assign_t)CALL((recv), (SFT_parser___parser_nodes[483] + 2)))
#define ID_parser___parser_nodes___ABraassignMethid (SFT_parser___parser_nodes[484])
#define COLOR_parser___parser_nodes___ABraassignMethid (SFT_parser___parser_nodes[485])
#define ATTR_parser___parser_nodes___ABraassignMethid____n_obra(recv) ATTR(recv, (SFT_parser___parser_nodes[486] + 0))
#define ATTR_parser___parser_nodes___ABraassignMethid____n_cbra(recv) ATTR(recv, (SFT_parser___parser_nodes[486] + 1))
#define ATTR_parser___parser_nodes___ABraassignMethid____n_assign(recv) ATTR(recv, (SFT_parser___parser_nodes[486] + 2))
#define INIT_TABLE_POS_parser___parser_nodes___ABraassignMethid (SFT_parser___parser_nodes[487] + 0)
#define CALL_parser___parser_nodes___ABraassignMethid___n_obra(recv) ((parser___parser_nodes___ABraassignMethid___n_obra_t)CALL((recv), (SFT_parser___parser_nodes[487] + 1)))
#define CALL_parser___parser_nodes___ABraassignMethid___n_cbra(recv) ((parser___parser_nodes___ABraassignMethid___n_cbra_t)CALL((recv), (SFT_parser___parser_nodes[487] + 2)))
#define CALL_parser___parser_nodes___ABraassignMethid___n_assign(recv) ((parser___parser_nodes___ABraassignMethid___n_assign_t)CALL((recv), (SFT_parser___parser_nodes[487] + 3)))
#define ID_parser___parser_nodes___ASignature (SFT_parser___parser_nodes[488])
#define COLOR_parser___parser_nodes___ASignature (SFT_parser___parser_nodes[489])
#define ATTR_parser___parser_nodes___ASignature____n_params(recv) ATTR(recv, (SFT_parser___parser_nodes[490] + 0))
#define ATTR_parser___parser_nodes___ASignature____n_type(recv) ATTR(recv, (SFT_parser___parser_nodes[490] + 1))
#define ATTR_parser___parser_nodes___ASignature____n_closure_decls(recv) ATTR(recv, (SFT_parser___parser_nodes[490] + 2))
#define INIT_TABLE_POS_parser___parser_nodes___ASignature (SFT_parser___parser_nodes[491] + 0)
#define CALL_parser___parser_nodes___ASignature___n_params(recv) ((parser___parser_nodes___ASignature___n_params_t)CALL((recv), (SFT_parser___parser_nodes[491] + 1)))
#define CALL_parser___parser_nodes___ASignature___n_type(recv) ((parser___parser_nodes___ASignature___n_type_t)CALL((recv), (SFT_parser___parser_nodes[491] + 2)))
#define CALL_parser___parser_nodes___ASignature___n_closure_decls(recv) ((parser___parser_nodes___ASignature___n_closure_decls_t)CALL((recv), (SFT_parser___parser_nodes[491] + 3)))
#define ID_parser___parser_nodes___AParam (SFT_parser___parser_nodes[492])
#define COLOR_parser___parser_nodes___AParam (SFT_parser___parser_nodes[493])
#define ATTR_parser___parser_nodes___AParam____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[494] + 0))
#define ATTR_parser___parser_nodes___AParam____n_type(recv) ATTR(recv, (SFT_parser___parser_nodes[494] + 1))
#define ATTR_parser___parser_nodes___AParam____n_dotdotdot(recv) ATTR(recv, (SFT_parser___parser_nodes[494] + 2))
#define INIT_TABLE_POS_parser___parser_nodes___AParam (SFT_parser___parser_nodes[495] + 0)
#define CALL_parser___parser_nodes___AParam___n_id(recv) ((parser___parser_nodes___AParam___n_id_t)CALL((recv), (SFT_parser___parser_nodes[495] + 1)))
#define CALL_parser___parser_nodes___AParam___n_type(recv) ((parser___parser_nodes___AParam___n_type_t)CALL((recv), (SFT_parser___parser_nodes[495] + 2)))
#define CALL_parser___parser_nodes___AParam___n_dotdotdot(recv) ((parser___parser_nodes___AParam___n_dotdotdot_t)CALL((recv), (SFT_parser___parser_nodes[495] + 3)))
#define ID_parser___parser_nodes___AClosureDecl (SFT_parser___parser_nodes[496])
#define COLOR_parser___parser_nodes___AClosureDecl (SFT_parser___parser_nodes[497])
#define ATTR_parser___parser_nodes___AClosureDecl____n_kwbreak(recv) ATTR(recv, (SFT_parser___parser_nodes[498] + 0))
#define ATTR_parser___parser_nodes___AClosureDecl____n_bang(recv) ATTR(recv, (SFT_parser___parser_nodes[498] + 1))
#define ATTR_parser___parser_nodes___AClosureDecl____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[498] + 2))
#define ATTR_parser___parser_nodes___AClosureDecl____n_signature(recv) ATTR(recv, (SFT_parser___parser_nodes[498] + 3))
#define ATTR_parser___parser_nodes___AClosureDecl____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[498] + 4))
#define INIT_TABLE_POS_parser___parser_nodes___AClosureDecl (SFT_parser___parser_nodes[499] + 0)
#define CALL_parser___parser_nodes___AClosureDecl___n_kwbreak(recv) ((parser___parser_nodes___AClosureDecl___n_kwbreak_t)CALL((recv), (SFT_parser___parser_nodes[499] + 1)))
#define CALL_parser___parser_nodes___AClosureDecl___n_bang(recv) ((parser___parser_nodes___AClosureDecl___n_bang_t)CALL((recv), (SFT_parser___parser_nodes[499] + 2)))
#define CALL_parser___parser_nodes___AClosureDecl___n_id(recv) ((parser___parser_nodes___AClosureDecl___n_id_t)CALL((recv), (SFT_parser___parser_nodes[499] + 3)))
#define CALL_parser___parser_nodes___AClosureDecl___n_signature(recv) ((parser___parser_nodes___AClosureDecl___n_signature_t)CALL((recv), (SFT_parser___parser_nodes[499] + 4)))
#define CALL_parser___parser_nodes___AClosureDecl___n_expr(recv) ((parser___parser_nodes___AClosureDecl___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[499] + 5)))
#define ID_parser___parser_nodes___AType (SFT_parser___parser_nodes[500])
#define COLOR_parser___parser_nodes___AType (SFT_parser___parser_nodes[501])
#define ATTR_parser___parser_nodes___AType____n_kwnullable(recv) ATTR(recv, (SFT_parser___parser_nodes[502] + 0))
#define ATTR_parser___parser_nodes___AType____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[502] + 1))
#define ATTR_parser___parser_nodes___AType____n_types(recv) ATTR(recv, (SFT_parser___parser_nodes[502] + 2))
#define INIT_TABLE_POS_parser___parser_nodes___AType (SFT_parser___parser_nodes[503] + 0)
#define CALL_parser___parser_nodes___AType___n_kwnullable(recv) ((parser___parser_nodes___AType___n_kwnullable_t)CALL((recv), (SFT_parser___parser_nodes[503] + 1)))
#define CALL_parser___parser_nodes___AType___n_id(recv) ((parser___parser_nodes___AType___n_id_t)CALL((recv), (SFT_parser___parser_nodes[503] + 2)))
#define CALL_parser___parser_nodes___AType___n_types(recv) ((parser___parser_nodes___AType___n_types_t)CALL((recv), (SFT_parser___parser_nodes[503] + 3)))
#define ID_parser___parser_nodes___ALabel (SFT_parser___parser_nodes[504])
#define COLOR_parser___parser_nodes___ALabel (SFT_parser___parser_nodes[505])
#define ATTR_parser___parser_nodes___ALabel____n_kwlabel(recv) ATTR(recv, (SFT_parser___parser_nodes[506] + 0))
#define ATTR_parser___parser_nodes___ALabel____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[506] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___ALabel (SFT_parser___parser_nodes[507] + 0)
#define CALL_parser___parser_nodes___ALabel___n_kwlabel(recv) ((parser___parser_nodes___ALabel___n_kwlabel_t)CALL((recv), (SFT_parser___parser_nodes[507] + 1)))
#define CALL_parser___parser_nodes___ALabel___n_id(recv) ((parser___parser_nodes___ALabel___n_id_t)CALL((recv), (SFT_parser___parser_nodes[507] + 2)))
#define ID_parser___parser_nodes___AExpr (SFT_parser___parser_nodes[508])
#define COLOR_parser___parser_nodes___AExpr (SFT_parser___parser_nodes[509])
#define INIT_TABLE_POS_parser___parser_nodes___AExpr (SFT_parser___parser_nodes[510] + 0)
#define ID_parser___parser_nodes___ABlockExpr (SFT_parser___parser_nodes[511])
#define COLOR_parser___parser_nodes___ABlockExpr (SFT_parser___parser_nodes[512])
#define ATTR_parser___parser_nodes___ABlockExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[513] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ABlockExpr (SFT_parser___parser_nodes[514] + 0)
#define CALL_parser___parser_nodes___ABlockExpr___n_expr(recv) ((parser___parser_nodes___ABlockExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[514] + 1)))
#define ID_parser___parser_nodes___AVardeclExpr (SFT_parser___parser_nodes[515])
#define COLOR_parser___parser_nodes___AVardeclExpr (SFT_parser___parser_nodes[516])
#define ATTR_parser___parser_nodes___AVardeclExpr____n_kwvar(recv) ATTR(recv, (SFT_parser___parser_nodes[517] + 0))
#define ATTR_parser___parser_nodes___AVardeclExpr____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[517] + 1))
#define ATTR_parser___parser_nodes___AVardeclExpr____n_type(recv) ATTR(recv, (SFT_parser___parser_nodes[517] + 2))
#define ATTR_parser___parser_nodes___AVardeclExpr____n_assign(recv) ATTR(recv, (SFT_parser___parser_nodes[517] + 3))
#define ATTR_parser___parser_nodes___AVardeclExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[517] + 4))
#define INIT_TABLE_POS_parser___parser_nodes___AVardeclExpr (SFT_parser___parser_nodes[518] + 0)
#define CALL_parser___parser_nodes___AVardeclExpr___n_kwvar(recv) ((parser___parser_nodes___AVardeclExpr___n_kwvar_t)CALL((recv), (SFT_parser___parser_nodes[518] + 1)))
#define CALL_parser___parser_nodes___AVardeclExpr___n_id(recv) ((parser___parser_nodes___AVardeclExpr___n_id_t)CALL((recv), (SFT_parser___parser_nodes[518] + 2)))
#define CALL_parser___parser_nodes___AVardeclExpr___n_type(recv) ((parser___parser_nodes___AVardeclExpr___n_type_t)CALL((recv), (SFT_parser___parser_nodes[518] + 3)))
#define CALL_parser___parser_nodes___AVardeclExpr___n_assign(recv) ((parser___parser_nodes___AVardeclExpr___n_assign_t)CALL((recv), (SFT_parser___parser_nodes[518] + 4)))
#define CALL_parser___parser_nodes___AVardeclExpr___n_expr(recv) ((parser___parser_nodes___AVardeclExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[518] + 5)))
#define ID_parser___parser_nodes___AReturnExpr (SFT_parser___parser_nodes[519])
#define COLOR_parser___parser_nodes___AReturnExpr (SFT_parser___parser_nodes[520])
#define ATTR_parser___parser_nodes___AReturnExpr____n_kwreturn(recv) ATTR(recv, (SFT_parser___parser_nodes[521] + 0))
#define ATTR_parser___parser_nodes___AReturnExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[521] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AReturnExpr (SFT_parser___parser_nodes[522] + 0)
#define CALL_parser___parser_nodes___AReturnExpr___n_kwreturn(recv) ((parser___parser_nodes___AReturnExpr___n_kwreturn_t)CALL((recv), (SFT_parser___parser_nodes[522] + 1)))
#define CALL_parser___parser_nodes___AReturnExpr___n_expr(recv) ((parser___parser_nodes___AReturnExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[522] + 2)))
#define ID_parser___parser_nodes___ALabelable (SFT_parser___parser_nodes[523])
#define COLOR_parser___parser_nodes___ALabelable (SFT_parser___parser_nodes[524])
#define ATTR_parser___parser_nodes___ALabelable____n_label(recv) ATTR(recv, (SFT_parser___parser_nodes[525] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ALabelable (SFT_parser___parser_nodes[526] + 0)
#define CALL_parser___parser_nodes___ALabelable___n_label(recv) ((parser___parser_nodes___ALabelable___n_label_t)CALL((recv), (SFT_parser___parser_nodes[526] + 1)))
#define ID_parser___parser_nodes___ABreakExpr (SFT_parser___parser_nodes[527])
#define COLOR_parser___parser_nodes___ABreakExpr (SFT_parser___parser_nodes[528])
#define ATTR_parser___parser_nodes___ABreakExpr____n_kwbreak(recv) ATTR(recv, (SFT_parser___parser_nodes[529] + 0))
#define ATTR_parser___parser_nodes___ABreakExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[529] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___ABreakExpr (SFT_parser___parser_nodes[530] + 0)
#define CALL_parser___parser_nodes___ABreakExpr___n_kwbreak(recv) ((parser___parser_nodes___ABreakExpr___n_kwbreak_t)CALL((recv), (SFT_parser___parser_nodes[530] + 1)))
#define CALL_parser___parser_nodes___ABreakExpr___n_expr(recv) ((parser___parser_nodes___ABreakExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[530] + 2)))
#define ID_parser___parser_nodes___AAbortExpr (SFT_parser___parser_nodes[531])
#define COLOR_parser___parser_nodes___AAbortExpr (SFT_parser___parser_nodes[532])
#define ATTR_parser___parser_nodes___AAbortExpr____n_kwabort(recv) ATTR(recv, (SFT_parser___parser_nodes[533] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AAbortExpr (SFT_parser___parser_nodes[534] + 0)
#define CALL_parser___parser_nodes___AAbortExpr___n_kwabort(recv) ((parser___parser_nodes___AAbortExpr___n_kwabort_t)CALL((recv), (SFT_parser___parser_nodes[534] + 1)))
#define ID_parser___parser_nodes___AContinueExpr (SFT_parser___parser_nodes[535])
#define COLOR_parser___parser_nodes___AContinueExpr (SFT_parser___parser_nodes[536])
#define ATTR_parser___parser_nodes___AContinueExpr____n_kwcontinue(recv) ATTR(recv, (SFT_parser___parser_nodes[537] + 0))
#define ATTR_parser___parser_nodes___AContinueExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[537] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AContinueExpr (SFT_parser___parser_nodes[538] + 0)
#define CALL_parser___parser_nodes___AContinueExpr___n_kwcontinue(recv) ((parser___parser_nodes___AContinueExpr___n_kwcontinue_t)CALL((recv), (SFT_parser___parser_nodes[538] + 1)))
#define CALL_parser___parser_nodes___AContinueExpr___n_expr(recv) ((parser___parser_nodes___AContinueExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[538] + 2)))
#define ID_parser___parser_nodes___ADoExpr (SFT_parser___parser_nodes[539])
#define COLOR_parser___parser_nodes___ADoExpr (SFT_parser___parser_nodes[540])
#define ATTR_parser___parser_nodes___ADoExpr____n_kwdo(recv) ATTR(recv, (SFT_parser___parser_nodes[541] + 0))
#define ATTR_parser___parser_nodes___ADoExpr____n_block(recv) ATTR(recv, (SFT_parser___parser_nodes[541] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___ADoExpr (SFT_parser___parser_nodes[542] + 0)
#define CALL_parser___parser_nodes___ADoExpr___n_kwdo(recv) ((parser___parser_nodes___ADoExpr___n_kwdo_t)CALL((recv), (SFT_parser___parser_nodes[542] + 1)))
#define CALL_parser___parser_nodes___ADoExpr___n_block(recv) ((parser___parser_nodes___ADoExpr___n_block_t)CALL((recv), (SFT_parser___parser_nodes[542] + 2)))
#define ID_parser___parser_nodes___AIfExpr (SFT_parser___parser_nodes[543])
#define COLOR_parser___parser_nodes___AIfExpr (SFT_parser___parser_nodes[544])
#define ATTR_parser___parser_nodes___AIfExpr____n_kwif(recv) ATTR(recv, (SFT_parser___parser_nodes[545] + 0))
#define ATTR_parser___parser_nodes___AIfExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[545] + 1))
#define ATTR_parser___parser_nodes___AIfExpr____n_then(recv) ATTR(recv, (SFT_parser___parser_nodes[545] + 2))
#define ATTR_parser___parser_nodes___AIfExpr____n_else(recv) ATTR(recv, (SFT_parser___parser_nodes[545] + 3))
#define INIT_TABLE_POS_parser___parser_nodes___AIfExpr (SFT_parser___parser_nodes[546] + 0)
#define CALL_parser___parser_nodes___AIfExpr___n_kwif(recv) ((parser___parser_nodes___AIfExpr___n_kwif_t)CALL((recv), (SFT_parser___parser_nodes[546] + 1)))
#define CALL_parser___parser_nodes___AIfExpr___n_expr(recv) ((parser___parser_nodes___AIfExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[546] + 2)))
#define CALL_parser___parser_nodes___AIfExpr___n_then(recv) ((parser___parser_nodes___AIfExpr___n_then_t)CALL((recv), (SFT_parser___parser_nodes[546] + 3)))
#define CALL_parser___parser_nodes___AIfExpr___n_else(recv) ((parser___parser_nodes___AIfExpr___n_else_t)CALL((recv), (SFT_parser___parser_nodes[546] + 4)))
#define ID_parser___parser_nodes___AIfexprExpr (SFT_parser___parser_nodes[547])
#define COLOR_parser___parser_nodes___AIfexprExpr (SFT_parser___parser_nodes[548])
#define ATTR_parser___parser_nodes___AIfexprExpr____n_kwif(recv) ATTR(recv, (SFT_parser___parser_nodes[549] + 0))
#define ATTR_parser___parser_nodes___AIfexprExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[549] + 1))
#define ATTR_parser___parser_nodes___AIfexprExpr____n_kwthen(recv) ATTR(recv, (SFT_parser___parser_nodes[549] + 2))
#define ATTR_parser___parser_nodes___AIfexprExpr____n_then(recv) ATTR(recv, (SFT_parser___parser_nodes[549] + 3))
#define ATTR_parser___parser_nodes___AIfexprExpr____n_kwelse(recv) ATTR(recv, (SFT_parser___parser_nodes[549] + 4))
#define ATTR_parser___parser_nodes___AIfexprExpr____n_else(recv) ATTR(recv, (SFT_parser___parser_nodes[549] + 5))
#define INIT_TABLE_POS_parser___parser_nodes___AIfexprExpr (SFT_parser___parser_nodes[550] + 0)
#define CALL_parser___parser_nodes___AIfexprExpr___n_kwif(recv) ((parser___parser_nodes___AIfexprExpr___n_kwif_t)CALL((recv), (SFT_parser___parser_nodes[550] + 1)))
#define CALL_parser___parser_nodes___AIfexprExpr___n_expr(recv) ((parser___parser_nodes___AIfexprExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[550] + 2)))
#define CALL_parser___parser_nodes___AIfexprExpr___n_kwthen(recv) ((parser___parser_nodes___AIfexprExpr___n_kwthen_t)CALL((recv), (SFT_parser___parser_nodes[550] + 3)))
#define CALL_parser___parser_nodes___AIfexprExpr___n_then(recv) ((parser___parser_nodes___AIfexprExpr___n_then_t)CALL((recv), (SFT_parser___parser_nodes[550] + 4)))
#define CALL_parser___parser_nodes___AIfexprExpr___n_kwelse(recv) ((parser___parser_nodes___AIfexprExpr___n_kwelse_t)CALL((recv), (SFT_parser___parser_nodes[550] + 5)))
#define CALL_parser___parser_nodes___AIfexprExpr___n_else(recv) ((parser___parser_nodes___AIfexprExpr___n_else_t)CALL((recv), (SFT_parser___parser_nodes[550] + 6)))
#define ID_parser___parser_nodes___AWhileExpr (SFT_parser___parser_nodes[551])
#define COLOR_parser___parser_nodes___AWhileExpr (SFT_parser___parser_nodes[552])
#define ATTR_parser___parser_nodes___AWhileExpr____n_kwwhile(recv) ATTR(recv, (SFT_parser___parser_nodes[553] + 0))
#define ATTR_parser___parser_nodes___AWhileExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[553] + 1))
#define ATTR_parser___parser_nodes___AWhileExpr____n_kwdo(recv) ATTR(recv, (SFT_parser___parser_nodes[553] + 2))
#define ATTR_parser___parser_nodes___AWhileExpr____n_block(recv) ATTR(recv, (SFT_parser___parser_nodes[553] + 3))
#define INIT_TABLE_POS_parser___parser_nodes___AWhileExpr (SFT_parser___parser_nodes[554] + 0)
#define CALL_parser___parser_nodes___AWhileExpr___n_kwwhile(recv) ((parser___parser_nodes___AWhileExpr___n_kwwhile_t)CALL((recv), (SFT_parser___parser_nodes[554] + 1)))
#define CALL_parser___parser_nodes___AWhileExpr___n_expr(recv) ((parser___parser_nodes___AWhileExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[554] + 2)))
#define CALL_parser___parser_nodes___AWhileExpr___n_kwdo(recv) ((parser___parser_nodes___AWhileExpr___n_kwdo_t)CALL((recv), (SFT_parser___parser_nodes[554] + 3)))
#define CALL_parser___parser_nodes___AWhileExpr___n_block(recv) ((parser___parser_nodes___AWhileExpr___n_block_t)CALL((recv), (SFT_parser___parser_nodes[554] + 4)))
#define ID_parser___parser_nodes___ALoopExpr (SFT_parser___parser_nodes[555])
#define COLOR_parser___parser_nodes___ALoopExpr (SFT_parser___parser_nodes[556])
#define ATTR_parser___parser_nodes___ALoopExpr____n_kwloop(recv) ATTR(recv, (SFT_parser___parser_nodes[557] + 0))
#define ATTR_parser___parser_nodes___ALoopExpr____n_block(recv) ATTR(recv, (SFT_parser___parser_nodes[557] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___ALoopExpr (SFT_parser___parser_nodes[558] + 0)
#define CALL_parser___parser_nodes___ALoopExpr___n_kwloop(recv) ((parser___parser_nodes___ALoopExpr___n_kwloop_t)CALL((recv), (SFT_parser___parser_nodes[558] + 1)))
#define CALL_parser___parser_nodes___ALoopExpr___n_block(recv) ((parser___parser_nodes___ALoopExpr___n_block_t)CALL((recv), (SFT_parser___parser_nodes[558] + 2)))
#define ID_parser___parser_nodes___AForExpr (SFT_parser___parser_nodes[559])
#define COLOR_parser___parser_nodes___AForExpr (SFT_parser___parser_nodes[560])
#define ATTR_parser___parser_nodes___AForExpr____n_kwfor(recv) ATTR(recv, (SFT_parser___parser_nodes[561] + 0))
#define ATTR_parser___parser_nodes___AForExpr____n_ids(recv) ATTR(recv, (SFT_parser___parser_nodes[561] + 1))
#define ATTR_parser___parser_nodes___AForExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[561] + 2))
#define ATTR_parser___parser_nodes___AForExpr____n_kwdo(recv) ATTR(recv, (SFT_parser___parser_nodes[561] + 3))
#define ATTR_parser___parser_nodes___AForExpr____n_block(recv) ATTR(recv, (SFT_parser___parser_nodes[561] + 4))
#define INIT_TABLE_POS_parser___parser_nodes___AForExpr (SFT_parser___parser_nodes[562] + 0)
#define CALL_parser___parser_nodes___AForExpr___n_kwfor(recv) ((parser___parser_nodes___AForExpr___n_kwfor_t)CALL((recv), (SFT_parser___parser_nodes[562] + 1)))
#define CALL_parser___parser_nodes___AForExpr___n_ids(recv) ((parser___parser_nodes___AForExpr___n_ids_t)CALL((recv), (SFT_parser___parser_nodes[562] + 2)))
#define CALL_parser___parser_nodes___AForExpr___n_expr(recv) ((parser___parser_nodes___AForExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[562] + 3)))
#define CALL_parser___parser_nodes___AForExpr___n_kwdo(recv) ((parser___parser_nodes___AForExpr___n_kwdo_t)CALL((recv), (SFT_parser___parser_nodes[562] + 4)))
#define CALL_parser___parser_nodes___AForExpr___n_block(recv) ((parser___parser_nodes___AForExpr___n_block_t)CALL((recv), (SFT_parser___parser_nodes[562] + 5)))
#define ID_parser___parser_nodes___AAssertExpr (SFT_parser___parser_nodes[563])
#define COLOR_parser___parser_nodes___AAssertExpr (SFT_parser___parser_nodes[564])
#define ATTR_parser___parser_nodes___AAssertExpr____n_kwassert(recv) ATTR(recv, (SFT_parser___parser_nodes[565] + 0))
#define ATTR_parser___parser_nodes___AAssertExpr____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[565] + 1))
#define ATTR_parser___parser_nodes___AAssertExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[565] + 2))
#define ATTR_parser___parser_nodes___AAssertExpr____n_else(recv) ATTR(recv, (SFT_parser___parser_nodes[565] + 3))
#define INIT_TABLE_POS_parser___parser_nodes___AAssertExpr (SFT_parser___parser_nodes[566] + 0)
#define CALL_parser___parser_nodes___AAssertExpr___n_kwassert(recv) ((parser___parser_nodes___AAssertExpr___n_kwassert_t)CALL((recv), (SFT_parser___parser_nodes[566] + 1)))
#define CALL_parser___parser_nodes___AAssertExpr___n_id(recv) ((parser___parser_nodes___AAssertExpr___n_id_t)CALL((recv), (SFT_parser___parser_nodes[566] + 2)))
#define CALL_parser___parser_nodes___AAssertExpr___n_expr(recv) ((parser___parser_nodes___AAssertExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[566] + 3)))
#define CALL_parser___parser_nodes___AAssertExpr___n_else(recv) ((parser___parser_nodes___AAssertExpr___n_else_t)CALL((recv), (SFT_parser___parser_nodes[566] + 4)))
#define ID_parser___parser_nodes___AAssignFormExpr (SFT_parser___parser_nodes[567])
#define COLOR_parser___parser_nodes___AAssignFormExpr (SFT_parser___parser_nodes[568])
#define ATTR_parser___parser_nodes___AAssignFormExpr____n_assign(recv) ATTR(recv, (SFT_parser___parser_nodes[569] + 0))
#define ATTR_parser___parser_nodes___AAssignFormExpr____n_value(recv) ATTR(recv, (SFT_parser___parser_nodes[569] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AAssignFormExpr (SFT_parser___parser_nodes[570] + 0)
#define CALL_parser___parser_nodes___AAssignFormExpr___n_assign(recv) ((parser___parser_nodes___AAssignFormExpr___n_assign_t)CALL((recv), (SFT_parser___parser_nodes[570] + 1)))
#define CALL_parser___parser_nodes___AAssignFormExpr___n_value(recv) ((parser___parser_nodes___AAssignFormExpr___n_value_t)CALL((recv), (SFT_parser___parser_nodes[570] + 2)))
#define ID_parser___parser_nodes___AReassignFormExpr (SFT_parser___parser_nodes[571])
#define COLOR_parser___parser_nodes___AReassignFormExpr (SFT_parser___parser_nodes[572])
#define ATTR_parser___parser_nodes___AReassignFormExpr____n_assign_op(recv) ATTR(recv, (SFT_parser___parser_nodes[573] + 0))
#define ATTR_parser___parser_nodes___AReassignFormExpr____n_value(recv) ATTR(recv, (SFT_parser___parser_nodes[573] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AReassignFormExpr (SFT_parser___parser_nodes[574] + 0)
#define CALL_parser___parser_nodes___AReassignFormExpr___n_assign_op(recv) ((parser___parser_nodes___AReassignFormExpr___n_assign_op_t)CALL((recv), (SFT_parser___parser_nodes[574] + 1)))
#define CALL_parser___parser_nodes___AReassignFormExpr___n_value(recv) ((parser___parser_nodes___AReassignFormExpr___n_value_t)CALL((recv), (SFT_parser___parser_nodes[574] + 2)))
#define ID_parser___parser_nodes___AOnceExpr (SFT_parser___parser_nodes[575])
#define COLOR_parser___parser_nodes___AOnceExpr (SFT_parser___parser_nodes[576])
#define ATTR_parser___parser_nodes___AOnceExpr____n_kwonce(recv) ATTR(recv, (SFT_parser___parser_nodes[577] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AOnceExpr (SFT_parser___parser_nodes[578] + 0)
#define CALL_parser___parser_nodes___AOnceExpr___n_kwonce(recv) ((parser___parser_nodes___AOnceExpr___n_kwonce_t)CALL((recv), (SFT_parser___parser_nodes[578] + 1)))
#define ID_parser___parser_nodes___ASendExpr (SFT_parser___parser_nodes[579])
#define COLOR_parser___parser_nodes___ASendExpr (SFT_parser___parser_nodes[580])
#define ATTR_parser___parser_nodes___ASendExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[581] + 0))
#define ATTR_parser___parser_nodes___ASendExpr____n_closure_defs(recv) ATTR(recv, (SFT_parser___parser_nodes[581] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___ASendExpr (SFT_parser___parser_nodes[582] + 0)
#define CALL_parser___parser_nodes___ASendExpr___n_expr(recv) ((parser___parser_nodes___ASendExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[582] + 1)))
#define CALL_parser___parser_nodes___ASendExpr___n_closure_defs(recv) ((parser___parser_nodes___ASendExpr___n_closure_defs_t)CALL((recv), (SFT_parser___parser_nodes[582] + 2)))
#define ID_parser___parser_nodes___ABinopExpr (SFT_parser___parser_nodes[583])
#define COLOR_parser___parser_nodes___ABinopExpr (SFT_parser___parser_nodes[584])
#define ATTR_parser___parser_nodes___ABinopExpr____n_expr2(recv) ATTR(recv, (SFT_parser___parser_nodes[585] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ABinopExpr (SFT_parser___parser_nodes[586] + 0)
#define CALL_parser___parser_nodes___ABinopExpr___n_expr2(recv) ((parser___parser_nodes___ABinopExpr___n_expr2_t)CALL((recv), (SFT_parser___parser_nodes[586] + 1)))
#define ID_parser___parser_nodes___ABoolExpr (SFT_parser___parser_nodes[587])
#define COLOR_parser___parser_nodes___ABoolExpr (SFT_parser___parser_nodes[588])
#define INIT_TABLE_POS_parser___parser_nodes___ABoolExpr (SFT_parser___parser_nodes[589] + 0)
#define ID_parser___parser_nodes___AOrExpr (SFT_parser___parser_nodes[590])
#define COLOR_parser___parser_nodes___AOrExpr (SFT_parser___parser_nodes[591])
#define ATTR_parser___parser_nodes___AOrExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[592] + 0))
#define ATTR_parser___parser_nodes___AOrExpr____n_expr2(recv) ATTR(recv, (SFT_parser___parser_nodes[592] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AOrExpr (SFT_parser___parser_nodes[593] + 0)
#define CALL_parser___parser_nodes___AOrExpr___n_expr(recv) ((parser___parser_nodes___AOrExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[593] + 1)))
#define CALL_parser___parser_nodes___AOrExpr___n_expr2(recv) ((parser___parser_nodes___AOrExpr___n_expr2_t)CALL((recv), (SFT_parser___parser_nodes[593] + 2)))
#define ID_parser___parser_nodes___AAndExpr (SFT_parser___parser_nodes[594])
#define COLOR_parser___parser_nodes___AAndExpr (SFT_parser___parser_nodes[595])
#define ATTR_parser___parser_nodes___AAndExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[596] + 0))
#define ATTR_parser___parser_nodes___AAndExpr____n_expr2(recv) ATTR(recv, (SFT_parser___parser_nodes[596] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AAndExpr (SFT_parser___parser_nodes[597] + 0)
#define CALL_parser___parser_nodes___AAndExpr___n_expr(recv) ((parser___parser_nodes___AAndExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[597] + 1)))
#define CALL_parser___parser_nodes___AAndExpr___n_expr2(recv) ((parser___parser_nodes___AAndExpr___n_expr2_t)CALL((recv), (SFT_parser___parser_nodes[597] + 2)))
#define ID_parser___parser_nodes___AOrElseExpr (SFT_parser___parser_nodes[598])
#define COLOR_parser___parser_nodes___AOrElseExpr (SFT_parser___parser_nodes[599])
#define ATTR_parser___parser_nodes___AOrElseExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[600] + 0))
#define ATTR_parser___parser_nodes___AOrElseExpr____n_expr2(recv) ATTR(recv, (SFT_parser___parser_nodes[600] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AOrElseExpr (SFT_parser___parser_nodes[601] + 0)
#define CALL_parser___parser_nodes___AOrElseExpr___n_expr(recv) ((parser___parser_nodes___AOrElseExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[601] + 1)))
#define CALL_parser___parser_nodes___AOrElseExpr___n_expr2(recv) ((parser___parser_nodes___AOrElseExpr___n_expr2_t)CALL((recv), (SFT_parser___parser_nodes[601] + 2)))
#define ID_parser___parser_nodes___ANotExpr (SFT_parser___parser_nodes[602])
#define COLOR_parser___parser_nodes___ANotExpr (SFT_parser___parser_nodes[603])
#define ATTR_parser___parser_nodes___ANotExpr____n_kwnot(recv) ATTR(recv, (SFT_parser___parser_nodes[604] + 0))
#define ATTR_parser___parser_nodes___ANotExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[604] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___ANotExpr (SFT_parser___parser_nodes[605] + 0)
#define CALL_parser___parser_nodes___ANotExpr___n_kwnot(recv) ((parser___parser_nodes___ANotExpr___n_kwnot_t)CALL((recv), (SFT_parser___parser_nodes[605] + 1)))
#define CALL_parser___parser_nodes___ANotExpr___n_expr(recv) ((parser___parser_nodes___ANotExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[605] + 2)))
#define ID_parser___parser_nodes___AEqExpr (SFT_parser___parser_nodes[606])
#define COLOR_parser___parser_nodes___AEqExpr (SFT_parser___parser_nodes[607])
#define INIT_TABLE_POS_parser___parser_nodes___AEqExpr (SFT_parser___parser_nodes[608] + 0)
#define ID_parser___parser_nodes___AEeExpr (SFT_parser___parser_nodes[609])
#define COLOR_parser___parser_nodes___AEeExpr (SFT_parser___parser_nodes[610])
#define ATTR_parser___parser_nodes___AEeExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[611] + 0))
#define ATTR_parser___parser_nodes___AEeExpr____n_expr2(recv) ATTR(recv, (SFT_parser___parser_nodes[611] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AEeExpr (SFT_parser___parser_nodes[612] + 0)
#define CALL_parser___parser_nodes___AEeExpr___n_expr(recv) ((parser___parser_nodes___AEeExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[612] + 1)))
#define CALL_parser___parser_nodes___AEeExpr___n_expr2(recv) ((parser___parser_nodes___AEeExpr___n_expr2_t)CALL((recv), (SFT_parser___parser_nodes[612] + 2)))
#define ID_parser___parser_nodes___ANeExpr (SFT_parser___parser_nodes[613])
#define COLOR_parser___parser_nodes___ANeExpr (SFT_parser___parser_nodes[614])
#define INIT_TABLE_POS_parser___parser_nodes___ANeExpr (SFT_parser___parser_nodes[615] + 0)
#define ID_parser___parser_nodes___ALtExpr (SFT_parser___parser_nodes[616])
#define COLOR_parser___parser_nodes___ALtExpr (SFT_parser___parser_nodes[617])
#define INIT_TABLE_POS_parser___parser_nodes___ALtExpr (SFT_parser___parser_nodes[618] + 0)
#define ID_parser___parser_nodes___ALeExpr (SFT_parser___parser_nodes[619])
#define COLOR_parser___parser_nodes___ALeExpr (SFT_parser___parser_nodes[620])
#define INIT_TABLE_POS_parser___parser_nodes___ALeExpr (SFT_parser___parser_nodes[621] + 0)
#define ID_parser___parser_nodes___ALlExpr (SFT_parser___parser_nodes[622])
#define COLOR_parser___parser_nodes___ALlExpr (SFT_parser___parser_nodes[623])
#define INIT_TABLE_POS_parser___parser_nodes___ALlExpr (SFT_parser___parser_nodes[624] + 0)
#define ID_parser___parser_nodes___AGtExpr (SFT_parser___parser_nodes[625])
#define COLOR_parser___parser_nodes___AGtExpr (SFT_parser___parser_nodes[626])
#define INIT_TABLE_POS_parser___parser_nodes___AGtExpr (SFT_parser___parser_nodes[627] + 0)
#define ID_parser___parser_nodes___AGeExpr (SFT_parser___parser_nodes[628])
#define COLOR_parser___parser_nodes___AGeExpr (SFT_parser___parser_nodes[629])
#define INIT_TABLE_POS_parser___parser_nodes___AGeExpr (SFT_parser___parser_nodes[630] + 0)
#define ID_parser___parser_nodes___AGgExpr (SFT_parser___parser_nodes[631])
#define COLOR_parser___parser_nodes___AGgExpr (SFT_parser___parser_nodes[632])
#define INIT_TABLE_POS_parser___parser_nodes___AGgExpr (SFT_parser___parser_nodes[633] + 0)
#define ID_parser___parser_nodes___AIsaExpr (SFT_parser___parser_nodes[634])
#define COLOR_parser___parser_nodes___AIsaExpr (SFT_parser___parser_nodes[635])
#define ATTR_parser___parser_nodes___AIsaExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[636] + 0))
#define ATTR_parser___parser_nodes___AIsaExpr____n_type(recv) ATTR(recv, (SFT_parser___parser_nodes[636] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AIsaExpr (SFT_parser___parser_nodes[637] + 0)
#define CALL_parser___parser_nodes___AIsaExpr___n_expr(recv) ((parser___parser_nodes___AIsaExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[637] + 1)))
#define CALL_parser___parser_nodes___AIsaExpr___n_type(recv) ((parser___parser_nodes___AIsaExpr___n_type_t)CALL((recv), (SFT_parser___parser_nodes[637] + 2)))
#define ID_parser___parser_nodes___APlusExpr (SFT_parser___parser_nodes[638])
#define COLOR_parser___parser_nodes___APlusExpr (SFT_parser___parser_nodes[639])
#define INIT_TABLE_POS_parser___parser_nodes___APlusExpr (SFT_parser___parser_nodes[640] + 0)
#define ID_parser___parser_nodes___AMinusExpr (SFT_parser___parser_nodes[641])
#define COLOR_parser___parser_nodes___AMinusExpr (SFT_parser___parser_nodes[642])
#define INIT_TABLE_POS_parser___parser_nodes___AMinusExpr (SFT_parser___parser_nodes[643] + 0)
#define ID_parser___parser_nodes___AStarshipExpr (SFT_parser___parser_nodes[644])
#define COLOR_parser___parser_nodes___AStarshipExpr (SFT_parser___parser_nodes[645])
#define INIT_TABLE_POS_parser___parser_nodes___AStarshipExpr (SFT_parser___parser_nodes[646] + 0)
#define ID_parser___parser_nodes___AStarExpr (SFT_parser___parser_nodes[647])
#define COLOR_parser___parser_nodes___AStarExpr (SFT_parser___parser_nodes[648])
#define INIT_TABLE_POS_parser___parser_nodes___AStarExpr (SFT_parser___parser_nodes[649] + 0)
#define ID_parser___parser_nodes___ASlashExpr (SFT_parser___parser_nodes[650])
#define COLOR_parser___parser_nodes___ASlashExpr (SFT_parser___parser_nodes[651])
#define INIT_TABLE_POS_parser___parser_nodes___ASlashExpr (SFT_parser___parser_nodes[652] + 0)
#define ID_parser___parser_nodes___APercentExpr (SFT_parser___parser_nodes[653])
#define COLOR_parser___parser_nodes___APercentExpr (SFT_parser___parser_nodes[654])
#define INIT_TABLE_POS_parser___parser_nodes___APercentExpr (SFT_parser___parser_nodes[655] + 0)
#define ID_parser___parser_nodes___AUminusExpr (SFT_parser___parser_nodes[656])
#define COLOR_parser___parser_nodes___AUminusExpr (SFT_parser___parser_nodes[657])
#define ATTR_parser___parser_nodes___AUminusExpr____n_minus(recv) ATTR(recv, (SFT_parser___parser_nodes[658] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AUminusExpr (SFT_parser___parser_nodes[659] + 0)
#define CALL_parser___parser_nodes___AUminusExpr___n_minus(recv) ((parser___parser_nodes___AUminusExpr___n_minus_t)CALL((recv), (SFT_parser___parser_nodes[659] + 1)))
#define ID_parser___parser_nodes___ANewExpr (SFT_parser___parser_nodes[660])
#define COLOR_parser___parser_nodes___ANewExpr (SFT_parser___parser_nodes[661])
#define ATTR_parser___parser_nodes___ANewExpr____n_kwnew(recv) ATTR(recv, (SFT_parser___parser_nodes[662] + 0))
#define ATTR_parser___parser_nodes___ANewExpr____n_type(recv) ATTR(recv, (SFT_parser___parser_nodes[662] + 1))
#define ATTR_parser___parser_nodes___ANewExpr____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[662] + 2))
#define ATTR_parser___parser_nodes___ANewExpr____n_args(recv) ATTR(recv, (SFT_parser___parser_nodes[662] + 3))
#define INIT_TABLE_POS_parser___parser_nodes___ANewExpr (SFT_parser___parser_nodes[663] + 0)
#define CALL_parser___parser_nodes___ANewExpr___n_kwnew(recv) ((parser___parser_nodes___ANewExpr___n_kwnew_t)CALL((recv), (SFT_parser___parser_nodes[663] + 1)))
#define CALL_parser___parser_nodes___ANewExpr___n_type(recv) ((parser___parser_nodes___ANewExpr___n_type_t)CALL((recv), (SFT_parser___parser_nodes[663] + 2)))
#define CALL_parser___parser_nodes___ANewExpr___n_id(recv) ((parser___parser_nodes___ANewExpr___n_id_t)CALL((recv), (SFT_parser___parser_nodes[663] + 3)))
#define CALL_parser___parser_nodes___ANewExpr___n_args(recv) ((parser___parser_nodes___ANewExpr___n_args_t)CALL((recv), (SFT_parser___parser_nodes[663] + 4)))
#define ID_parser___parser_nodes___AAttrFormExpr (SFT_parser___parser_nodes[664])
#define COLOR_parser___parser_nodes___AAttrFormExpr (SFT_parser___parser_nodes[665])
#define ATTR_parser___parser_nodes___AAttrFormExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[666] + 0))
#define ATTR_parser___parser_nodes___AAttrFormExpr____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[666] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AAttrFormExpr (SFT_parser___parser_nodes[667] + 0)
#define CALL_parser___parser_nodes___AAttrFormExpr___n_expr(recv) ((parser___parser_nodes___AAttrFormExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[667] + 1)))
#define CALL_parser___parser_nodes___AAttrFormExpr___n_id(recv) ((parser___parser_nodes___AAttrFormExpr___n_id_t)CALL((recv), (SFT_parser___parser_nodes[667] + 2)))
#define ID_parser___parser_nodes___AAttrExpr (SFT_parser___parser_nodes[668])
#define COLOR_parser___parser_nodes___AAttrExpr (SFT_parser___parser_nodes[669])
#define INIT_TABLE_POS_parser___parser_nodes___AAttrExpr (SFT_parser___parser_nodes[670] + 0)
#define ID_parser___parser_nodes___AAttrAssignExpr (SFT_parser___parser_nodes[671])
#define COLOR_parser___parser_nodes___AAttrAssignExpr (SFT_parser___parser_nodes[672])
#define INIT_TABLE_POS_parser___parser_nodes___AAttrAssignExpr (SFT_parser___parser_nodes[673] + 0)
#define ID_parser___parser_nodes___ACallFormExpr (SFT_parser___parser_nodes[674])
#define COLOR_parser___parser_nodes___ACallFormExpr (SFT_parser___parser_nodes[675])
#define ATTR_parser___parser_nodes___ACallFormExpr____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[676] + 0))
#define ATTR_parser___parser_nodes___ACallFormExpr____n_args(recv) ATTR(recv, (SFT_parser___parser_nodes[676] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___ACallFormExpr (SFT_parser___parser_nodes[677] + 0)
#define CALL_parser___parser_nodes___ACallFormExpr___n_id(recv) ((parser___parser_nodes___ACallFormExpr___n_id_t)CALL((recv), (SFT_parser___parser_nodes[677] + 1)))
#define CALL_parser___parser_nodes___ACallFormExpr___n_args(recv) ((parser___parser_nodes___ACallFormExpr___n_args_t)CALL((recv), (SFT_parser___parser_nodes[677] + 2)))
#define ID_parser___parser_nodes___AAttrReassignExpr (SFT_parser___parser_nodes[678])
#define COLOR_parser___parser_nodes___AAttrReassignExpr (SFT_parser___parser_nodes[679])
#define INIT_TABLE_POS_parser___parser_nodes___AAttrReassignExpr (SFT_parser___parser_nodes[680] + 0)
#define ID_parser___parser_nodes___ACallExpr (SFT_parser___parser_nodes[681])
#define COLOR_parser___parser_nodes___ACallExpr (SFT_parser___parser_nodes[682])
#define INIT_TABLE_POS_parser___parser_nodes___ACallExpr (SFT_parser___parser_nodes[683] + 0)
#define ID_parser___parser_nodes___ACallAssignExpr (SFT_parser___parser_nodes[684])
#define COLOR_parser___parser_nodes___ACallAssignExpr (SFT_parser___parser_nodes[685])
#define INIT_TABLE_POS_parser___parser_nodes___ACallAssignExpr (SFT_parser___parser_nodes[686] + 0)
#define ID_parser___parser_nodes___ACallReassignExpr (SFT_parser___parser_nodes[687])
#define COLOR_parser___parser_nodes___ACallReassignExpr (SFT_parser___parser_nodes[688])
#define INIT_TABLE_POS_parser___parser_nodes___ACallReassignExpr (SFT_parser___parser_nodes[689] + 0)
#define ID_parser___parser_nodes___ASuperExpr (SFT_parser___parser_nodes[690])
#define COLOR_parser___parser_nodes___ASuperExpr (SFT_parser___parser_nodes[691])
#define ATTR_parser___parser_nodes___ASuperExpr____n_qualified(recv) ATTR(recv, (SFT_parser___parser_nodes[692] + 0))
#define ATTR_parser___parser_nodes___ASuperExpr____n_kwsuper(recv) ATTR(recv, (SFT_parser___parser_nodes[692] + 1))
#define ATTR_parser___parser_nodes___ASuperExpr____n_args(recv) ATTR(recv, (SFT_parser___parser_nodes[692] + 2))
#define INIT_TABLE_POS_parser___parser_nodes___ASuperExpr (SFT_parser___parser_nodes[693] + 0)
#define CALL_parser___parser_nodes___ASuperExpr___n_qualified(recv) ((parser___parser_nodes___ASuperExpr___n_qualified_t)CALL((recv), (SFT_parser___parser_nodes[693] + 1)))
#define CALL_parser___parser_nodes___ASuperExpr___n_kwsuper(recv) ((parser___parser_nodes___ASuperExpr___n_kwsuper_t)CALL((recv), (SFT_parser___parser_nodes[693] + 2)))
#define CALL_parser___parser_nodes___ASuperExpr___n_args(recv) ((parser___parser_nodes___ASuperExpr___n_args_t)CALL((recv), (SFT_parser___parser_nodes[693] + 3)))
#define ID_parser___parser_nodes___AInitExpr (SFT_parser___parser_nodes[694])
#define COLOR_parser___parser_nodes___AInitExpr (SFT_parser___parser_nodes[695])
#define ATTR_parser___parser_nodes___AInitExpr____n_kwinit(recv) ATTR(recv, (SFT_parser___parser_nodes[696] + 0))
#define ATTR_parser___parser_nodes___AInitExpr____n_args(recv) ATTR(recv, (SFT_parser___parser_nodes[696] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___AInitExpr (SFT_parser___parser_nodes[697] + 0)
#define CALL_parser___parser_nodes___AInitExpr___n_kwinit(recv) ((parser___parser_nodes___AInitExpr___n_kwinit_t)CALL((recv), (SFT_parser___parser_nodes[697] + 1)))
#define CALL_parser___parser_nodes___AInitExpr___n_args(recv) ((parser___parser_nodes___AInitExpr___n_args_t)CALL((recv), (SFT_parser___parser_nodes[697] + 2)))
#define ID_parser___parser_nodes___ABraFormExpr (SFT_parser___parser_nodes[698])
#define COLOR_parser___parser_nodes___ABraFormExpr (SFT_parser___parser_nodes[699])
#define ATTR_parser___parser_nodes___ABraFormExpr____n_args(recv) ATTR(recv, (SFT_parser___parser_nodes[700] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ABraFormExpr (SFT_parser___parser_nodes[701] + 0)
#define CALL_parser___parser_nodes___ABraFormExpr___n_args(recv) ((parser___parser_nodes___ABraFormExpr___n_args_t)CALL((recv), (SFT_parser___parser_nodes[701] + 1)))
#define ID_parser___parser_nodes___ABraExpr (SFT_parser___parser_nodes[702])
#define COLOR_parser___parser_nodes___ABraExpr (SFT_parser___parser_nodes[703])
#define INIT_TABLE_POS_parser___parser_nodes___ABraExpr (SFT_parser___parser_nodes[704] + 0)
#define ID_parser___parser_nodes___ABraAssignExpr (SFT_parser___parser_nodes[705])
#define COLOR_parser___parser_nodes___ABraAssignExpr (SFT_parser___parser_nodes[706])
#define INIT_TABLE_POS_parser___parser_nodes___ABraAssignExpr (SFT_parser___parser_nodes[707] + 0)
#define ID_parser___parser_nodes___AVarFormExpr (SFT_parser___parser_nodes[708])
#define COLOR_parser___parser_nodes___AVarFormExpr (SFT_parser___parser_nodes[709])
#define ATTR_parser___parser_nodes___AVarFormExpr____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[710] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AVarFormExpr (SFT_parser___parser_nodes[711] + 0)
#define CALL_parser___parser_nodes___AVarFormExpr___n_id(recv) ((parser___parser_nodes___AVarFormExpr___n_id_t)CALL((recv), (SFT_parser___parser_nodes[711] + 1)))
#define ID_parser___parser_nodes___ABraReassignExpr (SFT_parser___parser_nodes[712])
#define COLOR_parser___parser_nodes___ABraReassignExpr (SFT_parser___parser_nodes[713])
#define INIT_TABLE_POS_parser___parser_nodes___ABraReassignExpr (SFT_parser___parser_nodes[714] + 0)
#define ID_parser___parser_nodes___AClosureCallExpr (SFT_parser___parser_nodes[715])
#define COLOR_parser___parser_nodes___AClosureCallExpr (SFT_parser___parser_nodes[716])
#define ATTR_parser___parser_nodes___AClosureCallExpr____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[717] + 0))
#define ATTR_parser___parser_nodes___AClosureCallExpr____n_args(recv) ATTR(recv, (SFT_parser___parser_nodes[717] + 1))
#define ATTR_parser___parser_nodes___AClosureCallExpr____n_closure_defs(recv) ATTR(recv, (SFT_parser___parser_nodes[717] + 2))
#define INIT_TABLE_POS_parser___parser_nodes___AClosureCallExpr (SFT_parser___parser_nodes[718] + 0)
#define CALL_parser___parser_nodes___AClosureCallExpr___n_id(recv) ((parser___parser_nodes___AClosureCallExpr___n_id_t)CALL((recv), (SFT_parser___parser_nodes[718] + 1)))
#define CALL_parser___parser_nodes___AClosureCallExpr___n_args(recv) ((parser___parser_nodes___AClosureCallExpr___n_args_t)CALL((recv), (SFT_parser___parser_nodes[718] + 2)))
#define CALL_parser___parser_nodes___AClosureCallExpr___n_closure_defs(recv) ((parser___parser_nodes___AClosureCallExpr___n_closure_defs_t)CALL((recv), (SFT_parser___parser_nodes[718] + 3)))
#define ID_parser___parser_nodes___AVarExpr (SFT_parser___parser_nodes[719])
#define COLOR_parser___parser_nodes___AVarExpr (SFT_parser___parser_nodes[720])
#define INIT_TABLE_POS_parser___parser_nodes___AVarExpr (SFT_parser___parser_nodes[721] + 0)
#define ID_parser___parser_nodes___AVarAssignExpr (SFT_parser___parser_nodes[722])
#define COLOR_parser___parser_nodes___AVarAssignExpr (SFT_parser___parser_nodes[723])
#define INIT_TABLE_POS_parser___parser_nodes___AVarAssignExpr (SFT_parser___parser_nodes[724] + 0)
#define ID_parser___parser_nodes___AVarReassignExpr (SFT_parser___parser_nodes[725])
#define COLOR_parser___parser_nodes___AVarReassignExpr (SFT_parser___parser_nodes[726])
#define INIT_TABLE_POS_parser___parser_nodes___AVarReassignExpr (SFT_parser___parser_nodes[727] + 0)
#define ID_parser___parser_nodes___ARangeExpr (SFT_parser___parser_nodes[728])
#define COLOR_parser___parser_nodes___ARangeExpr (SFT_parser___parser_nodes[729])
#define ATTR_parser___parser_nodes___ARangeExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[730] + 0))
#define ATTR_parser___parser_nodes___ARangeExpr____n_expr2(recv) ATTR(recv, (SFT_parser___parser_nodes[730] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___ARangeExpr (SFT_parser___parser_nodes[731] + 0)
#define CALL_parser___parser_nodes___ARangeExpr___n_expr(recv) ((parser___parser_nodes___ARangeExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[731] + 1)))
#define CALL_parser___parser_nodes___ARangeExpr___n_expr2(recv) ((parser___parser_nodes___ARangeExpr___n_expr2_t)CALL((recv), (SFT_parser___parser_nodes[731] + 2)))
#define ID_parser___parser_nodes___ACrangeExpr (SFT_parser___parser_nodes[732])
#define COLOR_parser___parser_nodes___ACrangeExpr (SFT_parser___parser_nodes[733])
#define INIT_TABLE_POS_parser___parser_nodes___ACrangeExpr (SFT_parser___parser_nodes[734] + 0)
#define ID_parser___parser_nodes___AOrangeExpr (SFT_parser___parser_nodes[735])
#define COLOR_parser___parser_nodes___AOrangeExpr (SFT_parser___parser_nodes[736])
#define INIT_TABLE_POS_parser___parser_nodes___AOrangeExpr (SFT_parser___parser_nodes[737] + 0)
#define ID_parser___parser_nodes___AArrayExpr (SFT_parser___parser_nodes[738])
#define COLOR_parser___parser_nodes___AArrayExpr (SFT_parser___parser_nodes[739])
#define ATTR_parser___parser_nodes___AArrayExpr____n_exprs(recv) ATTR(recv, (SFT_parser___parser_nodes[740] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AArrayExpr (SFT_parser___parser_nodes[741] + 0)
#define CALL_parser___parser_nodes___AArrayExpr___n_exprs(recv) ((parser___parser_nodes___AArrayExpr___n_exprs_t)CALL((recv), (SFT_parser___parser_nodes[741] + 1)))
#define ID_parser___parser_nodes___ASelfExpr (SFT_parser___parser_nodes[742])
#define COLOR_parser___parser_nodes___ASelfExpr (SFT_parser___parser_nodes[743])
#define ATTR_parser___parser_nodes___ASelfExpr____n_kwself(recv) ATTR(recv, (SFT_parser___parser_nodes[744] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ASelfExpr (SFT_parser___parser_nodes[745] + 0)
#define CALL_parser___parser_nodes___ASelfExpr___n_kwself(recv) ((parser___parser_nodes___ASelfExpr___n_kwself_t)CALL((recv), (SFT_parser___parser_nodes[745] + 1)))
#define ID_parser___parser_nodes___AImplicitSelfExpr (SFT_parser___parser_nodes[746])
#define COLOR_parser___parser_nodes___AImplicitSelfExpr (SFT_parser___parser_nodes[747])
#define INIT_TABLE_POS_parser___parser_nodes___AImplicitSelfExpr (SFT_parser___parser_nodes[748] + 0)
#define ID_parser___parser_nodes___ATrueExpr (SFT_parser___parser_nodes[749])
#define COLOR_parser___parser_nodes___ATrueExpr (SFT_parser___parser_nodes[750])
#define ATTR_parser___parser_nodes___ATrueExpr____n_kwtrue(recv) ATTR(recv, (SFT_parser___parser_nodes[751] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ATrueExpr (SFT_parser___parser_nodes[752] + 0)
#define CALL_parser___parser_nodes___ATrueExpr___n_kwtrue(recv) ((parser___parser_nodes___ATrueExpr___n_kwtrue_t)CALL((recv), (SFT_parser___parser_nodes[752] + 1)))
#define ID_parser___parser_nodes___AFalseExpr (SFT_parser___parser_nodes[753])
#define COLOR_parser___parser_nodes___AFalseExpr (SFT_parser___parser_nodes[754])
#define ATTR_parser___parser_nodes___AFalseExpr____n_kwfalse(recv) ATTR(recv, (SFT_parser___parser_nodes[755] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AFalseExpr (SFT_parser___parser_nodes[756] + 0)
#define CALL_parser___parser_nodes___AFalseExpr___n_kwfalse(recv) ((parser___parser_nodes___AFalseExpr___n_kwfalse_t)CALL((recv), (SFT_parser___parser_nodes[756] + 1)))
#define ID_parser___parser_nodes___ANullExpr (SFT_parser___parser_nodes[757])
#define COLOR_parser___parser_nodes___ANullExpr (SFT_parser___parser_nodes[758])
#define ATTR_parser___parser_nodes___ANullExpr____n_kwnull(recv) ATTR(recv, (SFT_parser___parser_nodes[759] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ANullExpr (SFT_parser___parser_nodes[760] + 0)
#define CALL_parser___parser_nodes___ANullExpr___n_kwnull(recv) ((parser___parser_nodes___ANullExpr___n_kwnull_t)CALL((recv), (SFT_parser___parser_nodes[760] + 1)))
#define ID_parser___parser_nodes___AIntExpr (SFT_parser___parser_nodes[761])
#define COLOR_parser___parser_nodes___AIntExpr (SFT_parser___parser_nodes[762])
#define ATTR_parser___parser_nodes___AIntExpr____n_number(recv) ATTR(recv, (SFT_parser___parser_nodes[763] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AIntExpr (SFT_parser___parser_nodes[764] + 0)
#define CALL_parser___parser_nodes___AIntExpr___n_number(recv) ((parser___parser_nodes___AIntExpr___n_number_t)CALL((recv), (SFT_parser___parser_nodes[764] + 1)))
#define ID_parser___parser_nodes___AFloatExpr (SFT_parser___parser_nodes[765])
#define COLOR_parser___parser_nodes___AFloatExpr (SFT_parser___parser_nodes[766])
#define ATTR_parser___parser_nodes___AFloatExpr____n_float(recv) ATTR(recv, (SFT_parser___parser_nodes[767] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AFloatExpr (SFT_parser___parser_nodes[768] + 0)
#define CALL_parser___parser_nodes___AFloatExpr___n_float(recv) ((parser___parser_nodes___AFloatExpr___n_float_t)CALL((recv), (SFT_parser___parser_nodes[768] + 1)))
#define ID_parser___parser_nodes___ACharExpr (SFT_parser___parser_nodes[769])
#define COLOR_parser___parser_nodes___ACharExpr (SFT_parser___parser_nodes[770])
#define ATTR_parser___parser_nodes___ACharExpr____n_char(recv) ATTR(recv, (SFT_parser___parser_nodes[771] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ACharExpr (SFT_parser___parser_nodes[772] + 0)
#define CALL_parser___parser_nodes___ACharExpr___n_char(recv) ((parser___parser_nodes___ACharExpr___n_char_t)CALL((recv), (SFT_parser___parser_nodes[772] + 1)))
#define ID_parser___parser_nodes___AStringFormExpr (SFT_parser___parser_nodes[773])
#define COLOR_parser___parser_nodes___AStringFormExpr (SFT_parser___parser_nodes[774])
#define INIT_TABLE_POS_parser___parser_nodes___AStringFormExpr (SFT_parser___parser_nodes[775] + 0)
#define ID_parser___parser_nodes___AStringExpr (SFT_parser___parser_nodes[776])
#define COLOR_parser___parser_nodes___AStringExpr (SFT_parser___parser_nodes[777])
#define ATTR_parser___parser_nodes___AStringExpr____n_string(recv) ATTR(recv, (SFT_parser___parser_nodes[778] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AStringExpr (SFT_parser___parser_nodes[779] + 0)
#define CALL_parser___parser_nodes___AStringExpr___n_string(recv) ((parser___parser_nodes___AStringExpr___n_string_t)CALL((recv), (SFT_parser___parser_nodes[779] + 1)))
#define ID_parser___parser_nodes___AStartStringExpr (SFT_parser___parser_nodes[780])
#define COLOR_parser___parser_nodes___AStartStringExpr (SFT_parser___parser_nodes[781])
#define ATTR_parser___parser_nodes___AStartStringExpr____n_string(recv) ATTR(recv, (SFT_parser___parser_nodes[782] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AStartStringExpr (SFT_parser___parser_nodes[783] + 0)
#define CALL_parser___parser_nodes___AStartStringExpr___n_string(recv) ((parser___parser_nodes___AStartStringExpr___n_string_t)CALL((recv), (SFT_parser___parser_nodes[783] + 1)))
#define ID_parser___parser_nodes___AMidStringExpr (SFT_parser___parser_nodes[784])
#define COLOR_parser___parser_nodes___AMidStringExpr (SFT_parser___parser_nodes[785])
#define ATTR_parser___parser_nodes___AMidStringExpr____n_string(recv) ATTR(recv, (SFT_parser___parser_nodes[786] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AMidStringExpr (SFT_parser___parser_nodes[787] + 0)
#define CALL_parser___parser_nodes___AMidStringExpr___n_string(recv) ((parser___parser_nodes___AMidStringExpr___n_string_t)CALL((recv), (SFT_parser___parser_nodes[787] + 1)))
#define ID_parser___parser_nodes___AEndStringExpr (SFT_parser___parser_nodes[788])
#define COLOR_parser___parser_nodes___AEndStringExpr (SFT_parser___parser_nodes[789])
#define ATTR_parser___parser_nodes___AEndStringExpr____n_string(recv) ATTR(recv, (SFT_parser___parser_nodes[790] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AEndStringExpr (SFT_parser___parser_nodes[791] + 0)
#define CALL_parser___parser_nodes___AEndStringExpr___n_string(recv) ((parser___parser_nodes___AEndStringExpr___n_string_t)CALL((recv), (SFT_parser___parser_nodes[791] + 1)))
#define ID_parser___parser_nodes___ASuperstringExpr (SFT_parser___parser_nodes[792])
#define COLOR_parser___parser_nodes___ASuperstringExpr (SFT_parser___parser_nodes[793])
#define ATTR_parser___parser_nodes___ASuperstringExpr____n_exprs(recv) ATTR(recv, (SFT_parser___parser_nodes[794] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ASuperstringExpr (SFT_parser___parser_nodes[795] + 0)
#define CALL_parser___parser_nodes___ASuperstringExpr___n_exprs(recv) ((parser___parser_nodes___ASuperstringExpr___n_exprs_t)CALL((recv), (SFT_parser___parser_nodes[795] + 1)))
#define ID_parser___parser_nodes___AParExpr (SFT_parser___parser_nodes[796])
#define COLOR_parser___parser_nodes___AParExpr (SFT_parser___parser_nodes[797])
#define INIT_TABLE_POS_parser___parser_nodes___AParExpr (SFT_parser___parser_nodes[798] + 0)
#define ID_parser___parser_nodes___AProxyExpr (SFT_parser___parser_nodes[799])
#define COLOR_parser___parser_nodes___AProxyExpr (SFT_parser___parser_nodes[800])
#define ATTR_parser___parser_nodes___AProxyExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[801] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AProxyExpr (SFT_parser___parser_nodes[802] + 0)
#define CALL_parser___parser_nodes___AProxyExpr___n_expr(recv) ((parser___parser_nodes___AProxyExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[802] + 1)))
#define ID_parser___parser_nodes___AAsCastExpr (SFT_parser___parser_nodes[803])
#define COLOR_parser___parser_nodes___AAsCastExpr (SFT_parser___parser_nodes[804])
#define ATTR_parser___parser_nodes___AAsCastExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[805] + 0))
#define ATTR_parser___parser_nodes___AAsCastExpr____n_kwas(recv) ATTR(recv, (SFT_parser___parser_nodes[805] + 1))
#define ATTR_parser___parser_nodes___AAsCastExpr____n_type(recv) ATTR(recv, (SFT_parser___parser_nodes[805] + 2))
#define INIT_TABLE_POS_parser___parser_nodes___AAsCastExpr (SFT_parser___parser_nodes[806] + 0)
#define CALL_parser___parser_nodes___AAsCastExpr___n_expr(recv) ((parser___parser_nodes___AAsCastExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[806] + 1)))
#define CALL_parser___parser_nodes___AAsCastExpr___n_kwas(recv) ((parser___parser_nodes___AAsCastExpr___n_kwas_t)CALL((recv), (SFT_parser___parser_nodes[806] + 2)))
#define CALL_parser___parser_nodes___AAsCastExpr___n_type(recv) ((parser___parser_nodes___AAsCastExpr___n_type_t)CALL((recv), (SFT_parser___parser_nodes[806] + 3)))
#define ID_parser___parser_nodes___AAsNotnullExpr (SFT_parser___parser_nodes[807])
#define COLOR_parser___parser_nodes___AAsNotnullExpr (SFT_parser___parser_nodes[808])
#define ATTR_parser___parser_nodes___AAsNotnullExpr____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[809] + 0))
#define ATTR_parser___parser_nodes___AAsNotnullExpr____n_kwas(recv) ATTR(recv, (SFT_parser___parser_nodes[809] + 1))
#define ATTR_parser___parser_nodes___AAsNotnullExpr____n_kwnot(recv) ATTR(recv, (SFT_parser___parser_nodes[809] + 2))
#define ATTR_parser___parser_nodes___AAsNotnullExpr____n_kwnull(recv) ATTR(recv, (SFT_parser___parser_nodes[809] + 3))
#define INIT_TABLE_POS_parser___parser_nodes___AAsNotnullExpr (SFT_parser___parser_nodes[810] + 0)
#define CALL_parser___parser_nodes___AAsNotnullExpr___n_expr(recv) ((parser___parser_nodes___AAsNotnullExpr___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[810] + 1)))
#define CALL_parser___parser_nodes___AAsNotnullExpr___n_kwas(recv) ((parser___parser_nodes___AAsNotnullExpr___n_kwas_t)CALL((recv), (SFT_parser___parser_nodes[810] + 2)))
#define CALL_parser___parser_nodes___AAsNotnullExpr___n_kwnot(recv) ((parser___parser_nodes___AAsNotnullExpr___n_kwnot_t)CALL((recv), (SFT_parser___parser_nodes[810] + 3)))
#define CALL_parser___parser_nodes___AAsNotnullExpr___n_kwnull(recv) ((parser___parser_nodes___AAsNotnullExpr___n_kwnull_t)CALL((recv), (SFT_parser___parser_nodes[810] + 4)))
#define ID_parser___parser_nodes___AIssetAttrExpr (SFT_parser___parser_nodes[811])
#define COLOR_parser___parser_nodes___AIssetAttrExpr (SFT_parser___parser_nodes[812])
#define ATTR_parser___parser_nodes___AIssetAttrExpr____n_kwisset(recv) ATTR(recv, (SFT_parser___parser_nodes[813] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AIssetAttrExpr (SFT_parser___parser_nodes[814] + 0)
#define CALL_parser___parser_nodes___AIssetAttrExpr___n_kwisset(recv) ((parser___parser_nodes___AIssetAttrExpr___n_kwisset_t)CALL((recv), (SFT_parser___parser_nodes[814] + 1)))
#define ID_parser___parser_nodes___AAssignOp (SFT_parser___parser_nodes[815])
#define COLOR_parser___parser_nodes___AAssignOp (SFT_parser___parser_nodes[816])
#define INIT_TABLE_POS_parser___parser_nodes___AAssignOp (SFT_parser___parser_nodes[817] + 0)
#define ID_parser___parser_nodes___APlusAssignOp (SFT_parser___parser_nodes[818])
#define COLOR_parser___parser_nodes___APlusAssignOp (SFT_parser___parser_nodes[819])
#define ATTR_parser___parser_nodes___APlusAssignOp____n_pluseq(recv) ATTR(recv, (SFT_parser___parser_nodes[820] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___APlusAssignOp (SFT_parser___parser_nodes[821] + 0)
#define CALL_parser___parser_nodes___APlusAssignOp___n_pluseq(recv) ((parser___parser_nodes___APlusAssignOp___n_pluseq_t)CALL((recv), (SFT_parser___parser_nodes[821] + 1)))
#define ID_parser___parser_nodes___AMinusAssignOp (SFT_parser___parser_nodes[822])
#define COLOR_parser___parser_nodes___AMinusAssignOp (SFT_parser___parser_nodes[823])
#define ATTR_parser___parser_nodes___AMinusAssignOp____n_minuseq(recv) ATTR(recv, (SFT_parser___parser_nodes[824] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___AMinusAssignOp (SFT_parser___parser_nodes[825] + 0)
#define CALL_parser___parser_nodes___AMinusAssignOp___n_minuseq(recv) ((parser___parser_nodes___AMinusAssignOp___n_minuseq_t)CALL((recv), (SFT_parser___parser_nodes[825] + 1)))
#define ID_parser___parser_nodes___AClosureDef (SFT_parser___parser_nodes[826])
#define COLOR_parser___parser_nodes___AClosureDef (SFT_parser___parser_nodes[827])
#define ATTR_parser___parser_nodes___AClosureDef____n_bang(recv) ATTR(recv, (SFT_parser___parser_nodes[828] + 0))
#define ATTR_parser___parser_nodes___AClosureDef____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[828] + 1))
#define ATTR_parser___parser_nodes___AClosureDef____n_ids(recv) ATTR(recv, (SFT_parser___parser_nodes[828] + 2))
#define ATTR_parser___parser_nodes___AClosureDef____n_kwdo(recv) ATTR(recv, (SFT_parser___parser_nodes[828] + 3))
#define ATTR_parser___parser_nodes___AClosureDef____n_expr(recv) ATTR(recv, (SFT_parser___parser_nodes[828] + 4))
#define INIT_TABLE_POS_parser___parser_nodes___AClosureDef (SFT_parser___parser_nodes[829] + 0)
#define CALL_parser___parser_nodes___AClosureDef___n_bang(recv) ((parser___parser_nodes___AClosureDef___n_bang_t)CALL((recv), (SFT_parser___parser_nodes[829] + 1)))
#define CALL_parser___parser_nodes___AClosureDef___n_id(recv) ((parser___parser_nodes___AClosureDef___n_id_t)CALL((recv), (SFT_parser___parser_nodes[829] + 2)))
#define CALL_parser___parser_nodes___AClosureDef___n_ids(recv) ((parser___parser_nodes___AClosureDef___n_ids_t)CALL((recv), (SFT_parser___parser_nodes[829] + 3)))
#define CALL_parser___parser_nodes___AClosureDef___n_kwdo(recv) ((parser___parser_nodes___AClosureDef___n_kwdo_t)CALL((recv), (SFT_parser___parser_nodes[829] + 4)))
#define CALL_parser___parser_nodes___AClosureDef___n_expr(recv) ((parser___parser_nodes___AClosureDef___n_expr_t)CALL((recv), (SFT_parser___parser_nodes[829] + 5)))
#define ID_parser___parser_nodes___AClosureId (SFT_parser___parser_nodes[830])
#define COLOR_parser___parser_nodes___AClosureId (SFT_parser___parser_nodes[831])
#define INIT_TABLE_POS_parser___parser_nodes___AClosureId (SFT_parser___parser_nodes[832] + 0)
#define ID_parser___parser_nodes___ASimpleClosureId (SFT_parser___parser_nodes[833])
#define COLOR_parser___parser_nodes___ASimpleClosureId (SFT_parser___parser_nodes[834])
#define ATTR_parser___parser_nodes___ASimpleClosureId____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[835] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ASimpleClosureId (SFT_parser___parser_nodes[836] + 0)
#define CALL_parser___parser_nodes___ASimpleClosureId___n_id(recv) ((parser___parser_nodes___ASimpleClosureId___n_id_t)CALL((recv), (SFT_parser___parser_nodes[836] + 1)))
#define ID_parser___parser_nodes___ABreakClosureId (SFT_parser___parser_nodes[837])
#define COLOR_parser___parser_nodes___ABreakClosureId (SFT_parser___parser_nodes[838])
#define ATTR_parser___parser_nodes___ABreakClosureId____n_kwbreak(recv) ATTR(recv, (SFT_parser___parser_nodes[839] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ABreakClosureId (SFT_parser___parser_nodes[840] + 0)
#define CALL_parser___parser_nodes___ABreakClosureId___n_kwbreak(recv) ((parser___parser_nodes___ABreakClosureId___n_kwbreak_t)CALL((recv), (SFT_parser___parser_nodes[840] + 1)))
#define ID_parser___parser_nodes___AModuleName (SFT_parser___parser_nodes[841])
#define COLOR_parser___parser_nodes___AModuleName (SFT_parser___parser_nodes[842])
#define ATTR_parser___parser_nodes___AModuleName____n_quad(recv) ATTR(recv, (SFT_parser___parser_nodes[843] + 0))
#define ATTR_parser___parser_nodes___AModuleName____n_path(recv) ATTR(recv, (SFT_parser___parser_nodes[843] + 1))
#define ATTR_parser___parser_nodes___AModuleName____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[843] + 2))
#define INIT_TABLE_POS_parser___parser_nodes___AModuleName (SFT_parser___parser_nodes[844] + 0)
#define CALL_parser___parser_nodes___AModuleName___n_quad(recv) ((parser___parser_nodes___AModuleName___n_quad_t)CALL((recv), (SFT_parser___parser_nodes[844] + 1)))
#define CALL_parser___parser_nodes___AModuleName___n_path(recv) ((parser___parser_nodes___AModuleName___n_path_t)CALL((recv), (SFT_parser___parser_nodes[844] + 2)))
#define CALL_parser___parser_nodes___AModuleName___n_id(recv) ((parser___parser_nodes___AModuleName___n_id_t)CALL((recv), (SFT_parser___parser_nodes[844] + 3)))
#define ID_parser___parser_nodes___AQualified (SFT_parser___parser_nodes[845])
#define COLOR_parser___parser_nodes___AQualified (SFT_parser___parser_nodes[846])
#define ATTR_parser___parser_nodes___AQualified____n_quad(recv) ATTR(recv, (SFT_parser___parser_nodes[847] + 0))
#define ATTR_parser___parser_nodes___AQualified____n_id(recv) ATTR(recv, (SFT_parser___parser_nodes[847] + 1))
#define ATTR_parser___parser_nodes___AQualified____n_classid(recv) ATTR(recv, (SFT_parser___parser_nodes[847] + 2))
#define INIT_TABLE_POS_parser___parser_nodes___AQualified (SFT_parser___parser_nodes[848] + 0)
#define CALL_parser___parser_nodes___AQualified___n_quad(recv) ((parser___parser_nodes___AQualified___n_quad_t)CALL((recv), (SFT_parser___parser_nodes[848] + 1)))
#define CALL_parser___parser_nodes___AQualified___n_id(recv) ((parser___parser_nodes___AQualified___n_id_t)CALL((recv), (SFT_parser___parser_nodes[848] + 2)))
#define CALL_parser___parser_nodes___AQualified___n_classid(recv) ((parser___parser_nodes___AQualified___n_classid_t)CALL((recv), (SFT_parser___parser_nodes[848] + 3)))
#define ID_parser___parser_nodes___ADoc (SFT_parser___parser_nodes[849])
#define COLOR_parser___parser_nodes___ADoc (SFT_parser___parser_nodes[850])
#define ATTR_parser___parser_nodes___ADoc____n_comment(recv) ATTR(recv, (SFT_parser___parser_nodes[851] + 0))
#define INIT_TABLE_POS_parser___parser_nodes___ADoc (SFT_parser___parser_nodes[852] + 0)
#define CALL_parser___parser_nodes___ADoc___n_comment(recv) ((parser___parser_nodes___ADoc___n_comment_t)CALL((recv), (SFT_parser___parser_nodes[852] + 1)))
#define ID_parser___parser_nodes___Start (SFT_parser___parser_nodes[853])
#define COLOR_parser___parser_nodes___Start (SFT_parser___parser_nodes[854])
#define ATTR_parser___parser_nodes___Start____n_base(recv) ATTR(recv, (SFT_parser___parser_nodes[855] + 0))
#define ATTR_parser___parser_nodes___Start____n_eof(recv) ATTR(recv, (SFT_parser___parser_nodes[855] + 1))
#define INIT_TABLE_POS_parser___parser_nodes___Start (SFT_parser___parser_nodes[856] + 0)
#define CALL_parser___parser_nodes___Start___n_base(recv) ((parser___parser_nodes___Start___n_base_t)CALL((recv), (SFT_parser___parser_nodes[856] + 1)))
#define CALL_parser___parser_nodes___Start___n_eof(recv) ((parser___parser_nodes___Start___n_eof_t)CALL((recv), (SFT_parser___parser_nodes[856] + 2)))
...
static const char * const LOCATE_parser___parser_nodes___AExternMethPropdef___n_extern = "parser_nodes::AExternMethPropdef::n_extern";
val_t parser___parser_nodes___AExternMethPropdef___n_extern(val_t p0);
typedef val_t (*parser___parser_nodes___AExternMethPropdef___n_extern_t)(val_t p0);
...
val_t NEW_AConcreteInitPropdef_parser___parser_nodes___ANode___init(val_t p0);
