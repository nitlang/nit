...
extern const int COLOR_nitni_utilities__MMethod__build_ccall_intern;
...
void CHECK_NEW_nitni_utilities__CallContext(val*);
...
void CHECK_NEW_nitni_utilities__SignatureLength(val*);
