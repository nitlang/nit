...
(nitmethod_t)VIRTUAL_abstract_collection__Collection__iterate, /* pointer to string:String:abstract_collection#Collection#iterate */
...
(nitmethod_t)VIRTUAL_abstract_collection__Collection__iterate, /* pointer to string:Buffer:abstract_collection#Collection#iterate */
...
if (var == NULL) {
fprintf(stderr, "Runtime error: %s (%s:%d)\n", "Uninitialized attribute _container", "lib/standard/collection/abstract_collection.nit", 207);
exit(1);
}
}
...
if (var == NULL) {
fprintf(stderr, "Runtime error: %s (%s:%d)\n", "Uninitialized attribute _iter", "lib/standard/collection/abstract_collection.nit", 580);
exit(1);
}
}
...
(nitmethod_t)VIRTUAL_kernel__Int__enumerate_to, /* pointer to kernel:Int:kernel#Int#enumerate_to */
(nitmethod_t)VIRTUAL_kernel__Int__enumerate_before, /* pointer to kernel:Int:kernel#Int#enumerate_before */
...
(nitmethod_t)VIRTUAL_range__Range__iterate, /* pointer to range:Range:range#Range#iterate */
...
if (var == NULL) {
fprintf(stderr, "Runtime error: %s (%s:%d)\n", "Uninitialized attribute _range", "lib/standard/collection/range.nit", 90);
exit(1);
}
...
(nitmethod_t)VIRTUAL_abstract_collection__Collection__iterate, /* pointer to list:List:abstract_collection#Collection#iterate */
...
if (var == NULL) {
fprintf(stderr, "Runtime error: %s (%s:%d)\n", "Uninitialized attribute _list", "lib/standard/collection/list.nit", 276);
exit(1);
}
...
(nitmethod_t)VIRTUAL_abstract_collection__Collection__iterate, /* pointer to list:ListNode:abstract_collection#Collection#iterate */
...
(nitmethod_t)VIRTUAL_array__Array__iterate, /* pointer to array:Array:array#Array#iterate */
...
(nitmethod_t)VIRTUAL_array__Array__sort, /* pointer to array:Array:array#Array#sort */
(nitmethod_t)VIRTUAL_array__Array__sub_sort, /* pointer to array:Array:array#Array#sub_sort */
...
if (var == NULL) {
fprintf(stderr, "Runtime error: %s (%s:%d)\n", "Uninitialized attribute _array", "lib/standard/collection/array.nit", 439);
exit(1);
}
}
...
(nitmethod_t)VIRTUAL_abstract_collection__Collection__iterate, /* pointer to array:ArraySet:abstract_collection#Collection#iterate */
...
if (var == NULL) {
fprintf(stderr, "Runtime error: %s (%s:%d)\n", "Uninitialized attribute _array", "lib/standard/collection/array.nit", 448);
exit(1);
}
}
...
if (var == NULL) {
fprintf(stderr, "Runtime error: %s (%s:%d)\n", "Uninitialized attribute _iter", "lib/standard/collection/array.nit", 505);
exit(1);
}
}
...
(nitmethod_t)VIRTUAL_kernel__Object__is_same_type, /* pointer to array:ArrayMap:kernel#Object#is_same_type */
...
(nitmethod_t)VIRTUAL_kernel__Object__output, /* pointer to array:ArrayMap:kernel#Object#output */
(nitmethod_t)VIRTUAL_kernel__Object__output_class_name, /* pointer to array:ArrayMap:kernel#Object#output_class_name */
...
(nitmethod_t)VIRTUAL_math__Object__atan2, /* pointer to array:ArrayMap:math#Object#atan2 */
(nitmethod_t)VIRTUAL_math__Object__pi, /* pointer to array:ArrayMap:math#Object#pi */
(nitmethod_t)VIRTUAL_math__Object__srand_from, /* pointer to array:ArrayMap:math#Object#srand_from */
(nitmethod_t)VIRTUAL_math__Object__srand, /* pointer to array:ArrayMap:math#Object#srand */
(nitmethod_t)VIRTUAL_stream__Object__poll, /* pointer to array:ArrayMap:stream#Object#poll */
(nitmethod_t)VIRTUAL_stream__Object__intern_poll, /* pointer to array:ArrayMap:stream#Object#intern_poll */
...
(nitmethod_t)VIRTUAL_file__Object__getc, /* pointer to array:ArrayMap:file#Object#getc */
(nitmethod_t)VIRTUAL_file__Object__gets, /* pointer to array:ArrayMap:file#Object#gets */
...
(nitmethod_t)VIRTUAL_file__Object__stdin, /* pointer to array:ArrayMap:file#Object#stdin */
(nitmethod_t)VIRTUAL_file__Object__stdout, /* pointer to array:ArrayMap:file#Object#stdout */
(nitmethod_t)VIRTUAL_file__Object__stderr, /* pointer to array:ArrayMap:file#Object#stderr */
...
(nitmethod_t)VIRTUAL_abstract_collection__MapRead__get_or_default, /* pointer to array:ArrayMap:abstract_collection#MapRead#get_or_default */
(nitmethod_t)VIRTUAL_abstract_collection__MapRead__has_key, /* pointer to array:ArrayMap:abstract_collection#MapRead#has_key */
(nitmethod_t)VIRTUAL_array__ArrayMap__iterator, /* pointer to array:ArrayMap:array#ArrayMap#iterator */
(nitmethod_t)VIRTUAL_abstract_collection__MapRead__iterate, /* pointer to array:ArrayMap:abstract_collection#MapRead#iterate */
...
(nitmethod_t)VIRTUAL_abstract_collection__Map__recover_with, /* pointer to array:ArrayMap:abstract_collection#Map#recover_with */
(nitmethod_t)VIRTUAL_array__ArrayMap__clear, /* pointer to array:ArrayMap:array#ArrayMap#clear */
(nitmethod_t)VIRTUAL_string__Map__join, /* pointer to array:ArrayMap:string#Map#join */
(nitmethod_t)VIRTUAL_array__ArrayMap__couple_at, /* pointer to array:ArrayMap:array#ArrayMap#couple_at */
(nitmethod_t)VIRTUAL_array__ArrayMap__keys_61d, /* pointer to array:ArrayMap:array#ArrayMap#keys= */
(nitmethod_t)VIRTUAL_array__ArrayMap__values_61d, /* pointer to array:ArrayMap:array#ArrayMap#values= */
(nitmethod_t)VIRTUAL_array__ArrayMap__enlarge, /* pointer to array:ArrayMap:array#ArrayMap#enlarge */
...
((void (*)(val*, val*))(var->class->vft[COLOR_array__ArrayMapKeys__init]))(var, self) /* init on <var:ArrayMapKeys[Object, nullable Object]>*/;
CHECK_NEW_array__ArrayMapKeys(var);
self->attrs[COLOR_array__ArrayMap___64dkeys].val = var; /* @keys on <self:ArrayMap[Object, nullable Object] exact> */
...
((void (*)(val*, val*))(var1->class->vft[COLOR_array__ArrayMapValues__init]))(var1, self) /* init on <var1:ArrayMapValues[Object, nullable Object]>*/;
CHECK_NEW_array__ArrayMapValues(var1);
self->attrs[COLOR_array__ArrayMap___64dvalues].val = var1; /* @values on <self:ArrayMap[Object, nullable Object] exact> */
var2 = 0;
self->attrs[COLOR_array__ArrayMap___last_index].l = var2; /* _last_index on <self:ArrayMap[Object, nullable Object] exact> */
return self;
}
/* allocate ArrayMap[Object, nullable Object] */
void CHECK_NEW_array__ArrayMap(val* self) {
...
if (var == NULL) {
fprintf(stderr, "Runtime error: %s (%s:%d)\n", "Uninitialized attribute _items", "lib/standard/collection/array.nit", 560);
exit(1);
}
}
...
(nitmethod_t)VIRTUAL_kernel__Object__is_same_type, /* pointer to array:ArrayMapKeys:kernel#Object#is_same_type */
...
(nitmethod_t)VIRTUAL_kernel__Object__output, /* pointer to array:ArrayMapKeys:kernel#Object#output */
(nitmethod_t)VIRTUAL_kernel__Object__output_class_name, /* pointer to array:ArrayMapKeys:kernel#Object#output_class_name */
...
(nitmethod_t)VIRTUAL_math__Object__atan2, /* pointer to array:ArrayMapKeys:math#Object#atan2 */
(nitmethod_t)VIRTUAL_math__Object__pi, /* pointer to array:ArrayMapKeys:math#Object#pi */
(nitmethod_t)VIRTUAL_math__Object__srand_from, /* pointer to array:ArrayMapKeys:math#Object#srand_from */
(nitmethod_t)VIRTUAL_math__Object__srand, /* pointer to array:ArrayMapKeys:math#Object#srand */
(nitmethod_t)VIRTUAL_stream__Object__poll, /* pointer to array:ArrayMapKeys:stream#Object#poll */
(nitmethod_t)VIRTUAL_stream__Object__intern_poll, /* pointer to array:ArrayMapKeys:stream#Object#intern_poll */
...
(nitmethod_t)VIRTUAL_file__Object__getc, /* pointer to array:ArrayMapKeys:file#Object#getc */
(nitmethod_t)VIRTUAL_file__Object__gets, /* pointer to array:ArrayMapKeys:file#Object#gets */
...
(nitmethod_t)VIRTUAL_file__Object__stdin, /* pointer to array:ArrayMapKeys:file#Object#stdin */
(nitmethod_t)VIRTUAL_file__Object__stdout, /* pointer to array:ArrayMapKeys:file#Object#stdout */
(nitmethod_t)VIRTUAL_file__Object__stderr, /* pointer to array:ArrayMapKeys:file#Object#stderr */
...
(nitmethod_t)VIRTUAL_abstract_collection__Collection__iterate, /* pointer to array:ArrayMapKeys:abstract_collection#Collection#iterate */
...
(nitmethod_t)VIRTUAL_array__ArrayMapKeys__has_only, /* pointer to array:ArrayMapKeys:array#ArrayMapKeys#has_only */
(nitmethod_t)VIRTUAL_array__ArrayMapKeys__count, /* pointer to array:ArrayMapKeys:array#ArrayMapKeys#count */
...
(nitmethod_t)VIRTUAL_math__Collection__rand, /* pointer to array:ArrayMapKeys:math#Collection#rand */
...
(nitmethod_t)VIRTUAL_array__ArrayMapKeys__remove_all, /* pointer to array:ArrayMapKeys:array#ArrayMapKeys#remove_all */
...
/* allocate ArrayMapKeys[Object, nullable Object] */
void CHECK_NEW_array__ArrayMapKeys(val* self) {
val* var /* : ArrayMap[Object, nullable Object] */;
var = self->attrs[COLOR_array__ArrayMapKeys___64dmap].val; /* @map on <self:ArrayMapKeys[Object, nullable Object]> */
if (var == NULL) {
...
(nitmethod_t)VIRTUAL_kernel__Object__is_same_type, /* pointer to array:ArrayMapValues:kernel#Object#is_same_type */
...
(nitmethod_t)VIRTUAL_kernel__Object__output, /* pointer to array:ArrayMapValues:kernel#Object#output */
(nitmethod_t)VIRTUAL_kernel__Object__output_class_name, /* pointer to array:ArrayMapValues:kernel#Object#output_class_name */
...
(nitmethod_t)VIRTUAL_math__Object__atan2, /* pointer to array:ArrayMapValues:math#Object#atan2 */
(nitmethod_t)VIRTUAL_math__Object__pi, /* pointer to array:ArrayMapValues:math#Object#pi */
(nitmethod_t)VIRTUAL_math__Object__srand_from, /* pointer to array:ArrayMapValues:math#Object#srand_from */
(nitmethod_t)VIRTUAL_math__Object__srand, /* pointer to array:ArrayMapValues:math#Object#srand */
(nitmethod_t)VIRTUAL_stream__Object__poll, /* pointer to array:ArrayMapValues:stream#Object#poll */
(nitmethod_t)VIRTUAL_stream__Object__intern_poll, /* pointer to array:ArrayMapValues:stream#Object#intern_poll */
...
(nitmethod_t)VIRTUAL_file__Object__getc, /* pointer to array:ArrayMapValues:file#Object#getc */
(nitmethod_t)VIRTUAL_file__Object__gets, /* pointer to array:ArrayMapValues:file#Object#gets */
...
(nitmethod_t)VIRTUAL_file__Object__stdin, /* pointer to array:ArrayMapValues:file#Object#stdin */
(nitmethod_t)VIRTUAL_file__Object__stdout, /* pointer to array:ArrayMapValues:file#Object#stdout */
(nitmethod_t)VIRTUAL_file__Object__stderr, /* pointer to array:ArrayMapValues:file#Object#stderr */
...
(nitmethod_t)VIRTUAL_abstract_collection__Collection__iterate, /* pointer to array:ArrayMapValues:abstract_collection#Collection#iterate */
...
(nitmethod_t)VIRTUAL_array__ArrayMapValues__has_only, /* pointer to array:ArrayMapValues:array#ArrayMapValues#has_only */
(nitmethod_t)VIRTUAL_array__ArrayMapValues__count, /* pointer to array:ArrayMapValues:array#ArrayMapValues#count */
...
(nitmethod_t)VIRTUAL_math__Collection__rand, /* pointer to array:ArrayMapValues:math#Collection#rand */
...
(nitmethod_t)VIRTUAL_array__ArrayMapValues__remove_all, /* pointer to array:ArrayMapValues:array#ArrayMapValues#remove_all */
...
/* allocate ArrayMapValues[Object, nullable Object] */
void CHECK_NEW_array__ArrayMapValues(val* self) {
val* var /* : ArrayMap[Object, nullable Object] */;
var = self->attrs[COLOR_array__ArrayMapValues___64dmap].val; /* @map on <self:ArrayMapValues[Object, nullable Object]> */
if (var == NULL) {
...
(nitmethod_t)VIRTUAL_kernel__Object__is_same_type, /* pointer to array:NativeArray:kernel#Object#is_same_type */
...
(nitmethod_t)VIRTUAL_kernel__Object__output, /* pointer to array:NativeArray:kernel#Object#output */
(nitmethod_t)VIRTUAL_kernel__Object__output_class_name, /* pointer to array:NativeArray:kernel#Object#output_class_name */
...
(nitmethod_t)VIRTUAL_math__Object__atan2, /* pointer to array:NativeArray:math#Object#atan2 */
(nitmethod_t)VIRTUAL_math__Object__pi, /* pointer to array:NativeArray:math#Object#pi */
(nitmethod_t)VIRTUAL_math__Object__srand_from, /* pointer to array:NativeArray:math#Object#srand_from */
(nitmethod_t)VIRTUAL_math__Object__srand, /* pointer to array:NativeArray:math#Object#srand */
(nitmethod_t)VIRTUAL_stream__Object__poll, /* pointer to array:NativeArray:stream#Object#poll */
(nitmethod_t)VIRTUAL_stream__Object__intern_poll, /* pointer to array:NativeArray:stream#Object#intern_poll */
...
(nitmethod_t)VIRTUAL_file__Object__getc, /* pointer to array:NativeArray:file#Object#getc */
(nitmethod_t)VIRTUAL_file__Object__gets, /* pointer to array:NativeArray:file#Object#gets */
...
(nitmethod_t)VIRTUAL_file__Object__stdin, /* pointer to array:NativeArray:file#Object#stdin */
(nitmethod_t)VIRTUAL_file__Object__stdout, /* pointer to array:NativeArray:file#Object#stdout */
(nitmethod_t)VIRTUAL_file__Object__stderr, /* pointer to array:NativeArray:file#Object#stderr */
...
val* self /* : NativeArray[nullable Object] */;
...
(nitmethod_t)VIRTUAL_kernel__Object__is_same_type, /* pointer to sorter:ComparableSorter:kernel#Object#is_same_type */
...
(nitmethod_t)VIRTUAL_kernel__Object__output, /* pointer to sorter:ComparableSorter:kernel#Object#output */
(nitmethod_t)VIRTUAL_kernel__Object__output_class_name, /* pointer to sorter:ComparableSorter:kernel#Object#output_class_name */
...
(nitmethod_t)VIRTUAL_math__Object__atan2, /* pointer to sorter:ComparableSorter:math#Object#atan2 */
(nitmethod_t)VIRTUAL_math__Object__pi, /* pointer to sorter:ComparableSorter:math#Object#pi */
(nitmethod_t)VIRTUAL_math__Object__srand_from, /* pointer to sorter:ComparableSorter:math#Object#srand_from */
(nitmethod_t)VIRTUAL_math__Object__srand, /* pointer to sorter:ComparableSorter:math#Object#srand */
(nitmethod_t)VIRTUAL_stream__Object__poll, /* pointer to sorter:ComparableSorter:stream#Object#poll */
(nitmethod_t)VIRTUAL_stream__Object__intern_poll, /* pointer to sorter:ComparableSorter:stream#Object#intern_poll */
...
(nitmethod_t)VIRTUAL_file__Object__getc, /* pointer to sorter:ComparableSorter:file#Object#getc */
(nitmethod_t)VIRTUAL_file__Object__gets, /* pointer to sorter:ComparableSorter:file#Object#gets */
...
(nitmethod_t)VIRTUAL_file__Object__stdin, /* pointer to sorter:ComparableSorter:file#Object#stdin */
(nitmethod_t)VIRTUAL_file__Object__stdout, /* pointer to sorter:ComparableSorter:file#Object#stdout */
(nitmethod_t)VIRTUAL_file__Object__stderr, /* pointer to sorter:ComparableSorter:file#Object#stderr */
...
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)VIRTUAL_sorter__ComparableSorter__compare, /* pointer to sorter:ComparableSorter:sorter#ComparableSorter#compare */
(nitmethod_t)VIRTUAL_sorter__AbstractSorter__sort, /* pointer to sorter:ComparableSorter:sorter#AbstractSorter#sort */
(nitmethod_t)VIRTUAL_sorter__AbstractSorter__sub_sort, /* pointer to sorter:ComparableSorter:sorter#AbstractSorter#sub_sort */
(nitmethod_t)VIRTUAL_sorter__AbstractSorter__quick_sort, /* pointer to sorter:ComparableSorter:sorter#AbstractSorter#quick_sort */
(nitmethod_t)VIRTUAL_sorter__AbstractSorter__bubble_sort, /* pointer to sorter:ComparableSorter:sorter#AbstractSorter#bubble_sort */
(nitmethod_t)VIRTUAL_sorter__ComparableSorter__init, /* pointer to sorter:ComparableSorter:sorter#ComparableSorter#init */
}
};
...
/* allocate ComparableSorter[Comparable] */
void CHECK_NEW_sorter__ComparableSorter(val* self) {
}
...
(nitmethod_t)VIRTUAL_hash_collection__HashMap__iterate, /* pointer to hash_collection:HashMap:hash_collection#HashMap#iterate */
...
(nitmethod_t)VIRTUAL_abstract_collection__Collection__iterate, /* pointer to hash_collection:HashMapKeys:abstract_collection#Collection#iterate */
...
(nitmethod_t)VIRTUAL_abstract_collection__Collection__iterate, /* pointer to hash_collection:HashMapValues:abstract_collection#Collection#iterate */
...
if (var == NULL) {
fprintf(stderr, "Runtime error: %s (%s:%d)\n", "Uninitialized attribute _key", "lib/standard/collection/hash_collection.nit", 189);
exit(1);
}
...
if (var == NULL) {
fprintf(stderr, "Runtime error: %s (%s:%d)\n", "Uninitialized attribute _map", "lib/standard/collection/hash_collection.nit", 390);
exit(1);
}
...
(nitmethod_t)VIRTUAL_abstract_collection__Collection__iterate, /* pointer to hash_collection:HashSet:abstract_collection#Collection#iterate */
...
if (var == NULL) {
fprintf(stderr, "Runtime error: %s (%s:%d)\n", "Uninitialized attribute _set", "lib/standard/collection/hash_collection.nit", 481);
exit(1);
}
...
(nitmethod_t)VIRTUAL_model__MSignature__mclosures, /* pointer to model:MSignature:model#MSignature#mclosures */
(nitmethod_t)VIRTUAL_model__MSignature__mclosures_61d, /* pointer to model:MSignature:model#MSignature#mclosures= */
...
CHECK_NEW_array__Array(var1);
self->attrs[COLOR_model__MSignature___64dmclosures].val = var1; /* @mclosures on <self:MSignature exact> */
return self;
}
/* allocate MSignature */
...
(nitmethod_t)VIRTUAL_abstract_collection__Collection__iterate, /* pointer to poset:POSet:abstract_collection#Collection#iterate */
...
var6 = NEW_hash_collection__HashMap(&type_hash_collection__HashMapmodel__MClassabstract_collection__Setmodel__MProperty);
((void (*)(val*))(var6->class->vft[COLOR_hash_collection__HashMap__init]))(var6) /* init on <var6:HashMap[MClass, Set[MProperty]]>*/;
CHECK_NEW_hash_collection__HashMap(var6);
self->attrs[COLOR_abstract_compiler__MModule___64dproperties_cache].val = var6; /* @properties_cache on <self:MModule exact> */
return self;
}
/* allocate MModule */
...
(nitmethod_t)VIRTUAL_hash_collection__HashMap__iterate, /* pointer to more_collections:MultiHashMap:hash_collection#HashMap#iterate */
...
if (var8 == NULL) {
fprintf(stderr, "Runtime error: %s (%s:%d)\n", "Uninitialized attribute _values", "lib/opts.nit", 221);
exit(1);
}
}
...
if (var3 == NULL) {
fprintf(stderr, "Runtime error: %s (%s:%d)\n", "Uninitialized attribute _optmap", "lib/opts.nit", 234);
exit(1);
}
}
