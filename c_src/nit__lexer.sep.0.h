...
val* NEW_nit__TSemi(const struct type* type);
extern const struct type type_nit__TSemi;
...
val* NEW_nit__TBinNumber(const struct type* type);
extern const struct type type_nit__TBinNumber;
void nit__lexer___TBinNumber___init_tk(val* self, val* p0);
val* NEW_nit__TOctNumber(const struct type* type);
extern const struct type type_nit__TOctNumber;
void nit__lexer___TOctNumber___init_tk(val* self, val* p0);
val* NEW_nit__TBytenum(const struct type* type);
extern const struct type type_nit__TBytenum;
void nit__lexer___TBytenum___init_tk(val* self, val* p0);
val* NEW_nit__THexBytenum(const struct type* type);
extern const struct type type_nit__THexBytenum;
void nit__lexer___THexBytenum___init_tk(val* self, val* p0);
val* NEW_nit__TBinBytenum(const struct type* type);
extern const struct type type_nit__TBinBytenum;
void nit__lexer___TBinBytenum___init_tk(val* self, val* p0);
val* NEW_nit__TOctBytenum(const struct type* type);
extern const struct type type_nit__TOctBytenum;
