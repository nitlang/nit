...
#define COLOR_nitc__nitni_base__MType__cname_normal_class 55
...
#define COLOR_nitc__nitni_base___MClassType___MType__cname_blind 70
...
#define COLOR_nitc__nitni_base___MGenericType___MType__mangled_cname 74
