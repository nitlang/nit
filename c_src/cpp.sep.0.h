...
void CHECK_NEW_cpp__CPPCompilationUnit(val*);
...
void CHECK_NEW_c_tools__CFunction(val*);
...
void CHECK_NEW_cpp__ForeignCppType(val*);
...
void CHECK_NEW_cpp__ExternCppFile(val*);
...
void CHECK_NEW_cpp__CppCallContext(val*);
...
void CHECK_NEW_cpp__ToCppCallContext(val*);
...
void CHECK_NEW_cpp__FromCppCallContext(val*);
