...
void CHECK_NEW_nitni_callbacks__VerifyNitniCallbacksPhase(val*);
...
void CHECK_NEW_ffi_base__FFILanguageAssignationPhase(val*);
...
void CHECK_NEW_extern_classes__ExternClassesTypingPhaseAst(val*);
...
void CHECK_NEW_extern_classes__ExternClassesTypingPhaseModel(val*);
...
void CHECK_NEW_header_dependency__HeaderDependancyPhase(val*);
...
void CHECK_NEW_pkgconfig__PkgconfigPhase(val*);
...
void CHECK_NEW_c_compiler_options__CCompilerOptionsPhase(val*);
...
void CHECK_NEW_c__CLanguage(val*);
...
void CHECK_NEW_cpp__CPPLanguage(val*);
...
extern const struct class class_compiling_writer__Writer;
...
extern const struct class class_compiling_writer__WriterCoreNode;
...
extern const struct class class_compiling_writer__WriterStrings;
...
extern const struct class class_c__ToCCallContext;
