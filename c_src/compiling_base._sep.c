...
void compiling_base___CProgram___generate_build_file(val_t p0){
  ...
  fra.me.REG[4] = CALL_compiling_base___CProgram___include_dirs(fra.me.REG[0])(fra.me.REG[0]);
  REGB1 = TAG_Int(3);
  ...
  fra.me.REG[6] = CALL_compiling_base___CProgram___compdir(fra.me.REG[0])(fra.me.REG[0]);
  CALL_abstract_collection___SimpleCollection___add(fra.me.REG[5])(fra.me.REG[5], fra.me.REG[6]);
  if (!once_value_5) {
  ...
  CALL_stream___OStream___write(fra.me.REG[1])(fra.me.REG[1], fra.me.REG[5]);
  ...
  fra.me.REG[4] = CALL_compiling_base___CProgram___program(fra.me.REG[0])(fra.me.REG[0]);
  ...
  fra.me.REG[4] = fra.me.REG[4];
  CALL_abstract_collection___SimpleCollection___add(fra.me.REG[5])(fra.me.REG[5], fra.me.REG[4]);
  fra.me.REG[4] = CALL_compiling_base___ToolContext___clibdir(fra.me.REG[3])(fra.me.REG[3]);
  REGB1 = TAG_Bool(fra.me.REG[4]!=NIT_NULL);
  if (UNTAG_Bool(REGB1)) {
  } else {
    nit_abort("Cast failed", NULL, LOCATE_compiling_base, 102);
  }
  CALL_abstract_collection___SimpleCollection___add(fra.me.REG[5])(fra.me.REG[5], fra.me.REG[4]);
  if (!once_value_10) {
    fra.me.REG[4] = BOX_NativeString("\"\n");
  ...
  fra.me.REG[4] = fra.me.REG[4];
  CALL_abstract_collection___SimpleCollection___add(fra.me.REG[5])(fra.me.REG[5], fra.me.REG[4]);
  fra.me.REG[4] = CALL_compiling_base___ToolContext___bindir(fra.me.REG[3])(fra.me.REG[3]);
  REGB1 = TAG_Bool(fra.me.REG[4]!=NIT_NULL);
  if (UNTAG_Bool(REGB1)) {
  } else {
    nit_abort("Cast failed", NULL, LOCATE_compiling_base, 103);
  }
  CALL_abstract_collection___SimpleCollection___add(fra.me.REG[5])(fra.me.REG[5], fra.me.REG[4]);
  if (!once_value_12) {
  ...
  if (UNTAG_Bool(REGB1)) {
    ...
    if (UNTAG_Bool(REGB1)) {
      ...
      nit_abort("Cast failed", NULL, LOCATE_compiling_base, 105);
    }
    CALL_abstract_collection___SimpleCollection___add(fra.me.REG[5])(fra.me.REG[5], fra.me.REG[4]);
    if (!once_value_18) {
      fra.me.REG[4] = BOX_NativeString("");
    ...
    REGB1 = CALL_abstract_collection___Collection___is_empty(fra.me.REG[5])(fra.me.REG[5]);
    if (UNTAG_Bool(REGB1)) {
  ...
  fra.me.REG[5] = CALL_compiling_base___ToolContext___cc_libs(fra.me.REG[3])(fra.me.REG[3]);
  ...
  fra.me.REG[4] = CALL_compiling_base___ToolContext___cc_lib_paths(fra.me.REG[3])(fra.me.REG[3]);
  /* ./../lib/standard//collection//array.nit:234 */
  REGB1 = TAG_Int(0);
  /* ./../lib/standard//collection//array.nit:235 */
...
void compiling_base___CProgram___run_c_compiler(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_build_file", LOCATE_compiling_base, 124);
  }
  fra.me.REG[0] = ATTR_compiling_base___CProgram____build_file(fra.me.REG[0]);
...
void compiling_base___CompilerVisitor___add_decl(val_t p0, val_t p1){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_decl_writer", LOCATE_compiling_base, 135);
  }
...
void compiling_base___CompilerVisitor___add_instr(val_t p0, val_t p1){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_writer", LOCATE_compiling_base, 141);
  }
...
void compiling_base___CompilerVisitor___add_indent(val_t p0, val_t p1){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_indent_level", LOCATE_compiling_base, 147);
  }
  ...
  if (UNTAG_Bool(REGB1)) {
    ...
    if (UNTAG_Bool(REGB0)) {
      ...
      nit_abort("Uninitialized attribute %s", "_indent_level", LOCATE_compiling_base, 150);
    }
    REGB0 = ATTR_compiling_base___CompilerVisitor____indent_level(fra.me.REG[0]);
...
void compiling_base___CompilerVisitor___add_assignment(val_t p0, val_t p1, val_t p2){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    if (UNTAG_Bool(REGB0)) {
      ...
      nit_abort("Uninitialized attribute %s", "_writer", LOCATE_compiling_base, 167);
    }
...
val_t compiling_base___CompilerVisitor___new_number(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_number_cpt", LOCATE_compiling_base, 179);
  }
...
void compiling_base___CompilerVisitor___unindent(val_t p0){
  ...
  if (UNTAG_Bool(REGB1)) {
    ...
    nit_abort("Uninitialized attribute %s", "_indent_level", LOCATE_compiling_base, 194);
  }
...
val_t compiling_base___CompilerVisitor___mmmodule(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_mmmodule", LOCATE_compiling_base, 197);
  }
...
val_t compiling_base___CompilerVisitor___header_writer(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_header_writer", LOCATE_compiling_base, 200);
  }
...
val_t compiling_base___CompilerVisitor___writer(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_writer", LOCATE_compiling_base, 203);
  }
...
val_t compiling_base___CompilerVisitor___decl_writer(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_decl_writer", LOCATE_compiling_base, 206);
  }
...
val_t compiling_base___CompilerVisitor___top_writer(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_top_writer", LOCATE_compiling_base, 209);
  }
...
val_t compiling_base___CompilerVisitor___top_decl_writer(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_top_decl_writer", LOCATE_compiling_base, 212);
  }
...
val_t compiling_base___CompilerVisitor___indent_level(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_indent_level", LOCATE_compiling_base, 215);
  }
  REGB0 = ATTR_compiling_base___CompilerVisitor____indent_level(fra.me.REG[0]);
  stack_frame_head = fra.me.prev;
  return REGB0;
...
val_t compiling_base___CompilerVisitor___program(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_program", LOCATE_compiling_base, 218);
  }
...
val_t compiling_base___CompilerVisitor___cprogram(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_cprogram", LOCATE_compiling_base, 221);
  }
...
val_t compiling_base___MMLocalProperty___cname(val_t p0){
  ...
  fra.me.REG[3] = NIT_NULL;
  fra.me.REG[0] = p0;
  /* ./compiling//compiling_base.nit:282 */
  ...
  if (UNTAG_Bool(REGB0)) {
    /* ./compiling//compiling_base.nit:284 */
    REGB0 = TAG_Int(2);
