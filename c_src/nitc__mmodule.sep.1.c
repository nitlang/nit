...
var1 = self->attrs[COLOR_nitc__mmodule__MModule___filepath].val; /* _filepath on <self:MModule> */
var = var1;
RET_LABEL:;
return var;
}
...
self->attrs[COLOR_nitc__mmodule__MModule___filepath].val = p0; /* _filepath on <self:MModule> */
RET_LABEL:;
}
...
{
{ /* Inline mpackage#MPackage#name (var15) on <var15:MPackage> */
var20 = var15->attrs[COLOR_nitc__mpackage__MPackage___name].val; /* _name on <var15:MPackage> */
...
{
{ /* Inline mmodule#MModule#name (self) on <self:MModule> */
var23 = self->attrs[COLOR_nitc__mmodule__MModule___name].val; /* _name on <self:MModule> */
...
{
var24 = ((short int(*)(val* self, val* p0))(var18->class->vft[COLOR_core__kernel__Object___61d_61d]))(var18, var21); /* == on <var18:String>*/
}
var8 = var24;
}
if (var8){
{
{ /* Inline mmodule#MModule#name (self) on <self:MModule> */
var27 = self->attrs[COLOR_nitc__mmodule__MModule___name].val; /* _name on <self:MModule> */
...
{
{ /* Inline mpackage#MGroup#mpackage (var_mgroup) on <var_mgroup:nullable MGroup(MGroup)> */
var35 = var_mgroup->attrs[COLOR_nitc__mpackage__MGroup___mpackage].val; /* _mpackage on <var_mgroup:nullable MGroup(MGroup)> */
...
{
{ /* Inline mpackage#MPackage#name (var33) on <var33:MPackage> */
var38 = var33->attrs[COLOR_nitc__mpackage__MPackage___name].val; /* _name on <var33:MPackage> */
...
((struct instance_core__NativeArray*)var28)->values[0]=var36;
{
{ /* Inline mmodule#MModule#name (self) on <self:MModule> */
var41 = self->attrs[COLOR_nitc__mmodule__MModule___name].val; /* _name on <self:MModule> */
...
((struct instance_core__NativeArray*)var28)->values[2]=var39;
{
var42 = ((val*(*)(val* self))(var28->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var28); /* native_to_s on <var28:NativeArray[String]>*/
}
varonce = var28;
var3 = var42;
goto RET_LABEL4;
...
{
var37 = ((val*(*)(val* self, val* p0))(var33->class->vft[COLOR_core__abstract_text__String___43d]))(var33, var34); /* + on <var33:String>*/
}
{
{ /* Inline mmodule#MModule#name (self) on <self:MModule> */
...
{
var42 = ((val*(*)(val* self, val* p0))(var37->class->vft[COLOR_core__abstract_text__String___43d]))(var37, var41); /* + on <var37:String>*/
}
var_res = var42;
} else {
{
...
{
var8 = ((val*(*)(val* self))((((long)var7&3)?class_info[((long)var7&3)]:var7->class)->vft[COLOR_core__abstract_collection__Collection__first]))(var7); /* first on <var7:Collection[nullable Object](Collection[MModule])>*/
}
var_mmodule = var8;
} else {
goto BREAK_label;
