...
#define COLOR_nitc__phase___ToolContext___core__kernel__Object__init 152
...
#define COLOR_nitc__phase___ToolContext___process_options 149
...
#define COLOR_nitc__phase__ToolContext___phases_list 38
