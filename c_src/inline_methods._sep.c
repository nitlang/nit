...
void inline_methods___InlineMethodVisitor___visit_icode(val_t p0, val_t p1){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    if (UNTAG_Bool(REGB0)) {
      nit_abort("Reciever is null", NULL, LOCATE_inline_methods, 30);
    }
    ...
    if (UNTAG_Bool(REGB0)) {
      REGB0 = TAG_Bool(fra.me.REG[3]==NIT_NULL);
      if (UNTAG_Bool(REGB0)) {
        nit_abort("Reciever is null", NULL, LOCATE_inline_methods, 32);
      }
    ...
    if (UNTAG_Bool(REGB0)) {
      ...
      if (UNTAG_Bool(REGB0)) {
        ...
        nit_abort("Uninitialized attribute %s", "_icb", LOCATE_inline_methods, 33);
      }
      fra.me.REG[5] = ATTR_inline_methods___InlineMethodVisitor____icb(fra.me.REG[2]);
      /* ./analysis//inline_methods.nit:34 */
      fra.me.REG[6] = CALL_icode_builder___ICodeBuilder___iroutine(fra.me.REG[5])(fra.me.REG[5]);
      REGB0 = TAG_Bool(IS_EQUAL_ON(fra.me.REG[6],fra.me.REG[4]));
      if (UNTAG_Bool(REGB0)) {
      } else {
        REGB1 = CALL_kernel___Object_____eqeq(fra.me.REG[6])(fra.me.REG[6], fra.me.REG[4]);
        REGB0 = REGB1;
      }
      if (UNTAG_Bool(REGB0)) {
        ...
        if (UNTAG_Bool(REGB0)) {
          nit_abort("Reciever is null", NULL, LOCATE_inline_methods, 37);
        }
        CALL_list___ListIterator___delete(fra.me.REG[6])(fra.me.REG[6]);
        /* ./analysis//inline_methods.nit:38 */
        REGB0 = TAG_Bool(fra.me.REG[3]==NIT_NULL);
        if (UNTAG_Bool(REGB0)) {
          nit_abort("Reciever is null", NULL, LOCATE_inline_methods, 38);
        }
        ...
        fra.me.REG[7] = CALL_icode_base___ICodeN___exprs(fra.me.REG[3])(fra.me.REG[3]);
        fra.me.REG[7] = NEW_IStaticCall_icode_base___IStaticCall___init(fra.me.REG[6], fra.me.REG[7]);
        /* ./analysis//inline_methods.nit:39 */
        REGB0 = TAG_Bool(fra.me.REG[3]==NIT_NULL);
        if (UNTAG_Bool(REGB0)) {
          nit_abort("Reciever is null", NULL, LOCATE_inline_methods, 39);
        }
        fra.me.REG[6] = CALL_icode_base___ICodeN___closure_defs(fra.me.REG[3])(fra.me.REG[3]);
        CALL_icode_base___ICodeN___closure_defs__eq(fra.me.REG[7])(fra.me.REG[7], fra.me.REG[6]);
        /* ./analysis//inline_methods.nit:40 */
        REGB0 = TAG_Bool(fra.me.REG[3]==NIT_NULL);
        if (UNTAG_Bool(REGB0)) {
          nit_abort("Reciever is null", NULL, LOCATE_inline_methods, 40);
        }
        fra.me.REG[6] = CALL_icode_base___ICode___result(fra.me.REG[3])(fra.me.REG[3]);
        CALL_icode_base___ICode___result__eq(fra.me.REG[7])(fra.me.REG[7], fra.me.REG[6]);
        /* ./analysis//inline_methods.nit:41 */
        fra.me.REG[6] = CALL_icode_tools___ICodeVisitor___current_icode(fra.me.REG[2])(fra.me.REG[2]);
        REGB0 = TAG_Bool(fra.me.REG[6]==NIT_NULL);
        if (UNTAG_Bool(REGB0)) {
          nit_abort("Reciever is null", NULL, LOCATE_inline_methods, 41);
        }
        CALL_list___ListIterator___insert_before(fra.me.REG[6])(fra.me.REG[6], fra.me.REG[7]);
        /* ./analysis//inline_methods.nit:42 */
        fra.me.REG[7] = CALL_icode_tools___ICodeVisitor___current_icode(fra.me.REG[2])(fra.me.REG[2]);
        REGB0 = TAG_Bool(fra.me.REG[7]==NIT_NULL);
        if (UNTAG_Bool(REGB0)) {
          nit_abort("Reciever is null", NULL, LOCATE_inline_methods, 42);
        }
        CALL_list___ListIterator___delete(fra.me.REG[7])(fra.me.REG[7]);
      } else {
        /* ./analysis//inline_methods.nit:44 */
        fra.me.REG[7] = NEW_ISeq_icode_base___ISeq___init();
        /* ./analysis//inline_methods.nit:45 */
        fra.me.REG[6] = CALL_icode_builder___ICodeBuilder___seq(fra.me.REG[5])(fra.me.REG[5]);
        /* ./analysis//inline_methods.nit:46 */
        CALL_icode_builder___ICodeBuilder___seq__eq(fra.me.REG[5])(fra.me.REG[5], fra.me.REG[7]);
        ...
        if (UNTAG_Bool(REGB0)) {
          nit_abort("Reciever is null", NULL, LOCATE_inline_methods, 47);
        }
        CALL_list___ListIterator___insert_before(fra.me.REG[8])(fra.me.REG[8], fra.me.REG[7]);
        /* ./analysis//inline_methods.nit:48 */
        REGB0 = TAG_Bool(fra.me.REG[3]==NIT_NULL);
        if (UNTAG_Bool(REGB0)) {
          nit_abort("Reciever is null", NULL, LOCATE_inline_methods, 48);
        }
        ...
        fra.me.REG[9] = CALL_icode_tools___ICodeBuilder___inline_routine(fra.me.REG[5])(fra.me.REG[5], fra.me.REG[4], fra.me.REG[8], fra.me.REG[9]);
        /* ./analysis//inline_methods.nit:49 */
        REGB0 = TAG_Bool(fra.me.REG[3]==NIT_NULL);
        if (UNTAG_Bool(REGB0)) {
          nit_abort("Reciever is null", NULL, LOCATE_inline_methods, 49);
        }
        ...
        if (UNTAG_Bool(REGB0)) {
          ...
          if (UNTAG_Bool(REGB0)) {
            ...
            nit_abort("Assert failed", NULL, LOCATE_inline_methods, 51);
          }
          ...
          REGB0 = TAG_Bool(fra.me.REG[8]==NIT_NULL);
          if (UNTAG_Bool(REGB0)) {
            nit_abort("Reciever is null", NULL, LOCATE_inline_methods, 52);
          }
        ...
        REGB0 = TAG_Bool(fra.me.REG[9]==NIT_NULL);
        if (UNTAG_Bool(REGB0)) {
          nit_abort("Reciever is null", NULL, LOCATE_inline_methods, 54);
        }
        CALL_list___ListIterator___delete(fra.me.REG[9])(fra.me.REG[9]);
        /* ./analysis//inline_methods.nit:55 */
        CALL_icode_builder___ICodeBuilder___seq__eq(fra.me.REG[5])(fra.me.REG[5], fra.me.REG[6]);
        /* ./analysis//inline_methods.nit:56 */
        CALL_icode_tools___ICodeVisitor___visit_icode(fra.me.REG[2])(fra.me.REG[2], fra.me.REG[7]);
      }
    }
  }
