...
var2 = ((val* (*)(val*))(var1->class->vft[COLOR_model_base__MModule__name]))(var1) /* name on <var1:nullable MModule>*/;
}
var = var2;
goto RET_LABEL;
RET_LABEL:;
...
/* method nitni_base#MMethodDef#impl_cname for (self: MMethodDef, MModule): String */
...
((void (*)(val*, val*))(var_->class->vft[COLOR_abstract_collection__SimpleCollection__add]))(var_, var3) /* add on <var_:Array[Object]>*/;
var7 = ((val* (*)(val*))(var_mmodule->class->vft[COLOR_model_base__MModule__name]))(var_mmodule) /* name on <var_mmodule:MModule>*/;
...
((void (*)(val*, val*))(var_->class->vft[COLOR_abstract_collection__SimpleCollection__add]))(var_, var9) /* add on <var_:Array[Object]>*/;
var13 = ((val* (*)(val*))(self->class->vft[COLOR_nitni_base__MMethodDef__cname]))(self) /* cname on <self:MMethodDef>*/;
...
/* method nitni_base#MMethodDef#impl_cname for (self: Object, MModule): String */
val* VIRTUAL_nitni_base__MMethodDef__impl_cname(val* self, val* p0) {
val* var /* : String */;
val* var1 /* : String */;
var1 = nitni_base__MMethodDef__impl_cname(self, p0);
var = var1;
RET_LABEL:;
return var;
}
/* method nitni_base#MMethodDef#super_cname for (self: MMethodDef, MModule): String */
...
/* method nitni_base#MMethodDef#super_cname for (self: Object, MModule): String */
val* VIRTUAL_nitni_base__MMethodDef__super_cname(val* self, val* p0) {
val* var /* : String */;
val* var1 /* : String */;
var1 = nitni_base__MMethodDef__super_cname(self, p0);
var = var1;
RET_LABEL:;
return var;
}
...
val* var /* : String */;
val* var1 /* : String */;
var1 = ((val* (*)(val*))(self->class->vft[COLOR_string__Object__class_name]))(self) /* class_name on <self:MType>*/;
((void (*)(val*, val*))(self->class->vft[COLOR_file__Object__print]))(self, var1) /* print on <self:MType>*/;
fprintf(stderr, "Runtime error: %s", "Aborted");
fprintf(stderr, " (%s:%d)\n", "src/nitni/nitni_base.nit", 76);
exit(1);
RET_LABEL:;
return var;
}
...
var1 = ((val* (*)(val*))(self->class->vft[COLOR_string__Object__class_name]))(self) /* class_name on <self:MType>*/;
((void (*)(val*, val*))(self->class->vft[COLOR_file__Object__print]))(self, var1) /* print on <self:MType>*/;
((void (*)(val*, val*))(self->class->vft[COLOR_file__Object__print]))(self, self) /* print on <self:MType>*/;
fprintf(stderr, "Runtime error: %s", "Aborted");
fprintf(stderr, " (%s:%d)\n", "src/nitni/nitni_base.nit", 89);
exit(1);
RET_LABEL:;
return var;
}
